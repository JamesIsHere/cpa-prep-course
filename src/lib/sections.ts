...
const allSections: Section[] = [
	...
	},
	{
		...
		lessons: [
			...
			{
				slug: "02-financial-statement-presentation",
				title: "Financial Statement Presentation",
				contentPath: "far/02-financial-statement-presentation",
				isFree: false,
			},
			{
				slug: "03-statement-of-cash-flows",
				title: "Statement of Cash Flows",
				contentPath: "far/03-statement-of-cash-flows",
				isFree: false,
			},
			{
				slug: "04-earnings-per-share",
				title: "Earnings Per Share",
				contentPath: "far/04-earnings-per-share",
				isFree: false,
			},
			{
				slug: "05-employee-benefit-plans",
				title: "Employee Benefit Plans",
				contentPath: "far/05-employee-benefit-plans",
				isFree: false,
			},
			{
				slug: "06-special-purpose-frameworks",
			...
			{
				slug: "22-governmental-accounting-fundamentals",
				title: "Governmental Accounting Fundamentals",
				contentPath: "far/22-governmental-accounting-fundamentals",
				isFree: false,
			},
			{
				slug: "23-government-financial-statements",
				title: "Government-Wide and Fund Financial Statements",
				contentPath: "far/23-government-financial-statements",
				isFree: false,
			},
		],
	},
