...
export const questionCounts: Record<string, number> = {
	...
	// REG (1,456 total — synced with live DB 2026-03-30)
	...
	"Individual Taxation: Credits/AMT": 67,
	...
	"Property Transactions: Basis": 48,
	"Property Transactions: Gains/Losses": 44,
	"S Corporations": 82,
	"Tax Procedures": 44,
	"Tax-Exempt Organizations": 77,
	// BAR (1,539 total — synced with live DB 2026-03-30)
