...
export const questionCounts: Record<string, number> = {
	// AUD (1,446 total — synced with live DB 2026-04-11)
	...
	// FAR (1,554 total — synced with live DB 2026-04-11)
	...
	// REG (1,446 total — synced with live DB 2026-04-11)
	...
	// BAR (1,534 total — synced with live DB 2026-04-11)
	...
	// ISC (1,452 total — synced with live DB 2026-04-11)
	...
	// TCP (1,421 total — synced with live DB 2026-04-11)
