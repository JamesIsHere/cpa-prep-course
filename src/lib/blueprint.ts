...
export const questionCounts: Record<string, number> = {
	// AUD (1,424 total — synced with live DB 2026-04-21)
	...
	// FAR (1,539 total — synced with live DB 2026-04-21)
	...
	// REG (1,397 total — synced with live DB 2026-04-21)
	...
	// BAR (1,509 total — synced with live DB 2026-04-21)
	...
	// ISC (1,452 total — synced with live DB 2026-04-21)
	...
	// TCP (1,291 total — synced with live DB 2026-04-21)
