...
export const questionCounts: Record<string, number> = {
	...
	"Advanced Consolidations": 14,
	"Derivatives and Hedging": 14,
	"State and Local Government Reporting": 13,
	"Internal-Use Software and Cloud Computing": 10,
	"Advanced Lease Transactions": 10,
