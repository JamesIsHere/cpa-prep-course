...
export const questionCounts: Record<string, number> = {
	// AUD (1,424 total — synced with live DB 2026-04-23)
	...
	// FAR (1,539 total — synced with live DB 2026-04-23)
	...
	// REG (1,397 total — synced with live DB 2026-04-23)
	...
	// ISC (1,452 total — synced with live DB 2026-04-23)
	...
	// TCP (1,291 total — synced with live DB 2026-04-23)
	...
	"Owner-Entity Transactions": 74,
	"Passive Activity and At-Risk Rules": 93,
