...
export const questionCounts: Record<string, number> = {
	// AUD (3,180 total — synced with live DB 2026-03-05)
	...
	Materiality: 20,
	"Misstatements and Control Deficiencies": 1443,
	...
	// FAR (2,801 total — synced with live DB 2026-03-05)
	"Accounting Changes and Error Corrections": 80,
	"Bonds and Debt": 73,
	"Cash and Receivables": 64,
	"Conceptual Framework and Standards": 80,
	Consolidations: 77,
	Contingencies: 64,
	...
	// REG (2,219 total — synced with live DB 2026-03-05)
	"Agency and Regulation": 66,
	"Alternative Minimum Tax": 78,
	"Business Law: Contracts": 73,
	"Business Structures": 67,
	"C Corporations": 133,
	"Circular 230": 42,
	"Debtor-Creditor Relationships": 62,
	"Estate and Gift Tax": 195,
	"Federal Tax Procedures": 10,
	"Government Regulation of Business": 50,
	"Individual Taxation: Credits": 97,
	"Individual Taxation: Credits/AMT": 53,
	"Individual Taxation: Deductions": 66,
	"Individual Taxation: Filing/Credits": 75,
	"Individual Taxation: Income": 84,
	...
	// ISC (948 total — synced with live DB 2026-03-05)
	"Change Management": 20,
	"Data Management and Lifecycle": 48,
	"Data Protection Technologies": 166,
	"ERP and Accounting Information Systems": 48,
	"Incident Response and Recovery": 103,
	...
	// TCP (910 total — synced with live DB 2026-03-05)
	...
	"Passive Activity and At-Risk Rules": 226,
	"Related Party Transactions": 40,
	"Retirement Plans and Education Savings": 80,
