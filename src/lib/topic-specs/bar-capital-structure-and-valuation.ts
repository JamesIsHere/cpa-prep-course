...
//
// // Anchored to AICPA group BAR/I/B. Refine to a 4-part
// topic-level ref (BAR/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/I/B "Valuation and capital structure"
// Slayer lesson(s): 04-capital-structure, 05-financial-valuation, 06-risk-management
//
...
//   const SPECS = { ..., [barCapitalStructureAndValuation.topic]: barCapitalStructureAndValuation };
//
