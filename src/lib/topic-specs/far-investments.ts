...
//
// // Anchored to AICPA group FAR/II/E. Refine to a 4-part
// topic-level ref (FAR/II/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/E "Investments"
// Slayer lesson(s): 13-investments
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farInvestments } from "./far-investments";
//   const SPECS = { ..., [farInvestments.topic]: farInvestments };
//
