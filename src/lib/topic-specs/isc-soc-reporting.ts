...
//
// // blueprintRef="TODO" — the scaffolder could not resolve ISC/III/E
...
//
// Slayer group: ISC/III/E "Reporting on SOC engagements"
// Slayer lesson(s): 16-soc-reporting
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscSocReporting } from "./isc-soc-reporting";
//   const SPECS = { ..., [iscSocReporting.topic]: iscSocReporting };
//
