...
//
// // Anchored to AICPA group FAR/I/F. Refine to a 4-part
// topic-level ref (FAR/I/F/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/I/F "Financial statement ratios and performance metrics"
// Slayer lesson(s): 08-financial-statement-ratios
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farFinancialStatementRatios } from "./far-financial-statement-ratios";
//   const SPECS = { ..., [farFinancialStatementRatios.topic]: farFinancialStatementRatios };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Financial Statement Ratios",
	section: "far",
	blueprintRef: "FAR/I/F",
