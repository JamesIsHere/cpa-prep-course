...
//
// // Anchored to AICPA group REG/IV/A. Refine to a 4-part
// topic-level ref (REG/IV/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/IV/A "Gross income"
// Slayer lesson(s): 09-individual-taxation-income
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regIndividualTaxationIncome } from "./reg-individual-taxation-income";
//   const SPECS = { ..., [regIndividualTaxationIncome.topic]: regIndividualTaxationIncome };
//
