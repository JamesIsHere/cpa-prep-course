...
//
// // Anchored to AICPA group AUD/II/F. Refine to a 4-part
// topic-level ref (AUD/II/F/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/II/F "Understanding internal control"
// Slayer lesson(s): 05-internal-controls
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audInternalControls } from "./aud-internal-controls";
//   const SPECS = { ..., [audInternalControls.topic]: audInternalControls };
//
