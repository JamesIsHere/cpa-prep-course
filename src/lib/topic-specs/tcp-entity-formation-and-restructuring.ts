...
//
// // Anchored to AICPA group TCP/IV/A. Refine to a 4-part
// topic-level ref (TCP/IV/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/IV/A "Entity formation and restructuring"
// Slayer lesson(s): 11-formation-liquidation
//
...
//   const SPECS = { ..., [tcpEntityFormationAndRestructuring.topic]: tcpEntityFormationAndRestructuring };
//
