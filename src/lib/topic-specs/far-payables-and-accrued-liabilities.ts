...
//
// // Anchored to AICPA group FAR/II/G. Refine to a 4-part
// topic-level ref (FAR/II/G/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/G "Payables and accrued liabilities"
// Slayer lesson(s): 15-payables-and-accrued-liabilities
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farPayablesAndAccruedLiabilities } from "./far-payables-and-accrued-liabilities";
//   const SPECS = { ..., [farPayablesAndAccruedLiabilities.topic]: farPayablesAndAccruedLiabilities };
//
