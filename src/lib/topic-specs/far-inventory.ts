...
//
// // Anchored to AICPA group FAR/II/C. Refine to a 4-part
// topic-level ref (FAR/II/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/C "Inventory"
// Slayer lesson(s): 11-inventory
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farInventory } from "./far-inventory";
//   const SPECS = { ..., [farInventory.topic]: farInventory };
//
