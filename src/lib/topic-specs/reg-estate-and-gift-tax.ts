...
//
// // Anchored to AICPA group REG/V/D. Refine to a 4-part
// topic-level ref (REG/V/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/V/D "Estate and gift tax"
...
//   const SPECS = { ..., [regEstateAndGiftTax.topic]: regEstateAndGiftTax };
//
