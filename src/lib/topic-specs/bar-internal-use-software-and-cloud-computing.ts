...
//
// // Anchored to AICPA group BAR/II/B. Refine to a 4-part
// topic-level ref (BAR/II/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/B "Internal-use software and cloud computing"
// Slayer lesson(s): 12-internal-use-software
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barInternalUseSoftwareAndCloudComputing } from "./bar-internal-use-software-and-cloud-computing";
//   const SPECS = { ..., [barInternalUseSoftwareAndCloudComputing.topic]: barInternalUseSoftwareAndCloudComputing };
//
