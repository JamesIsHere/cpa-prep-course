...
//
// // Anchored to AICPA group AUD/I/E. Refine to a 4-part
// topic-level ref (AUD/I/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/I/E "Government Auditing Standards and Single Audit"
// Slayer lesson(s): 13-government-auditing
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audGovernmentAuditingStandards } from "./aud-government-auditing-standards";
//   const SPECS = { ..., [audGovernmentAuditingStandards.topic]: audGovernmentAuditingStandards };
//
