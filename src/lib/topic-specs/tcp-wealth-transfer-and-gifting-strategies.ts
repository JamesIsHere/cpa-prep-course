...
//
// // Anchored to AICPA group TCP/I/C. Refine to a 4-part
// topic-level ref (TCP/I/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/I/C "Wealth transfer and estate planning"
// Slayer lesson(s): 04-wealth-transfer
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as tcpWealthTransferAndGiftingStrategies } from "./tcp-wealth-transfer-and-gifting-strategies";
//   const SPECS = { ..., [tcpWealthTransferAndGiftingStrategies.topic]: tcpWealthTransferAndGiftingStrategies };
//
