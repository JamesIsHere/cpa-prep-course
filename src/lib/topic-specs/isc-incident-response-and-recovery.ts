...
//
// // Anchored to AICPA group ISC/II/D. Refine to a 4-part
// topic-level ref (ISC/II/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/II/D "Monitoring and incident response"
// Slayer lesson(s): 10-incident-response
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscIncidentResponseAndRecovery } from "./isc-incident-response-and-recovery";
//   const SPECS = { ..., [iscIncidentResponseAndRecovery.topic]: iscIncidentResponseAndRecovery };
//
