...
//
// // Anchored to AICPA group TCP/I/A. Refine to a 4-part
// topic-level ref (TCP/I/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/I/A "Compensation planning and optimization"
// Slayer lesson(s): 02-individual-planning
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as tcpIndividualTaxPlanningCompensation } from "./tcp-individual-tax-planning-compensation";
//   const SPECS = { ..., [tcpIndividualTaxPlanningCompensation.topic]: tcpIndividualTaxPlanningCompensation };
//
