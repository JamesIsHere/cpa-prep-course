...
//
// // Anchored to AICPA group FAR/I/D. Refine to a 4-part
// topic-level ref (FAR/I/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/I/D "Public company reporting topics"
// Slayer lesson(s): 06-public-company-reporting
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farPublicCompanyReporting } from "./far-public-company-reporting";
//   const SPECS = { ..., [farPublicCompanyReporting.topic]: farPublicCompanyReporting };
//
