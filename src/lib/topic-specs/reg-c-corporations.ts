...
//
// // Anchored to AICPA group REG/V/A. Refine to a 4-part
// topic-level ref (REG/V/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/V/A "C corporations"
// Slayer lesson(s): 11-c-corporations
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regCCorporations } from "./reg-c-corporations";
//   const SPECS = { ..., [regCCorporations.topic]: regCCorporations };
//
