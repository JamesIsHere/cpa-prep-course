...
//
// // Anchored to AICPA group REG/III/B. Refine to a 4-part
// topic-level ref (REG/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/III/B "Gains, losses, and nontaxable exchanges"
// Slayer lesson(s): 07-property-transactions-gains, 08-like-kind-exchanges
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regPropertyTransactionsGainsLosses } from "./reg-property-transactions-gains-losses";
//   const SPECS = { ..., [regPropertyTransactionsGainsLosses.topic]: regPropertyTransactionsGainsLosses };
//
