...
//
// // Anchored to AICPA group FAR/III/D. Refine to a 4-part
// topic-level ref (FAR/III/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/D "Accounting for income taxes"
// Slayer lesson(s): 21-income-taxes
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farIncomeTaxes } from "./far-income-taxes";
//   const SPECS = { ..., [farIncomeTaxes.topic]: farIncomeTaxes };
//
