...
//
// // Anchored to AICPA group AUD/I/B. Refine to a 4-part
// topic-level ref (AUD/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/I/B "Professional ethics and conduct"
// Slayer lesson(s): 02-ethics-and-independence
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audProfessionalResponsibilities } from "./aud-professional-responsibilities";
//   const SPECS = { ..., [audProfessionalResponsibilities.topic]: audProfessionalResponsibilities };
//
