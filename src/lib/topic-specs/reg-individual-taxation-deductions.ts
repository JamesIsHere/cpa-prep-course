...
//
// // Anchored to AICPA group REG/IV/B. Refine to a 4-part
// topic-level ref (REG/IV/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/IV/B "Adjustments and deductions"
...
//   const SPECS = { ..., [regIndividualTaxationDeductions.topic]: regIndividualTaxationDeductions };
//
