...
//
// // Anchored to AICPA group REG/I/B. Refine to a 4-part
// topic-level ref (REG/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/I/B "Circular 230 and tax practice"
// Slayer lesson(s): 02-circular-230
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regCircular-230 } from "./reg-circular-230";
//   const SPECS = { ..., [regCircular-230.topic]: regCircular-230 };
//
