...
//
// // Anchored to AICPA group REG/IV/E. Refine to a 4-part
// topic-level ref (REG/IV/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/IV/E "Alternative minimum tax"
// Slayer lesson(s): 10-individual-taxation-credits
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regAlternativeMinimumTax } from "./reg-alternative-minimum-tax";
//   const SPECS = { ..., [regAlternativeMinimumTax.topic]: regAlternativeMinimumTax };
//
