...
//
// // Anchored to AICPA group AUD/IV/D. Refine to a 4-part
// topic-level ref (AUD/IV/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/IV/D "Reviews and compilations"
// Slayer lesson(s): 10-review-compilation
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audReviewCompilationEngagements } from "./aud-review-compilation-engagements";
//   const SPECS = { ..., [audReviewCompilationEngagements.topic]: audReviewCompilationEngagements };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Review/Compilation Engagements",
	section: "aud",
	blueprintRef: "AUD/IV/D",
