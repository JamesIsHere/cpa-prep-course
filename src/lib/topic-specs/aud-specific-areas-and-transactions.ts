...
//
// // Anchored to AICPA group AUD/III/H. Refine to a 4-part
// topic-level ref (AUD/III/H/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/H "Specific areas and transactions"
// Slayer lesson(s): 08-substantive-procedures
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audSpecificAreasAndTransactions } from "./aud-specific-areas-and-transactions";
//   const SPECS = { ..., [audSpecificAreasAndTransactions.topic]: audSpecificAreasAndTransactions };
//
