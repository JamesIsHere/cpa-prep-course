...
//
// // Anchored to AICPA group FAR/III/G. Refine to a 4-part
// topic-level ref (FAR/III/G/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/G "Subsequent events"
// Slayer lesson(s): 24-subsequent-events
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farSubsequentEvents } from "./far-subsequent-events";
//   const SPECS = { ..., [farSubsequentEvents.topic]: farSubsequentEvents };
//
