...
//
// // Anchored to AICPA group AUD/II/B. Refine to a 4-part
// topic-level ref (AUD/II/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/II/B "Understanding the entity and its environment"
// Slayer lesson(s): 03-audit-planning
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audUnderstandingTheEntityAndEnvironment } from "./aud-understanding-the-entity-and-environment";
//   const SPECS = { ..., [audUnderstandingTheEntityAndEnvironment.topic]: audUnderstandingTheEntityAndEnvironment };
//
