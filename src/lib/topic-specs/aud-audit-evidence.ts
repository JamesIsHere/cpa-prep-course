...
//
// // Anchored to AICPA group AUD/III/E. Refine to a 4-part
// topic-level ref (AUD/III/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/E "Audit evidence evaluation"
...
//   const SPECS = { ..., [audAuditEvidence.topic]: audAuditEvidence };
//
