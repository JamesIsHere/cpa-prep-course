...
//
// // Anchored to AICPA group ISC/II/B. Refine to a 4-part
// topic-level ref (ISC/II/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/II/B "Threats and vulnerabilities"
// Slayer lesson(s): 07-threats-vulnerabilities
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscThreatsAttacksAndVulnerabilities } from "./isc-threats-attacks-and-vulnerabilities";
//   const SPECS = { ..., [iscThreatsAttacksAndVulnerabilities.topic]: iscThreatsAttacksAndVulnerabilities };
//
