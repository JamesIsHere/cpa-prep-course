...
//
// // Anchored to AICPA group BAR/II/G. Refine to a 4-part
// topic-level ref (BAR/II/G/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/G "Foreign currency transactions"
// Slayer lesson(s): 10-derivatives
//
...
//   const SPECS = { ..., [barForeignCurrencyTransactions.topic]: barForeignCurrencyTransactions };
//
