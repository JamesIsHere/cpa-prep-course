...
//
// // Anchored to AICPA group REG/I/C. Refine to a 4-part
// topic-level ref (REG/I/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/I/C "Federal tax procedures"
// Slayer lesson(s): 14-federal-tax-procedures
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regFederalTaxProcedures } from "./reg-federal-tax-procedures";
//   const SPECS = { ..., [regFederalTaxProcedures.topic]: regFederalTaxProcedures };
//
