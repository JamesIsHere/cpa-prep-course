...
//
// // Anchored to AICPA group ISC/III/A. Refine to a 4-part
// topic-level ref (ISC/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/III/A "SOC engagement types and scope"
// Slayer lesson(s): 11-soc-engagements
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscSocEngagements } from "./isc-soc-engagements";
//   const SPECS = { ..., [iscSocEngagements.topic]: iscSocEngagements };
//
