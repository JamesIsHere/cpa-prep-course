...
//
// // Anchored to AICPA group AUD/III/C. Refine to a 4-part
// topic-level ref (AUD/III/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/C "Analytical procedures"
...
//   const SPECS = { ..., [audAnalyticalProcedures.topic]: audAnalyticalProcedures };
//
