...
//
// // Anchored to AICPA group FAR/II/F. Refine to a 4-part
// topic-level ref (FAR/II/F/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/F "Intangible assets"
// Slayer lesson(s): 14-intangible-assets
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farIntangibleAssets } from "./far-intangible-assets";
//   const SPECS = { ..., [farIntangibleAssets.topic]: farIntangibleAssets };
//
