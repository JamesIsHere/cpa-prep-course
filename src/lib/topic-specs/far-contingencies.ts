...
//
// // Anchored to AICPA group FAR/III/B. Refine to a 4-part
// topic-level ref (FAR/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/B "Contingencies and commitments"
// Slayer lesson(s): 19-contingencies
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farContingencies } from "./far-contingencies";
//   const SPECS = { ..., [farContingencies.topic]: farContingencies };
//
