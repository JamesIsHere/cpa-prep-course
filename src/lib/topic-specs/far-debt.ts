...
//
// // Anchored to AICPA group FAR/II/H. Refine to a 4-part
// topic-level ref (FAR/II/H/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/H "Debt (financial liabilities)"
// Slayer lesson(s): 16-debt
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farDebt } from "./far-debt";
//   const SPECS = { ..., [farDebt.topic]: farDebt };
//
