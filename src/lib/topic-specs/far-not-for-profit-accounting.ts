...
//
// // Anchored to AICPA group FAR/I/B. Refine to a 4-part
// topic-level ref (FAR/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/I/B "General-purpose financial reporting: nongovernmental not-for-profit entities"
// Slayer lesson(s): 04-not-for-profit
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farNotForProfitAccounting } from "./far-not-for-profit-accounting";
//   const SPECS = { ..., [farNotForProfitAccounting.topic]: farNotForProfitAccounting };
//
