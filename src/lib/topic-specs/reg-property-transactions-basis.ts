...
//
// // Anchored to AICPA group REG/III/A. Refine to a 4-part
// topic-level ref (REG/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/III/A "Basis and holding period"
// Slayer lesson(s): 06-property-transactions-basis
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regPropertyTransactionsBasis } from "./reg-property-transactions-basis";
//   const SPECS = { ..., [regPropertyTransactionsBasis.topic]: regPropertyTransactionsBasis };
//
