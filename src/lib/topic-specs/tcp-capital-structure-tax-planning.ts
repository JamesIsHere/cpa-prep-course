...
//
// // Anchored to AICPA group TCP/III/C. Refine to a 4-part
// topic-level ref (TCP/III/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/III/C "Capital structure optimization"
// Slayer lesson(s): 13-capital-structure-tax
//
...
//   const SPECS = { ..., [tcpCapitalStructureTaxPlanning.topic]: tcpCapitalStructureTaxPlanning };
//
