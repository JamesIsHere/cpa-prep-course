...
//
// // Anchored to AICPA group REG/II/D. Refine to a 4-part
// topic-level ref (REG/II/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/II/D "Debtor-creditor relationships"
// Slayer lesson(s): 16-debtor-creditor
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regDebtorCreditorRelationships } from "./reg-debtor-creditor-relationships";
//   const SPECS = { ..., [regDebtorCreditorRelationships.topic]: regDebtorCreditorRelationships };
//
