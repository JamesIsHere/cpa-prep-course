...
//
// // Anchored to AICPA group FAR/II/B. Refine to a 4-part
// topic-level ref (FAR/II/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/B "Trade receivables"
// Slayer lesson(s): 10-trade-receivables
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farTradeReceivables } from "./far-trade-receivables";
//   const SPECS = { ..., [farTradeReceivables.topic]: farTradeReceivables };
//
