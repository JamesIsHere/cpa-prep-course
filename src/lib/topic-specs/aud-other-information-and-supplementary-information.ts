...
//
// // Anchored to AICPA group AUD/IV/C. Refine to a 4-part
// topic-level ref (AUD/IV/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/IV/C "Other information and supplementary information"
// Slayer lesson(s): 09-audit-reports
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audOtherInformationAndSupplementaryInformation } from "./aud-other-information-and-supplementary-information";
//   const SPECS = { ..., [audOtherInformationAndSupplementaryInformation.topic]: audOtherInformationAndSupplementaryInformation };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Other Information and Supplementary Information",
	section: "aud",
	blueprintRef: "AUD/IV/C",
