...
//
// // Anchored to AICPA group AUD/III/D. Refine to a 4-part
// topic-level ref (AUD/III/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/D "Audit sampling"
// Slayer lesson(s): 07-sampling
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audAuditSampling } from "./aud-audit-sampling";
//   const SPECS = { ..., [audAuditSampling.topic]: audAuditSampling };
//
