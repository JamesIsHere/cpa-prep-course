...
//
// // Anchored to AICPA group BAR/III/A. Refine to a 4-part
// topic-level ref (BAR/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/III/A "Government-wide financial statements"
// Slayer lesson(s): 11-government-advanced
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barStateAndLocalGovernmentReporting } from "./bar-state-and-local-government-reporting";
//   const SPECS = { ..., [barStateAndLocalGovernmentReporting.topic]: barStateAndLocalGovernmentReporting };
//
