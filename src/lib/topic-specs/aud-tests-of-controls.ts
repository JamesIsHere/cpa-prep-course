...
//
// // Anchored to AICPA group AUD/III/B. Refine to a 4-part
// topic-level ref (AUD/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/B "Tests of controls"
...
//   const SPECS = { ..., [audTestsOfControls.topic]: audTestsOfControls };
//
