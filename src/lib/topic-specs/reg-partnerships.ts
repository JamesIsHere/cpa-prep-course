...
//
// // Anchored to AICPA group REG/V/C. Refine to a 4-part
// topic-level ref (REG/V/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/V/C "Partnerships"
// Slayer lesson(s): 13-partnerships
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regPartnerships } from "./reg-partnerships";
//   const SPECS = { ..., [regPartnerships.topic]: regPartnerships };
//
