...
//
// // Anchored to AICPA group FAR/II/A. Refine to a 4-part
// topic-level ref (FAR/II/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/A "Cash and cash equivalents"
// Slayer lesson(s): 09-cash-and-cash-equivalents
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farCashAndCashEquivalents } from "./far-cash-and-cash-equivalents";
//   const SPECS = { ..., [farCashAndCashEquivalents.topic]: farCashAndCashEquivalents };
//
