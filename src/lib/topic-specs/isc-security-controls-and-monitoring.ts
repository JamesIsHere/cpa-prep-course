...
//
// // Anchored to AICPA group ISC/II/C. Refine to a 4-part
// topic-level ref (ISC/II/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/II/C "Security controls and countermeasures"
// Slayer lesson(s): 08-security-controls
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscSecurityControlsAndMonitoring } from "./isc-security-controls-and-monitoring";
//   const SPECS = { ..., [iscSecurityControlsAndMonitoring.topic]: iscSecurityControlsAndMonitoring };
//
