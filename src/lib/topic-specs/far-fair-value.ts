...
//
// // Anchored to AICPA group FAR/III/E. Refine to a 4-part
// topic-level ref (FAR/III/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/E "Fair value measurements"
// Slayer lesson(s): 22-fair-value
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farFairValue } from "./far-fair-value";
//   const SPECS = { ..., [farFairValue.topic]: farFairValue };
//
