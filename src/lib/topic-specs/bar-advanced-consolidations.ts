...
//
// // Anchored to AICPA group BAR/II/E. Refine to a 4-part
// topic-level ref (BAR/II/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/E "Consolidations (advanced)"
// Slayer lesson(s): 09-consolidations-advanced
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barAdvancedConsolidations } from "./bar-advanced-consolidations";
//   const SPECS = { ..., [barAdvancedConsolidations.topic]: barAdvancedConsolidations };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Advanced Consolidations",
	section: "bar",
	blueprintRef: "BAR/II/E",
