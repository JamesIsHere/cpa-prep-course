...
//
// // Anchored to AICPA group AUD/I/C. Refine to a 4-part
// topic-level ref (AUD/I/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/I/C "Independence"
// Slayer lesson(s): 02-ethics-and-independence
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audIndependence } from "./aud-independence";
//   const SPECS = { ..., [audIndependence.topic]: audIndependence };
//
