...
//
// // Anchored to AICPA group AUD/III/G. Refine to a 4-part
// topic-level ref (AUD/III/G/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/G "Written representations"
// Slayer lesson(s): 06-audit-evidence
//
...
//   const SPECS = { ..., [audWrittenRepresentations.topic]: audWrittenRepresentations };
//
