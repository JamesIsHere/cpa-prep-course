...
//
// // Anchored to AICPA group TCP/IV/C. Refine to a 4-part
// topic-level ref (TCP/IV/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/IV/C "Related party transactions"
// Slayer lesson(s): 15-related-party-transactions
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as tcpRelatedPartyTransactions } from "./tcp-related-party-transactions";
//   const SPECS = { ..., [tcpRelatedPartyTransactions.topic]: tcpRelatedPartyTransactions };
//
