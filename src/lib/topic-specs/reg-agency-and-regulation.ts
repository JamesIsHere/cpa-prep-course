...
//
// // Anchored to AICPA group REG/II/B. Refine to a 4-part
// topic-level ref (REG/II/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/II/B "Agency"
// Slayer lesson(s): 04-agency-and-regulation
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regAgencyAndRegulation } from "./reg-agency-and-regulation";
//   const SPECS = { ..., [regAgencyAndRegulation.topic]: regAgencyAndRegulation };
//
