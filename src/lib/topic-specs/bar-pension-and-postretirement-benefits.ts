...
//
// // Anchored to AICPA group BAR/II/K. Refine to a 4-part
// topic-level ref (BAR/II/K/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/K "Employee benefit plans"
// Slayer lesson(s): 14-employee-benefit-plans
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barPensionAndPostretirementBenefits } from "./bar-pension-and-postretirement-benefits";
//   const SPECS = { ..., [barPensionAndPostretirementBenefits.topic]: barPensionAndPostretirementBenefits };
//
