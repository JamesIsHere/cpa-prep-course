...
//
// // Anchored to AICPA group BAR/III/B. Refine to a 4-part
// topic-level ref (BAR/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/III/B "Reconciliation requirements"
// Slayer lesson(s): 15-fund-reconciliation
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barFundToGovernmentWideReconciliation } from "./bar-fund-to-government-wide-reconciliation";
//   const SPECS = { ..., [barFundToGovernmentWideReconciliation.topic]: barFundToGovernmentWideReconciliation };
//
