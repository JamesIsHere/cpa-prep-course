...
//
// // blueprintRef="TODO" — the scaffolder could not resolve ISC/I/G
...
//
// Slayer group: ISC/I/G "IT audit frameworks"
// Slayer lesson(s): 14-it-audit-frameworks
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscItAuditFrameworks } from "./isc-it-audit-frameworks";
//   const SPECS = { ..., [iscItAuditFrameworks.topic]: iscItAuditFrameworks };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "IT Audit Frameworks",
	section: "isc",
	blueprintRef: "TODO",
