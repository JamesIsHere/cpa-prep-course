...
//
// // Anchored to AICPA group ISC/I/A. Refine to a 4-part
// topic-level ref (ISC/I/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/I/A "IT infrastructure and architecture"
// Slayer lesson(s): 02-it-infrastructure
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscItInfrastructureAndArchitecture } from "./isc-it-infrastructure-and-architecture";
//   const SPECS = { ..., [iscItInfrastructureAndArchitecture.topic]: iscItInfrastructureAndArchitecture };
//
