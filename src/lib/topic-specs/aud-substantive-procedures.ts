...
//
// // Anchored to AICPA group AUD/III/A. Refine to a 4-part
// topic-level ref (AUD/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/III/A "Substantive procedures"
// Slayer lesson(s): 08-substantive-procedures
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audSubstantiveProcedures } from "./aud-substantive-procedures";
//   const SPECS = { ..., [audSubstantiveProcedures.topic]: audSubstantiveProcedures };
//
