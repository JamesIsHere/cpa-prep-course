...
//
// // Anchored to AICPA group FAR/III/F. Refine to a 4-part
// topic-level ref (FAR/III/F/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/F "Lessee accounting"
// Slayer lesson(s): 23-lessee-accounting
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farLeases } from "./far-leases";
//   const SPECS = { ..., [farLeases.topic]: farLeases };
//
