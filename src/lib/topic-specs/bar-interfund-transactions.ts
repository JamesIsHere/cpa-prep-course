...
//
// // Anchored to AICPA group BAR/III/C. Refine to a 4-part
// topic-level ref (BAR/III/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/III/C "Specific transactions and events"
// Slayer lesson(s): 16-interfund-transactions
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barInterfundTransactions } from "./bar-interfund-transactions";
//   const SPECS = { ..., [barInterfundTransactions.topic]: barInterfundTransactions };
//
