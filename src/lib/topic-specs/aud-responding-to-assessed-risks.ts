...
//
// // Anchored to AICPA group AUD/II/E. Refine to a 4-part
// topic-level ref (AUD/II/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/II/E "Responding to assessed risks"
// Slayer lesson(s): 04-risk-assessment
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audRespondingToAssessedRisks } from "./aud-responding-to-assessed-risks";
//   const SPECS = { ..., [audRespondingToAssessedRisks.topic]: audRespondingToAssessedRisks };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Responding to Assessed Risks",
	section: "aud",
	blueprintRef: "AUD/II/E",
