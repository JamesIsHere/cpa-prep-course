...
//
// // Anchored to AICPA group ISC/I/B. Refine to a 4-part
// topic-level ref (ISC/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/I/B "Enterprise systems and applications"
// Slayer lesson(s): 03-erp-accounting-systems
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscErpAndAccountingInformationSystems } from "./isc-erp-and-accounting-information-systems";
//   const SPECS = { ..., [iscErpAndAccountingInformationSystems.topic]: iscErpAndAccountingInformationSystems };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "ERP and Accounting Information Systems",
	section: "isc",
	blueprintRef: "ISC/I/B",
