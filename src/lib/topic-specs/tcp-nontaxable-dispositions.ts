...
//
// // Anchored to AICPA group TCP/IV/B. Refine to a 4-part
// topic-level ref (TCP/IV/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/IV/B "Nontaxable dispositions"
// Slayer lesson(s): 14-nontaxable-dispositions
//
...
//   const SPECS = { ..., [tcpNontaxableDispositions.topic]: tcpNontaxableDispositions };
//
