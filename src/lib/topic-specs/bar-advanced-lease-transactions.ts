...
//
// // Anchored to AICPA group BAR/II/I. Refine to a 4-part
// topic-level ref (BAR/II/I/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/I "Advanced lease transactions"
// Slayer lesson(s): 13-advanced-leases
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barAdvancedLeaseTransactions } from "./bar-advanced-lease-transactions";
//   const SPECS = { ..., [barAdvancedLeaseTransactions.topic]: barAdvancedLeaseTransactions };
//
