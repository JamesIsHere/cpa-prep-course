...
//
// // Anchored to AICPA group REG/II/E. Refine to a 4-part
// topic-level ref (REG/II/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/II/E "Government regulation of business"
// Slayer lesson(s): 04-agency-and-regulation
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regGovernmentRegulationOfBusiness } from "./reg-government-regulation-of-business";
//   const SPECS = { ..., [regGovernmentRegulationOfBusiness.topic]: regGovernmentRegulationOfBusiness };
//
