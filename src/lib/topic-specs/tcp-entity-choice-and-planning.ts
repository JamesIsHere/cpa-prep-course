...
//
// // Anchored to AICPA group TCP/III/B. Refine to a 4-part
// topic-level ref (TCP/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/III/B "Entity choice and planning strategies"
// Slayer lesson(s): 12-entity-choice
//
...
//   const SPECS = { ..., [tcpEntityChoiceAndPlanning.topic]: tcpEntityChoiceAndPlanning };
//
