...
//
// // Anchored to AICPA group TCP/III/A. Refine to a 4-part
// topic-level ref (TCP/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/III/A "Trust and estate taxation"
// Slayer lesson(s): 10-trusts-estates
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as tcpTrustsAndEstates } from "./tcp-trusts-and-estates";
//   const SPECS = { ..., [tcpTrustsAndEstates.topic]: tcpTrustsAndEstates };
//
