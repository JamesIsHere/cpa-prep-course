...
//
// // Anchored to AICPA group AUD/I/D. Refine to a 4-part
// topic-level ref (AUD/I/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/I/D "Professional skepticism and judgment"
// Slayer lesson(s): 01-intro
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audProfessionalSkepticismAndJudgment } from "./aud-professional-skepticism-and-judgment";
//   const SPECS = { ..., [audProfessionalSkepticismAndJudgment.topic]: audProfessionalSkepticismAndJudgment };
//
