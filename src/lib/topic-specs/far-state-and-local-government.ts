...
//
// // Anchored to AICPA group FAR/I/C. Refine to a 4-part
// topic-level ref (FAR/I/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/I/C "State and local government concepts"
// Slayer lesson(s): 05-state-local-government
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farStateAndLocalGovernment } from "./far-state-and-local-government";
//   const SPECS = { ..., [farStateAndLocalGovernment.topic]: farStateAndLocalGovernment };
//
