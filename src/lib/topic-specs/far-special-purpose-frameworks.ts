...
//
// // Anchored to AICPA group FAR/I/E. Refine to a 4-part
// topic-level ref (FAR/I/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/I/E "Special purpose frameworks"
// Slayer lesson(s): 07-special-purpose-frameworks
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farSpecialPurposeFrameworks } from "./far-special-purpose-frameworks";
//   const SPECS = { ..., [farSpecialPurposeFrameworks.topic]: farSpecialPurposeFrameworks };
//
