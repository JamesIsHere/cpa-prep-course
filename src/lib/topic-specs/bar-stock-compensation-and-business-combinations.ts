...
//
// // Anchored to AICPA group BAR/II/C. Refine to a 4-part
// topic-level ref (BAR/II/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/C "Stock-based compensation"
// Slayer lesson(s): 08-stock-compensation
//
...
//   const SPECS = { ..., [barStockCompensationAndBusinessCombinations.topic]: barStockCompensationAndBusinessCombinations };
//
