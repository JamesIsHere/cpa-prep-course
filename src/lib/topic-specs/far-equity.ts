...
//
// // Anchored to AICPA group FAR/II/I. Refine to a 4-part
// topic-level ref (FAR/II/I/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/I "Equity"
// Slayer lesson(s): 17-equity
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farEquity } from "./far-equity";
//   const SPECS = { ..., [farEquity.topic]: farEquity };
//
