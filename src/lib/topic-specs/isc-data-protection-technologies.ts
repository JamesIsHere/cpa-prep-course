...
//
// // blueprintRef="TODO" — the scaffolder could not resolve ISC/II/F
...
//
// Slayer group: ISC/II/F "Data protection technologies"
// Slayer lesson(s): 09-privacy
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscDataProtectionTechnologies } from "./isc-data-protection-technologies";
//   const SPECS = { ..., [iscDataProtectionTechnologies.topic]: iscDataProtectionTechnologies };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Data Protection Technologies",
	section: "isc",
	blueprintRef: "TODO",
