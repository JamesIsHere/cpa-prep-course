...
//
// // Anchored to AICPA group TCP/III/D. Refine to a 4-part
// topic-level ref (TCP/III/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/III/D "Multi-jurisdictional planning"
// Slayer lesson(s): 07-international-tax
//
...
//   const SPECS = { ..., [tcpMultiJurisdictionalTaxPlanning.topic]: tcpMultiJurisdictionalTaxPlanning };
//
