...
//
// // Anchored to AICPA group BAR/II/J. Refine to a 4-part
// topic-level ref (BAR/II/J/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: BAR/II/J "Income taxes (advanced)"
// Slayer lesson(s): 09-consolidations-advanced
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as barIncomeTaxesAdvanced } from "./bar-income-taxes-advanced";
//   const SPECS = { ..., [barIncomeTaxesAdvanced.topic]: barIncomeTaxesAdvanced };
//
// Then run the drift test to confirm:
//   npx vitest run tests/unit/topic-specs.test.ts

export const spec: TopicSpec = {
	topic: "Income Taxes Advanced",
	section: "bar",
	blueprintRef: "BAR/II/J",
