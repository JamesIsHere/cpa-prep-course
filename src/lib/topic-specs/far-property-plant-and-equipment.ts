...
//
// // Anchored to AICPA group FAR/II/D. Refine to a 4-part
// topic-level ref (FAR/II/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/II/D "Property, plant and equipment"
// Slayer lesson(s): 12-property-plant-equipment
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farPropertyPlantAndEquipment } from "./far-property-plant-and-equipment";
//   const SPECS = { ..., [farPropertyPlantAndEquipment.topic]: farPropertyPlantAndEquipment };
//
