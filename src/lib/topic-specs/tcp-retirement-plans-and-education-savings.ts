...
//
// // Anchored to AICPA group TCP/I/D. Refine to a 4-part
// topic-level ref (TCP/I/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/I/D "Retirement and education savings"
// Slayer lesson(s): 05-retirement-education
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as tcpRetirementPlansAndEducationSavings } from "./tcp-retirement-plans-and-education-savings";
//   const SPECS = { ..., [tcpRetirementPlansAndEducationSavings.topic]: tcpRetirementPlansAndEducationSavings };
//
