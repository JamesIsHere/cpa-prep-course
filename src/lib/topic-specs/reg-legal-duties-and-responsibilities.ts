...
//
// // Anchored to AICPA group REG/I/D. Refine to a 4-part
// topic-level ref (REG/I/D/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/I/D "Legal duties and responsibilities"
// Slayer lesson(s): 15-legal-duties
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regLegalDutiesAndResponsibilities } from "./reg-legal-duties-and-responsibilities";
//   const SPECS = { ..., [regLegalDutiesAndResponsibilities.topic]: regLegalDutiesAndResponsibilities };
//
