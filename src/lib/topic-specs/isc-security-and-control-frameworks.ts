...
//
// // Anchored to AICPA group ISC/II/A. Refine to a 4-part
// topic-level ref (ISC/II/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/II/A "Security frameworks and standards"
// Slayer lesson(s): 06-security-frameworks
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as iscSecurityAndControlFrameworks } from "./isc-security-and-control-frameworks";
//   const SPECS = { ..., [iscSecurityAndControlFrameworks.topic]: iscSecurityAndControlFrameworks };
//
