...
//
// // Anchored to AICPA group REG/II/C. Refine to a 4-part
// topic-level ref (REG/II/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/II/C "Business structures and governance"
// Slayer lesson(s): 05-business-structures
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regBusinessStructures } from "./reg-business-structures";
//   const SPECS = { ..., [regBusinessStructures.topic]: regBusinessStructures };
//
