...
//
// // Anchored to AICPA group AUD/IV/E. Refine to a 4-part
// topic-level ref (AUD/IV/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/IV/E "Attestation engagements"
// Slayer lesson(s): 11-attestation-engagements
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as audAttestationEngagements } from "./aud-attestation-engagements";
//   const SPECS = { ..., [audAttestationEngagements.topic]: audAttestationEngagements };
//
