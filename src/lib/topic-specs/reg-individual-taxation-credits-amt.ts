...
//
// // Anchored to AICPA group REG/IV/C. Refine to a 4-part
// topic-level ref (REG/IV/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/IV/C "Tax credits and payments"
// Slayer lesson(s): 10-individual-taxation-credits
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regIndividualTaxationCreditsAmt } from "./reg-individual-taxation-credits-amt";
//   const SPECS = { ..., [regIndividualTaxationCreditsAmt.topic]: regIndividualTaxationCreditsAmt };
//
