...
//
// // Anchored to AICPA group ISC/III/B. Refine to a 4-part
// topic-level ref (ISC/III/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: ISC/III/B "Trust services criteria"
// Slayer lesson(s): 12-soc-reporting
//
...
//   const SPECS = { ..., [iscSocReportingAndTrustServicesCriteria.topic]: iscSocReportingAndTrustServicesCriteria };
//
