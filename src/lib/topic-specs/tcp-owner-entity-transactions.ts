...
//
// // Anchored to AICPA group TCP/II/C. Refine to a 4-part
// topic-level ref (TCP/II/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/II/C "Owner-entity transactions"
// Slayer lesson(s): 08-owner-entity
//
...
//   const SPECS = { ..., [tcpOwnerEntityTransactions.topic]: tcpOwnerEntityTransactions };
//
