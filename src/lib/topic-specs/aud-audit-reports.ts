...
//
// // Anchored to AICPA group AUD/IV/A. Refine to a 4-part
// topic-level ref (AUD/IV/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: AUD/IV/A "Reports on financial statement audits"
...
//   const SPECS = { ..., [audAuditReports.topic]: audAuditReports };
//
