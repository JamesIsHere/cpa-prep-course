...
//
// // Anchored to AICPA group REG/V/E. Refine to a 4-part
// topic-level ref (REG/V/E/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: REG/V/E "Tax-exempt organizations"
// Slayer lesson(s): 18-tax-exempt-organizations
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as regTaxExemptOrganizations } from "./reg-tax-exempt-organizations";
//   const SPECS = { ..., [regTaxExemptOrganizations.topic]: regTaxExemptOrganizations };
//
