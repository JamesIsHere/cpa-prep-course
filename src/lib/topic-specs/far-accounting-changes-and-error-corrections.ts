...
//
// // Anchored to AICPA group FAR/III/A. Refine to a 4-part
// topic-level ref (FAR/III/A/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/A "Accounting changes and error corrections"
// Slayer lesson(s): 18-accounting-changes
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farAccountingChangesAndErrorCorrections } from "./far-accounting-changes-and-error-corrections";
//   const SPECS = { ..., [farAccountingChangesAndErrorCorrections.topic]: farAccountingChangesAndErrorCorrections };
//
