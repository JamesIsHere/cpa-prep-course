...
//
// // Anchored to AICPA group TCP/I/B. Refine to a 4-part
// topic-level ref (TCP/I/B/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: TCP/I/B "Passive activities and at-risk limitations"
// Slayer lesson(s): 03-passive-at-risk
//
...
//   const SPECS = { ..., [tcpPassiveActivityAndAtRiskRules.topic]: tcpPassiveActivityAndAtRiskRules };
//
