...
//
// // Anchored to AICPA group FAR/III/C. Refine to a 4-part
// topic-level ref (FAR/III/C/<N>) if this Slayer topic maps 1:1 to a
// single AICPA representative-task topic.
//
// Slayer group: FAR/III/C "Revenue recognition"
// Slayer lesson(s): 20-revenue-recognition
//
// After authoring, register in src/lib/topic-specs/index.ts:
//   import { spec as farRevenueRecognition } from "./far-revenue-recognition";
//   const SPECS = { ..., [farRevenueRecognition.topic]: farRevenueRecognition };
//
