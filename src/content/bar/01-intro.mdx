...
**1.** Under the 2024 CPA Evolution model, BAR is classified as:

a) A core section required of all candidates
b) A discipline section chosen by the candidate
c) An elective that does not affect the CPA license
d) A replacement for the former FAR section

**Answer:** b) A discipline section chosen by the candidate — BAR is one of three discipline options (BAR, ISC, TCP) that candidates select in addition to the three required core sections.

---

**2.** Which of the following topics is tested on BAR but NOT on FAR?

a) Revenue recognition under ASC 606
b) Discounted cash flow valuation methods
c) Preparation of the statement of cash flows
d) Lease classification under ASC 842

**Answer:** b) Discounted cash flow valuation methods — DCF analysis and business valuation are BAR-specific topics that go beyond FAR's financial reporting focus.

---

**3.** The largest content area of the BAR section by exam weight is:

a) State and Local Government Concepts
b) Technical Accounting and Reporting
c) Business Analysis
d) Ethics and Professional Responsibilities

**Answer:** c) Business Analysis — at 40-50% of the exam, Business Analysis is the most heavily weighted area, covering financial analysis, valuation, and risk management.
