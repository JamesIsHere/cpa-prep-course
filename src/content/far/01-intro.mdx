...
"Real when cash moves"  "Real when cash is imminent"  "Real when economics change"
```

**Cash basis** requires zero judgment and badly misrepresents economic reality for any entity with significant credit transactions. It answers: "How much cash came in and went out?"

**Modified accrual** exists only for governmental funds. Revenue is recognized when **measurable and available** (collectible within ~60 days). It answers: "Do I have enough current financial resources to meet current obligations?"

**Full accrual** captures the complete economic position. Revenue when performance obligations are satisfied. Expenses when incurred. It requires the most judgment. It answers: "What is the total economic position and performance of this entity?"
