...
|---------|------|---------|-----------|-----------------|---------------------------------------------------|
| AUD     | aud  | 13      | ~1,435    | 37              | Ethics, planning, risk, controls, evidence, sampling, reports, review/compilation, attestation, quality mgmt, government auditing |
...
| REG     | reg  | 18      | ~1,410    | 60              | Circular 230, contracts, agency, business structures, basis, gains/losses, 1031, individual tax, credits, filing status, C/S corps, partnerships, tax procedures, legal duties, debtor-creditor, tax-exempt orgs |
| BAR     | bar  | 16      | ~1,513    | 40              | Financial analysis, valuation, capital structure, derivatives, consolidations, govt reporting, fund reconciliation, interfund transactions |
...
| TCP     | tcp  | 15      | ~1,293    | 44              | Individual planning, passive/at-risk, wealth transfer, retirement, international tax, trusts, capital structure tax, nontaxable dispositions, related parties |

**Totals:** 102 lessons, ~8,642 questions (target: ~9,000), 346 framework items across 6 sections
