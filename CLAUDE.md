...
| BAR     | bar  | 16      | ~1,530    | 40              | Financial analysis, valuation, capital structure, derivatives, consolidations, govt reporting, fund reconciliation, interfund transactions |
...
**Totals:** 102 lessons, ~8,734 questions (target: ~9,000), 346 framework items across 6 sections
