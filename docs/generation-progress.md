...
| FAR     | 3,041   | 5,000  | 1,959     | ~66            | In Progress |
...
| 2026-03-05 | 00445_generate_far_batch88.sql | FAR | Earnings Per Share | 30 | Rabbi trust shares excluded, cash dividends no WA effect, graded vesting separate tranches, stock split numerator unaffected, ASU 2020-06 net share settlement, treasury reissuance mid-year, time-weighting vs simple average, conversion inducement expense, subsidiary holding parent shares, forfeiture-adjusted options, preferred redeemed below carrying, EPS for common only, sequencing halt antidilutive, noncumulative undeclared not deducted, YTD cumulative interim EPS, participating preferred dividend cap, undistributed losses not allocated, EPS all periods presented, simple structure diluted=basic, retrospective change restates EPS, buyback authorization no effect, anti-dilution ratchet conversion, cumulative if-converted add-back, two tranches one antidilutive, make-whole premium shares, partially paid subscriptions, stock comp dual effect, capped call excluded purchased option, preferred redeemed at discount, retirement vs treasury same EPS effect |
| 2026-03-05 | 00446_generate_far_batch89.sql | FAR | Earnings Per Share | 30 | Nonpublic exemption, EPS rounding, year-end vs WA analyst error, increasing-rate preferred, variable-share contract, interim Q standalone loss control number, ATM offering weighting, shares for services date, contingently adjustable conversion, bargain purchase gain in numerator, ESOP suspense exclusion, zero-exercise RSU assumed proceeds, buyback authorization no effect, stock comp expense effect, PIK preferred deduction, leveraged ESOP allocated+committed, issuance costs deemed dividend year, OCI vs net income, participating warrants cash settlement, anti-dilution ratchet, rabbi trust treasury, ASU 2020-06 if-converted, partially paid subscriptions, make-whole provision shares, issuance costs year 2 no effect, mid-year tax rate change add-back, EPS all periods presented, loss from operations antidilutive, litigation settlement weighting, ASR initial delivery |
| 2026-03-05 | 00447_generate_far_batch90.sql | FAR | Earnings Per Share | 30 | Noncumulative preferred no deduction, induced conversion expense, partially paid subscriptions, antidilutive ordering test, option modification assumed proceeds, cash-settled SARs excluded, OCI excluded from numerator, reverse stock split retroactive, discontinued ops separate EPS, interim YTD weighted-average, contingently returnable acquisition shares, EPS precision two decimal, purchased call antidilutive, nonpublic entity not required, increasing-rate preferred imputed discount, ASR initial delivery, DRIP shares not retroactive, down-round deemed dividend, subsidiary dilutive securities consolidated, stock splits retroactive, restricted stock forfeitable dividends, preferred issuance costs, mid-year tax rate if-converted, bonus issue retroactive, preferred discount early conversion accretion, mid-year change tax rate add-back, excess tax benefits ASU 2016-09, out-of-money options antidilutive, year-to-date vs quarterly EPS, simple structure basic only |
| 2026-03-05 | 00448_generate_far_batch91.sql | FAR | Earnings Per Share | 30 | Reverse split retroactive restatement, basic EPS preferred deduction, convertible participating preferred two-class vs if-converted, negative EPS from preferred exceeding NI, stock dividend retroactive three-transaction, subscription cancellation weighting, large stock dividend same treatment, fractional share cash no EPS effect, minimum EPS line items, stock split denominator only, cumulative+noncumulative dual deduction, mid-year option grant weighting, EPS all periods presented, ESPP shares periodic weighting, loss from continuing ops antidilutive, treasury reissuance mid-year, cumulative undeclared dividend deduction, net income vs comprehensive income numerator, noncumulative undeclared no deduction, prior-period error EPS restatement, BCF accretion deemed dividend, negative EPS allowed, EPS display location face of IS, same diluted denominator all line items, interim EPS required, weighted-average fraction of year, dual-class common separate EPS, break-even control number zero, contingently issuable complex structure, prior-year stock dividend comparative restatement |
| 2026-03-05 | 00449_generate_far_batch92.sql | FAR | Earnings Per Share | 30 | DRIP shares quarterly weighting, unvested restricted shares forfeiture no basic effect, valuation allowance if-converted, subsidiary holding parent shares treasury, back-calculate max dilutive options, cumulative preferred arrearages current-year only, stock subscriptions not outstanding, per-share line items required, retroactive stock dividend prior-period, small stock dividend retroactive vs cash issuance, complex capital structure dual presentation, contingently issuable shares interim met, mandatorily redeemable preferred as liability, participating preferred loss not shared, multi-security diluted EPS sequencing, cumulative preferred deducted in loss year |
| 2026-03-05 | 00450_generate_far_batch93.sql | FAR | Earnings Per Share | 30 | Redeemable NCI accretion, zero-coupon convertible if-converted, shares surrendered for tax withholding, convertible bond extinguished mid-year, preferred at premium dividend basis, participation cap two-class, shares for lawsuit settlement, stock comp expense vs basic denominator, year-end repurchase negligible WA impact, par value irrelevance, dual-condition contingent shares, stepped-up conversion ratio, fiscal year transition period WA, share repurchase no TSM effect, mezzanine preferred accretion+dividends, control number continuing ops, effective interest vs coupon add-back, EPS on income statement only, convertible retired partial-year, net-share-settled ASU 2020-06, equity-to-liability reclassification mid-year, written put reverse TSM concept, escrow shares released year-end, secondary offering no entity effect, convertible participating more dilutive test, noncash asset shares weighted from issuance, simple average error, simple capital structure single EPS, quasi-reorganization no EPS effect, analyst error simple average |
