...
Wrong (C): Averaging current and future rates is not permitted; the measurement uses the single enacted rate applicable to the reversal period.$EXPL$,
  difficulty = 'easy'
WHERE id = 2179;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 740 as amended by ASU 2015-17, all deferred tax assets and liabilities are classified as noncurrent. DTAs and DTLs from the same tax-paying jurisdiction are offset and presented as a single net amount. The net DTA is $150,000 − $90,000 = $60,000 noncurrent.
...
Wrong (C): Classifying the DTA as current and the DTL as noncurrent reflects the pre-ASU 2015-17 approach, which has been superseded. All deferred taxes are now noncurrent.$EXPL$,
  difficulty = 'easy'
WHERE id = 2183;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): ASC 805-20-30-1 requires the acquirer to measure identifiable assets acquired and liabilities assumed at their acquisition-date fair values. This establishes the new cost basis in a business combination.
...
Wrong (D): The lower of cost or fair value is a conservatism concept not applicable to acquisition-date measurement under ASC 805.$EXPL$,
  difficulty = 'easy'
WHERE id = 2190;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 805-30-25-2, when the fair value of identifiable net assets ($3,500,000) exceeds consideration transferred ($3,000,000), a bargain purchase exists. After reassessing all assets and liabilities, the $500,000 excess is recognized immediately as a gain in earnings.
...
Wrong (D): Recording a deferred credit for negative goodwill was the approach under legacy standards; ASC 805 requires immediate gain recognition.$EXPL$,
  difficulty = 'medium'
WHERE id = 2192;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): ASC 805-10-25-15 limits the measurement period to one year from the acquisition date. During this period, the acquirer may adjust provisional amounts as new information is obtained about facts and circumstances that existed at the acquisition date.
...
Wrong (C): The measurement period is measured from the acquisition date, not the fiscal year-end, and extends up to 12 months regardless of where the acquisition falls in the fiscal year.$EXPL$,
  difficulty = 'easy'
WHERE id = 2193;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 805-10-25-23, acquisition-related costs such as finder's fees, advisory fees, legal fees, and due diligence costs are expensed as incurred. These are not part of the consideration transferred.
...
Wrong (C): Costs of issuing debt securities are accounted for under ASC 470 as a discount or deferred charge and amortized over the debt term.$EXPL$,
  difficulty = 'medium'
WHERE id = 2205;
...
Wrong (D): Recording at $1 as a nominal amount has no basis under ASC 805; fair value measurement is required.$EXPL$,
  difficulty = 'easy'
WHERE id = 2206;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 350-20-35-1, goodwill is not amortized but is tested for impairment at least annually, or more frequently if indicators of impairment exist. This is the default GAAP treatment for public entities.
...
Wrong (D): Writing off goodwill immediately against retained earnings is not permitted; goodwill remains on the balance sheet until impaired.$EXPL$,
  difficulty = 'easy'
WHERE id = 2210;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): ASC 805-20-25-19 requires the acquirer to recognize contingent liabilities assumed in a business combination at their acquisition-date fair value if the fair value can be determined during the measurement period. This is a lower recognition threshold than the ASC 450 probable-and-estimable criteria.
...
Wrong (D): Requiring virtual certainty is an even higher threshold than ASC 450 and has no basis in ASC 805's acquisition accounting requirements.$EXPL$,
  difficulty = 'hard'
WHERE id = 2214;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 805-30-30-1, total consideration = $3,000,000 cash + $400,000 contingent consideration fair value = $3,400,000. Goodwill = $3,400,000 − $2,800,000 = $600,000. Contingent consideration is measured at acquisition-date fair value and included in consideration transferred.
...
Wrong (D): $400,000 equals the contingent consideration alone and does not reflect the correct goodwill computation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2215;
...
Wrong (C): Writing off the investment and starting fresh has no basis in GAAP; the previously held interest is remeasured, not eliminated.$EXPL$,
  difficulty = 'hard'
WHERE id = 2216;
...
Wrong (D): Reporting only the parent's total assets would ignore the subsidiary entirely, defeating the purpose of consolidation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2218;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): ASC 820-10-35-10 requires nonfinancial assets to be measured based on their highest and best use from the perspective of market participants. Highest and best use considers what is physically possible, legally permissible, and financially feasible.
...
Wrong (C): Taking the lower of current use or highest and best use applies a conservatism concept not found in the fair value framework.$EXPL$,
  difficulty = 'medium'
WHERE id = 2223;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): ASC 820-10-35-36B explicitly prohibits blockage factors (discounts for large position sizes) for Level 1 measurements. The fair value is the quoted price per unit multiplied by the quantity held: 100,000 × $50 = $5,000,000.
...
Wrong (D): Determining what a willing buyer would pay for the entire block introduces a block-level valuation that contradicts the per-unit measurement required for Level 1 inputs.$EXPL$,
  difficulty = 'medium'
WHERE id = 2226;
...
Wrong (C): The cost approach is one of the three recognized valuation approaches under ASC 820.$EXPL$,
  difficulty = 'easy'
WHERE id = 2227;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): ASC 820-10-35-24B does not prescribe a hierarchy among valuation approaches. The entity should use the approach (or combination) that is most representative of fair value in the circumstances, considering the availability and quality of inputs.
...
Wrong (D): Selecting the lowest value applies a conservatism principle that has no basis in the ASC 820 fair value framework.$EXPL$,
  difficulty = 'medium'
WHERE id = 2228;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 820-10-50-1, recurring fair value measurements are those required in the balance sheet at the end of each reporting period. Available-for-sale debt securities are measured at fair value every reporting period, making them recurring.
...
Wrong (D): Assets acquired in a business combination are measured at acquisition-date fair value only once, making this a nonrecurring measurement.$EXPL$,
  difficulty = 'medium'
WHERE id = 2229;
...
Wrong (C): The fair value amount at the reporting date is disclosed for all levels, not uniquely for Level 3.$EXPL$,
  difficulty = 'hard'
WHERE id = 2232;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 820-10-35-24C, the cost approach reflects the current replacement cost — the amount that would currently be required to replace the service capacity of an asset, adjusted for physical, functional, and economic obsolescence.
...
Wrong (C): Net realizable value is selling price less completion and disposal costs, a concept from inventory accounting (ASC 330), not the cost approach to fair value.$EXPL$,
  difficulty = 'easy'
WHERE id = 2234;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): ASC 820-10-50-2 requires disclosure of transfers between levels of the fair value hierarchy, including the reasons for the transfer and the amounts involved. Transfers between Level 2 and Level 3 are particularly significant because they indicate a change in the observability of inputs.
...
Wrong (C): Disclosing only the amounts without the reason is also insufficient; the standard requires both to provide adequate transparency.$EXPL$,
  difficulty = 'medium'
WHERE id = 2235;
...
Wrong (C): Selecting the lower value applies a conservatism concept that is not part of the fair value measurement framework.$EXPL$,
  difficulty = 'medium'
WHERE id = 2238;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 825-10-25, when the fair value option is elected, subsequent changes in fair value are recognized in net income. The $20,000 decrease ($500,000 − $480,000) is reported as a fair value loss in earnings. The fair value option, once elected, is irrevocable for that instrument.
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 820-10-35-5, if the exchange is the principal market (greatest volume and activity), the fair value is the quoted price in that market ($120,000) even if a more advantageous price exists elsewhere. The principal market is determined objectively based on volume and activity.
...
Wrong (D): The entity does not choose which market is principal; it is determined objectively by volume and level of activity under ASC 820-10-35-5.$EXPL$,
  difficulty = 'hard'
WHERE id = 2241;
...
Wrong (D): Transaction costs are not always ignored — they play a role in identifying the most advantageous market, even though they are excluded from the fair value measurement.$EXPL$,
  difficulty = 'hard'
WHERE id = 2242;
...
Wrong (D): Frequency of use is not a criterion; significance to the overall measurement determines the hierarchy classification.$EXPL$,
  difficulty = 'medium'
WHERE id = 2243;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 860-10-40-5, factoring without recourse transfers the credit risk to the factor. Since the seller has no continuing involvement or obligation if customers fail to pay, the transaction meets the criteria for a sale and the receivables are derecognized.
...
Wrong (D): A pledge of receivables encumbers the assets but does not transfer them; without-recourse factoring removes the receivables from the balance sheet entirely.$EXPL$,
  difficulty = 'easy'
WHERE id = 2251;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 860-30, pledging receivables as collateral does not constitute a transfer of ownership or control. The receivables remain on the borrower's balance sheet, and the loan proceeds are recorded as a liability. Disclosure of the pledge is required in the notes.
...
Wrong (D): Reducing receivables to net realizable value is an impairment concept unrelated to pledging collateral.$EXPL$,
  difficulty = 'easy'
WHERE id = 2253;
...
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-15, interest = Principal × Rate × Time = $100,000 × 8% × 6/12 = $4,000. The 6-month note runs from July 1 to December 31, so the full 6 months of interest has been earned by year-end.
...
Wrong (D): $100,000 is the principal amount of the note, not the interest receivable.$EXPL$,
  difficulty = 'easy'
WHERE id = 2255;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): ASC 326-20-30-7 requires consideration of all three factors: historical experience (past events), current conditions, and reasonable and supportable forecasts of future economic conditions. For periods beyond which reasonable forecasts can be made, the entity reverts to historical loss rates.
...
Wrong (D): The CECL model requires estimating expected losses over the life of the asset, not just losses that have been specifically identified — that was the incurred-loss model under legacy ASC 450-20.$EXPL$,
  difficulty = 'medium'
WHERE id = 2266;
...
Wrong (D): Deferred revenue applies to exchange transactions where performance obligations are unmet, not to donor-restricted contributions under ASC 958.$EXPL$,
  difficulty = 'easy'
WHERE id = 2270;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 958-605-25-5A, conditional promises to give are not recognized as revenue until the conditions (barriers) are substantially met. This pledge includes a barrier (raising matching funds) and a right of return. Since only $300,000 of $1,000,000 has been raised, the condition is not substantially met and the promise is disclosed in the notes only.
...
Wrong (D): Deferred revenue treatment applies to exchange transactions, not conditional contributions under ASC 958.$EXPL$,
  difficulty = 'medium'
WHERE id = 2272;
...
Wrong (C): Deducting an allowance for uncollectible pledges is a separate step from discounting; the initial measurement uses present value, and a separate allowance may also apply.$EXPL$,
  difficulty = 'medium'
WHERE id = 2273;
...
Wrong (C): There is no $10,000 minimum threshold for recognizing contributed services; recognition depends on the specialized skill and enhancement criteria.$EXPL$,
  difficulty = 'easy'
WHERE id = 2274;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASU 2020-07 and ASC 958-605-30, contributed nonfinancial assets are measured at fair value at the date of receipt using ASC 820 principles (exit price in the principal market). The NFP's independently determined fair value of $800,000 is the appropriate amount, not the donor's estimate.
...
Wrong (D): In-kind gifts of supplies are recognized as contributions when they meet the definition of an asset and have measurable fair value.$EXPL$,
  difficulty = 'medium'
WHERE id = 2276;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under UPMIFA (adopted by most states) and ASC 958-205-45-1, a not-for-profit may appropriate for expenditure an amount it considers prudent from the total endowment value. The 4% spending rate applied to the total endowment ($5,000,000 + $1,200,000 = $6,200,000) yields $248,000.
...
Wrong (C): Spending all $1,200,000 in accumulated returns would likely exceed a prudent appropriation and ignores the board's adopted 4% spending policy.$EXPL$,
  difficulty = 'hard'
WHERE id = 2279;
...
Wrong (C): Deferred revenue treatment applies to exchange transactions, not to split-interest agreements under ASC 958-30.$EXPL$,
  difficulty = 'hard'
WHERE id = 2281;
...
Wrong (D): NFPs are not required to follow the multi-step income statement format used by for-profit entities; presentation flexibility exists under ASC 958.$EXPL$,
  difficulty = 'easy'
WHERE id = 2283;
...
Wrong (C): Not capitalizing collections is explicitly permitted under ASC 958-360 when the qualifying conditions are met.$EXPL$,
  difficulty = 'medium'
WHERE id = 2287;
...
Wrong (D): $330,000 deducts only the bad debt ($350,000 − $20,000) while ignoring contractual adjustments.$EXPL$,
  difficulty = 'medium'
WHERE id = 2288;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 958-605-25-5A, from the grantor's perspective, a conditional grant is not recognized as expense until the recipient substantially meets the conditions (barriers). As the recipient meets conditions progressively, the grantor recognizes expense accordingly.
...
Wrong (C): Recognizing $37,500 per quarter assumes time-based recognition, but ASC 958-605 ties recognition to the satisfaction of barriers, not to a fixed schedule.$EXPL$,
  difficulty = 'medium'
WHERE id = 2291;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 958-230-45-3, donor-restricted contributions and investment income restricted for long-term purposes (such as acquiring long-lived assets or endowment) are classified as financing activities on the NFP's statement of cash flows.
...
Wrong (D): Supplemental disclosures are for noncash transactions; cash receipts of restricted contributions must be classified within the cash flow statement itself.$EXPL$,
  difficulty = 'medium'
WHERE id = 2292;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 958-605-25-36, special events with both exchange and contribution elements require bifurcation. Exchange revenue = 200 × $120 = $24,000 (fair value of benefits). Contribution revenue = (200 × $500) − $24,000 = $76,000 (amount exceeding fair value of benefits).
...
Wrong (D): A 50/50 split has no basis in ASC 958; bifurcation is based on the fair value of benefits provided, not an arbitrary allocation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2293;
...
Wrong (C): Averaging cost and fair value has no basis in GAAP; fair value at the date of receipt is the sole measurement attribute.$EXPL$,
  difficulty = 'easy'
WHERE id = 2296;
...
Wrong (C): $500,000 represents total undiscounted payments and ignores the time value of money required by ASC 958-30.$EXPL$,
  difficulty = 'hard'
WHERE id = 2297;
...
Wrong (C): $10,000,000 includes both the uncollectible portion and amounts not available within 60 days.$EXPL$,
  difficulty = 'medium'
WHERE id = 2298;
...
Wrong (C): Economic resources measurement focus is used for government-wide statements and proprietary funds under GASB 34, not for governmental fund-level reporting.$EXPL$,
  difficulty = 'easy'
WHERE id = 2299;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under GASB Statement No. 34, paragraph 69, fiduciary funds account for resources held in trust or as agent for parties outside the government. A pension trust fund for employee pension benefits is a fiduciary fund because the government holds and administers these resources for plan participants.
...
Wrong (D): A motor pool fleet fund is an internal service fund, which is a proprietary fund type used for services provided to other government departments.$EXPL$,
  difficulty = 'easy'
WHERE id = 2309;
...
Wrong (D): Bond proceeds restricted for capital construction are reported in a capital projects fund, which is a governmental fund type.$EXPL$,
  difficulty = 'medium'
WHERE id = 2310;
...
-- Issues: unstructured, no_citation
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under GASB Statement No. 34, paragraph 65, a permanent fund accounts for resources that are legally restricted so that only earnings, not principal, may be used to support government programs. Since the earnings benefit the government's own citizens (park maintenance), this is a permanent fund.
...
Wrong (D): A private-purpose trust fund is used when earnings benefit individuals, private organizations, or other governments rather than the reporting government's own programs.$EXPL$,
  difficulty = 'medium'
WHERE id = 2311;
...
Wrong (C): Recording $2,000,000 as an expense applies to the fund-level statements under modified accrual, where it is an expenditure, but not to the government-wide accrual-basis statements.$EXPL$,
  difficulty = 'medium'
WHERE id = 2314;
