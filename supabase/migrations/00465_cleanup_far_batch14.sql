...
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 360-10-30-1, the cost of property, plant, and equipment includes all expenditures necessary to acquire the asset and prepare it for its intended use. This includes the purchase price ($120,000), shipping ($8,000), and installation ($5,000), totaling $133,000.
...
Wrong (D): $136,000 incorrectly includes the $3,000 maintenance contract, which is a period expense because it maintains rather than enhances the asset.$EXPL$,
  difficulty = 'easy'
WHERE id = 1988;
...
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 360-10-35-4, the units-of-production method allocates depreciable cost based on actual usage. Depreciable base = $80,000 − $5,000 = $75,000. Rate per mile = $75,000 / 200,000 = $0.375. Year 1 depreciation = 35,000 × $0.375 = $13,125.
...
Wrong (D): $15,750 likely results from applying an incorrect mileage figure or failing to deduct salvage value properly.$EXPL$,
  difficulty = 'easy'
WHERE id = 1992;
...
Wrong (C): Replacement cost of the asset is irrelevant to measuring the retirement obligation, which relates to the cost of settling the obligation, not replacing the asset.$EXPL$,
  difficulty = 'medium'
WHERE id = 1999;
...
Wrong (D): Recording the adjustment in other comprehensive income is incorrect because ARO adjustments are recognized through the asset and liability, not through OCI.$EXPL$,
  difficulty = 'hard'
WHERE id = 2001;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 360-10-35-17, impairment of assets held and used follows a two-step process. Step 1: the carrying amount ($2,000,000) exceeds undiscounted future cash flows ($1,800,000), confirming impairment. Step 2: the impairment loss equals carrying amount minus fair value = $2,000,000 − $1,500,000 = $500,000.
...
Wrong (D): $300,000 does not correspond to any correct application of the two-step impairment test under ASC 360.$EXPL$,
  difficulty = 'hard'
WHERE id = 2008;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 360-10-35-20, once an impairment loss is recognized on a long-lived asset held and used, the reduced carrying amount becomes the new cost basis. Restoration of previously recognized impairment losses is prohibited under U.S. GAAP.
...
Wrong (D): Assets held for sale follow ASC 360-10-35-40, which allows subsequent increases in fair value less costs to sell, but only up to the cumulative loss previously recognized — this does not apply to assets held and used.$EXPL$,
  difficulty = 'medium'
WHERE id = 2009;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 360-10-45-9, when an asset is reclassified to held-for-sale, it is measured at the lower of carrying amount or fair value less costs to sell. Since $350,000 < $400,000, a $50,000 loss is recognized. Depreciation ceases once the asset is classified as held-for-sale.
...
Wrong (C): Waiting until the asset is sold would fail to recognize the impairment at the reclassification date, violating the lower-of-cost-or-fair-value-less-costs-to-sell requirement.$EXPL$,
  difficulty = 'hard'
WHERE id = 2014;
...
Wrong (D): A customer list with a 5-year attrition rate has a determinable useful life based on the expected pattern of economic benefit and must be amortized.$EXPL$,
  difficulty = 'easy'
WHERE id = 2019;
...
Wrong (D): Replacement cost is not the measurement basis for goodwill impairment; ASC 350 uses fair value of the reporting unit as the benchmark.$EXPL$,
  difficulty = 'medium'
WHERE id = 2020;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 730-10-25-1, all research and development costs are expensed as incurred. This includes materials consumed ($120,000), personnel costs ($200,000), depreciation on equipment with no alternative future use ($45,000), and a reasonable allocation of overhead ($30,000), totaling $395,000.
...
Wrong (D): $350,000 omits the depreciation on R&D equipment ($45,000), which must be expensed because the equipment has no alternative future use.$EXPL$,
  difficulty = 'medium'
WHERE id = 2024;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 730-10-25-2, equipment acquired for R&D that has alternative future use beyond the current project is capitalized as a fixed asset and depreciated over its useful life. The depreciation charge is then allocated to R&D expense for periods the equipment is used in R&D.
...
Wrong (D): Costs of operating a dedicated R&D facility are expensed as incurred under ASC 730, including depreciation and maintenance of the facility.$EXPL$,
  difficulty = 'medium'
WHERE id = 2032;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 350-40-25-2, internal-use software costs are capitalized only during the application development stage. Preliminary project stage costs ($80,000) and post-implementation stage costs ($40,000) are expensed as incurred, leaving $350,000 to be capitalized.
...
Wrong (D): $80,000 represents only the preliminary project stage costs, which are expensed, not capitalized — this inverts the correct treatment.$EXPL$,
  difficulty = 'medium'
WHERE id = 2033;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 350-20-35-13, once a goodwill impairment loss is recognized, it cannot be reversed in subsequent periods. Any recovery in value would be considered internally generated goodwill, which is not recognized under U.S. GAAP.
...
Wrong (D): A qualitative assessment may indicate no further impairment is needed, but it cannot be used to reverse a previously recognized impairment loss.$EXPL$,
  difficulty = 'easy'
WHERE id = 2034;
...
Wrong (D): $150,000 overstates amortization and does not match either the revenue ratio method or straight-line calculation.$EXPL$,
  difficulty = 'hard'
WHERE id = 2045;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 842-10-25-2, a lease is classified as a finance lease if any one of five criteria is met, including when the present value of lease payments equals or exceeds substantially all (typically 90% or more) of the asset's fair value.
...
Wrong (D): A renewal option alone is not a classification criterion; it affects lease classification only to the extent it changes the lease term when reasonably certain to be exercised.$EXPL$,
  difficulty = 'easy'
WHERE id = 2046;
...
Wrong (D): Variable expense based on actual usage applies only to variable lease payments tied to usage or performance, not to the base lease cost of an operating lease.$EXPL$,
  difficulty = 'easy'
WHERE id = 2048;
...
Wrong (C): Capitalizing total lease payments as a prepaid asset is not a recognized treatment under ASC 842 for any lease classification.$EXPL$,
  difficulty = 'medium'
WHERE id = 2051;
...
Wrong (D): Initial direct costs are added to the ROU asset, not included in the lease liability measurement.$EXPL$,
  difficulty = 'medium'
WHERE id = 2052;
...
Wrong (D): Direct financing lease is a lessor classification under ASC 842, not a lessee classification — lessees classify leases as either finance or operating.$EXPL$,
  difficulty = 'medium'
WHERE id = 2053;
...
Wrong (D): Leveraged lease is a legacy classification from ASC 840 that is no longer recognized under ASC 842 for new leases.$EXPL$,
  difficulty = 'easy'
WHERE id = 2055;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 842-20-25-6, operating lease expense is recognized on a straight-line basis over the lease term. Total payments = (2 × $40,000) + (4 × $60,000) = $320,000. Annual straight-line expense = $320,000 / 6 = $53,333.
...
Wrong (D): $60,000 is the Year 3-6 payment amount and ignores the lower payments in the first two years that reduce the straight-line average.$EXPL$,
  difficulty = 'medium'
WHERE id = 2057;
...
Wrong (D): Expensing additional payments as incurred ignores the requirement to remeasure the lease liability and adjust the ROU asset prospectively.$EXPL$,
  difficulty = 'medium'
WHERE id = 2058;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 842-20-50-4, lessees must disclose a maturity analysis of lease liabilities showing undiscounted future lease payments for each of the first five years and a total for remaining years, reconciled to the lease liabilities on the balance sheet.
...
Wrong (D): The fair value of the leased asset at commencement is used by the lessor for classification purposes and is not a required lessee disclosure.$EXPL$,
  difficulty = 'medium'
WHERE id = 2059;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 842-20-30-5, the lease liability = $24,000 × 2.7232 = $65,357. The ROU asset equals the lease liability minus lease incentives received: $65,357 − $6,000 = $59,357. Lease incentives reduce the ROU asset, not the lease liability.
...
Wrong (D): $71,357 appears to subtract only a partial amount rather than the full $6,000 incentive from a base figure.$EXPL$,
  difficulty = 'hard'
WHERE id = 2060;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 842-20-30-5, the lease liability = $30,000 × 3.6730 = $110,190. The ROU asset = lease liability + initial direct costs = $110,190 + $4,000 = $114,190. Initial direct costs are added to the ROU asset but are not included in the lease liability.
...
Wrong (D): $116,190 does not correspond to any correct combination of the lease liability and initial direct costs.$EXPL$,
  difficulty = 'medium'
WHERE id = 2065;
...
Wrong (C): Exclusive use of a vehicle for 2 years involves a specifically identified asset under customer control, satisfying the lease criteria.$EXPL$,
  difficulty = 'medium'
WHERE id = 2067;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 842-20-25-6, operating lease expense is recognized on a straight-line basis over the entire lease term, including rent-free periods. Total payments = $210,000. Annual straight-line expense = $210,000 / 5 years = $42,000.
...
Wrong (D): $35,000 does not correspond to the correct total payments divided by the lease term.$EXPL$,
  difficulty = 'easy'
WHERE id = 2068;
...
Wrong (C): Immediate expensing is incorrect because the costs provide benefit over the entire term of the debt and must be amortized.$EXPL$,
  difficulty = 'medium'
WHERE id = 2083;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 470-50-40-2, gain or loss on early extinguishment equals carrying amount minus reacquisition price. Here: $960,000 − $975,000 = −$15,000, a loss. The reacquisition price exceeds the carrying amount (which includes the unamortized discount), resulting in a loss.
...
Wrong (C): A $25,000 loss incorrectly computes the difference from face value rather than carrying amount; the carrying amount (net of discount) is the relevant figure.$EXPL$,
  difficulty = 'medium'
WHERE id = 2084;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 470-20-25-12 (book value method), when convertible bonds are converted, the carrying amount ($4,850,000) is transferred to equity with no gain or loss. Shares issued = ($5,000,000 / $1,000) × 50 = 250,000 shares. Common stock at par = 250,000 × $10 = $2,500,000. APIC = $4,850,000 − $2,500,000 = $2,350,000.
...
Wrong (D): Crediting the full $4,850,000 to common stock only ignores the distinction between par value and additional paid-in capital.$EXPL$,
  difficulty = 'hard'
WHERE id = 2087;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-45-1A, bond issuance costs are presented as a direct deduction from the carrying amount of the debt. Carrying amount = $1,000,000 − $25,000 = $975,000. The issuance costs will be amortized over the bond term, increasing effective interest expense.
...
Wrong (D): $997,500 does not correspond to any correct calculation of par value minus issuance costs.$EXPL$,
  difficulty = 'easy'
WHERE id = 2089;
...
Wrong (D): Recognizing the premium as revenue is incorrect because the premium represents an excess price paid for the debt instrument, not earned revenue.$EXPL$,
  difficulty = 'medium'
WHERE id = 2100;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 835-30-45-1A, both the bond discount and issuance costs reduce the carrying amount. Issue price = $800,000 × 0.94 = $752,000. After deducting issuance costs of $12,000: initial carrying amount = $752,000 − $12,000 = $740,000.
...
Wrong (D): $800,000 is the par value and ignores both the discount and the issuance costs.$EXPL$,
  difficulty = 'medium'
WHERE id = 2106;
...
Wrong (C): Retained earnings is not unchanged — it decreases by the fair value (for small stock dividends) or par value (for large stock dividends) of the shares issued.$EXPL$,
  difficulty = 'medium'
WHERE id = 2118;
...
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 505-30-30-6 (par value method), treasury stock is debited at par ($10). The original APIC from issuance is reversed: $25 − $10 = $15 debited to APIC. The excess of reacquisition cost over original issue price is charged to retained earnings: $30 − $25 = $5 debited to RE. Cash is credited $30.
...
Wrong (D): Debiting treasury stock at $25 and recognizing a gain on treasury stock is incorrect because treasury stock transactions never result in gains or losses on the income statement.$EXPL$,
  difficulty = 'hard'
WHERE id = 2121;
...
Wrong (C): Converting preferred stock to common stock is a recapitalization transaction, not a quasi-reorganization, and does not address retained earnings deficits.$EXPL$,
  difficulty = 'hard'
WHERE id = 2127;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 450-20-25-2, when the likelihood of a loss contingency is remote, neither accrual nor disclosure is required. The only exception is for guarantees of indebtedness of others under ASC 460, which require disclosure even if remote.
...
Wrong (D): Accruing a partial amount has no basis under ASC 450; accrual is an all-or-nothing determination based on the probability and estimability criteria.$EXPL$,
  difficulty = 'easy'
WHERE id = 2141;
...
Wrong (C): Accruing $400,000 is inappropriate because the likelihood of having to perform is remote, so the contingent loss does not meet the accrual threshold under ASC 450.$EXPL$,
  difficulty = 'medium'
WHERE id = 2142;
...
Wrong (C): No disclosure would be inadequate when the gain is probable; ASC 450-30 requires note disclosure for probable gain contingencies.$EXPL$,
  difficulty = 'medium'
WHERE id = 2143;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 450-20-25-5, loss contingencies are generally not discounted to present value. The full estimated amount of $2,000,000 should be accrued. Discounting is only permitted when the amount and timing of payments are fixed or reliably determinable and a specific authoritative standard supports it.
...
Wrong (D): Discounting only when timing is fixed describes the narrow exception, but even then a specific authoritative standard must support it — the general rule under ASC 450 is no discounting.$EXPL$,
  difficulty = 'hard'
WHERE id = 2145;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 855-10-25-1, the lawsuit settlement is a recognized (Type I) subsequent event because the lawsuit existed at the balance sheet date. The settlement provides additional evidence about conditions at year-end, so the financial statements should be adjusted to accrue the $500,000 loss.
...
Wrong (D): Accruing $250,000 as a compromise has no basis in GAAP; the settlement amount of $500,000 is the best estimate and must be accrued in full.$EXPL$,
  difficulty = 'hard'
WHERE id = 2147;
...
Wrong (C): A probable future outflow of resources is the accrual criterion for a loss contingency, not the definition of a commitment.$EXPL$,
  difficulty = 'medium'
WHERE id = 2148;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 450-20-25-2 and further specified by ASC 326 (CECL model), credit losses on accounts receivable represent a loss contingency that is typically probable and estimable, requiring accrual through an allowance for doubtful accounts.
...
Wrong (C): A guarantee where loss is remote does not meet the accrual criteria, though ASC 460 requires note disclosure of the guarantee.$EXPL$,
  difficulty = 'easy'
WHERE id = 2151;
...
Wrong (C): Expected value of future payments is a component that may be used in estimating fair value, but the standard specifically requires fair value, not expected value alone.$EXPL$,
  difficulty = 'medium'
WHERE id = 2153;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 450-20-25-2, when it is probable that an unasserted claim will be asserted and, upon assertion, a loss is probable and reasonably estimable, the entity must accrue the estimated loss. Both conditions are met here — probable assertion and probable loss of $250,000.
...
Wrong (D): Accruing $125,000 as a conservative estimate has no basis under ASC 450; when a single best estimate exists, that amount must be accrued in full.$EXPL$,
  difficulty = 'hard'
WHERE id = 2154;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 450-30-25-1, gain contingencies are never accrued regardless of probability, even when virtually certain. The appropriate treatment is note disclosure. Gain contingencies are recognized only when realized — typically when cash is received or a legally binding settlement is finalized.
...
Wrong (D): Waiting until cash is received without any disclosure would be inadequate when a gain contingency is virtually certain; note disclosure is warranted.$EXPL$,
  difficulty = 'medium'
WHERE id = 2156;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 740-10-30-5, a valuation allowance is required when it is more likely than not (greater than 50% likelihood) that some portion or all of the deferred tax asset will not be realized. The assessment considers all available positive and negative evidence.
...
Wrong (C): There is no dollar threshold in ASC 740; the valuation allowance requirement is based on probability of realization, not the size of the DTA.$EXPL$,
  difficulty = 'easy'
WHERE id = 2164;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 740-10-30-3, deferred tax assets and liabilities are computed using enacted tax rates. DTL from depreciation = $200,000 × 21% = $42,000. DTA from warranty = $60,000 × 21% = $12,600. Net DTL = $42,000 − $12,600 = $29,400. Under ASC 740-10-45-6, DTAs and DTLs from the same jurisdiction are presented net.
...
Wrong (D): $12,600 represents only the DTA from the warranty accrual and ignores the larger DTL from depreciation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2166;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 740-10-35-4, deferred taxes are adjusted in the period the rate change is enacted. The underlying temporary difference = $420,000 / 0.21 = $2,000,000. New DTL at 25% = $2,000,000 × 0.25 = $500,000, an increase of $80,000. This adjustment is recognized as additional income tax expense.
...
Wrong (D): Reporting the adjustment in OCI is incorrect; rate change adjustments on items originally recognized in income are reported in income tax expense, not OCI.$EXPL$,
  difficulty = 'hard'
WHERE id = 2170;
...
Wrong (D): Reasonably possible (25-50%) is below the required threshold and is a classification used in ASC 450 for contingencies requiring disclosure only.$EXPL$,
  difficulty = 'easy'
WHERE id = 2173;
