...
Wrong (D): The remeasurement gain is reported in net income, not other comprehensive income. OCI treatment would apply to certain investment reclassifications, but not to property dividend remeasurements.$19$,
  difficulty = 'hard'
WHERE id = 172;
...
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 740-10-25-6, an uncertain tax position is recognized only if it is more likely than not (greater than 50% likelihood) to be sustained upon examination by the taxing authority based on its technical merits. This is Step 1 of the two-step recognition and measurement process.
...
Wrong (D): "Reasonably possible" is a lower threshold than more likely than not and is used for disclosure of contingencies under ASC 450, not for recognition of tax benefits under ASC 740.$19$,
  difficulty = 'medium'
WHERE id = 175;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 350-20-35-33, goodwill acquired in a business combination is assigned to and tested for impairment at the reporting unit level. A reporting unit is an operating segment or one level below an operating segment (a component). Goodwill is allocated to reporting units that benefit from the synergies of the combination.
...
Wrong (D): Testing at the consolidated entity level would aggregate reporting units with different economic characteristics, potentially masking impairment in one unit with strong performance in another.$19$,
  difficulty = 'medium'
WHERE id = 187;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under IAS 16.31, IFRS permits the revaluation model for property, plant, and equipment, allowing assets to be carried at fair value with changes recognized in other comprehensive income (revaluation surplus). U.S. GAAP (ASC 360) requires the cost model only and does not permit upward revaluation of PP&E.
...
Wrong (D): Both IFRS (IAS 38.48) and U.S. GAAP (ASC 350-20-25-2) prohibit recognition of internally generated goodwill, so this is not a difference between the frameworks.$19$,
  difficulty = 'medium'
WHERE id = 371;
...
Wrong (D): Goodwill impairment losses are recognized in net income under ASC 350-20-35-1, not in OCI. Impairment is a charge against earnings in the period identified.$19$,
  difficulty = 'medium'
WHERE id = 373;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under FASB ASC 105-10-05-1, the FASB Accounting Standards Codification is the sole source of authoritative nongovernmental U.S. GAAP. When a nonauthoritative source conflicts with the Codification, the Codification always takes precedence regardless of any other factors.
...
Wrong (D): Entities do not have the option to choose between authoritative and nonauthoritative sources. The Codification is mandatory for GAAP-compliant financial reporting.$19$,
  difficulty = 'easy'
WHERE id = 375;
...
Wrong (C): This reverses the actual requirement. GAAP requires functional classification, and IFRS permits either nature or function — not the other way around.$19$,
  difficulty = 'hard'
WHERE id = 376;
...
Wrong (D): Extraordinary item classification was eliminated under ASU 2015-01 (ASC 225-20). Even before elimination, a depreciation method change would not have qualified as extraordinary.$19$,
  difficulty = 'hard'
WHERE id = 378;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 606-10-55-36 through 55-40, an entity is a principal if it controls the specified good or service before transfer to the customer. Being primarily responsible for fulfilling the promise is a key indicator of control and principal status, as the entity bears fulfillment risk.
...
Wrong (D): Having no pricing discretion is an indicator of agent status under ASC 606-10-55-39. Principals typically have the ability to establish prices for the goods or services.$19$,
  difficulty = 'easy'
WHERE id = 384;
...
Wrong (C): Cash receipt is not the recognition trigger. ASC 606 is not a cash-basis framework — revenue is recognized when the underlying sale or usage occurs, regardless of when cash is collected.$19$,
  difficulty = 'medium'
WHERE id = 386;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 606-10-25-12 through 25-13, when a contract modification adds distinct goods or services and the price increase reflects standalone selling prices, the modification is treated as a separate contract. If the remaining goods are distinct but the price does not reflect standalone selling prices, the modification is treated as a termination of the existing contract and creation of a new one.
...
Wrong (D): Contract modifications under ASC 606 are not changes in accounting estimates under ASC 250. They are addressed by specific modification guidance within the revenue recognition standard.$19$,
  difficulty = 'hard'
WHERE id = 387;
...
Wrong (D): The interest rate relative to the prime rate is not a factor in the practical expedient. The expedient is based solely on the timing between transfer and payment being one year or less.$19$,
  difficulty = 'easy'
WHERE id = 388;
...
Wrong (D): Bearing credit risk on the receivable is an indicator considered in the analysis but is not the core principle. Control of the good or service before transfer is the fundamental test under ASC 606.$19$,
  difficulty = 'medium'
WHERE id = 389;
...
Wrong (D): The margin rate is central to the calculation. The method converts sales to estimated COGS using the gross profit percentage, so the rate directly determines the inventory estimate.$19$,
  difficulty = 'easy'
WHERE id = 394;
...
Wrong (D): The retail method estimates cost, not net realizable value. While NRV is relevant for lower-of-cost-or-NRV testing, the retail method''s purpose is to approximate the cost of ending inventory.$19$,
  difficulty = 'easy'
WHERE id = 395;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under IRC Section 472, if a taxpayer elects LIFO for federal income tax purposes, it must also use LIFO for financial reporting in its primary financial statements. This LIFO conformity rule is a rare instance where tax law dictates financial reporting methodology.
...
Wrong (D): There is no $10 million inventory threshold for the conformity rule. The requirement applies to any entity that elects LIFO for tax regardless of inventory size.$19$,
  difficulty = 'medium'
WHERE id = 398;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 410-20-25-2, an asset retirement obligation is initially measured at fair value (typically the present value of estimated future cash flows) when a reasonable estimate can be made. An equal amount is capitalized as an increase to the carrying amount of the related long-lived asset. The capitalized cost is depreciated over the asset''s useful life, and the liability accretes to its settlement value over time.
...
Wrong (D): There is no 10% materiality threshold for ARO recognition. The obligation is recorded whenever a legal obligation exists and a reasonable estimate of fair value can be made.$19$,
  difficulty = 'medium'
WHERE id = 400;
...
Wrong (D): $180,000 would result from applying an incorrect blended rate or misallocating expenditures between the specific and general borrowings.$19$,
  difficulty = 'hard'
WHERE id = 401;
...
Wrong (D): Lower-of-cost-or-market is an inventory concept under ASC 330, not the measurement basis for nonmonetary exchanges. The correct basis is the book value of the asset given up.$19$,
  difficulty = 'easy'
WHERE id = 403;
...
UPDATE questions SET
  stem = $19$Which of the following criteria must be met to classify a long-lived asset as held for sale under ASC 360?$19$,
  choices = $19$["The asset must be fully depreciated before reclassification","Management must commit to a sell plan with sale probable within one year","A binding purchase agreement must be signed with an identified buyer","The asset must first be tested and found to be impaired"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 360-10-45-9, held-for-sale classification requires that management with authority commits to a plan to sell, the asset is available for immediate sale in its present condition, an active program to locate a buyer has been initiated, the sale is probable and expected within one year, and the asset is being actively marketed at a reasonable price.
...
Wrong (D): Impairment is not a prerequisite for held-for-sale classification. An asset may be classified as held for sale regardless of whether it is impaired; impairment testing occurs separately after reclassification.$19$,
  difficulty = 'medium'
WHERE id = 405;
...
Wrong (D): Writing down to net realizable value is an inventory concept under ASC 330. Long-lived asset impairment under ASC 360 measures the loss as carrying amount minus fair value, not net realizable value.$19$,
  difficulty = 'medium'
WHERE id = 407;
...
Wrong (D): Significant initial direct costs are a cost consideration for the lessor but are not a classification criterion under ASC 842-10-25-2. Classification depends on the transfer-of-control indicators, not cost levels.$19$,
  difficulty = 'medium'
WHERE id = 418;
...
Wrong (D): Impairment of the right-of-use asset is a separate assessment under ASC 360, not a consequence of a lease modification. Modifications affect lease terms and payments, not asset impairment.$19$,
  difficulty = 'medium'
WHERE id = 420;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 842-10-35-3, the sublessor (original lessee) classifies a sublease by reference to the right-of-use asset arising from the head lease, not the underlying asset itself. The sublessor is effectively transferring its right-of-use, so classification criteria are applied relative to the ROU asset''s remaining value and term.
...
Wrong (D): Total remaining payments on the head lease represent the sublessor''s obligation, not the asset being subleased. Classification is based on the ROU asset, and the head lease payments are a separate liability.$19$,
  difficulty = 'hard'
WHERE id = 421;
...
Wrong (D): Deferred gain amortization was the treatment under the previous standard (ASC 840). Under ASC 842, if the transfer is not a sale, it is a financing arrangement — there is no gain to defer.$19$,
  difficulty = 'hard'
WHERE id = 422;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 470-50-40-2, when bonds are extinguished early, the difference between the reacquisition price ($960,000) and the carrying amount ($940,000) is recognized as a loss of $20,000 in net income in the period of extinguishment. The carrying amount reflects the face value net of any unamortized discount.
...
Wrong (D): Extraordinary item classification was eliminated under ASU 2015-01 (ASC 225-20). Even before elimination, the standard no longer required debt extinguishment gains and losses to be classified as extraordinary.$19$,
  difficulty = 'easy'
WHERE id = 432;
...
Wrong (D): The intrinsic value method is not permitted under ASC 718 for share-based payment awards. ASC 718-10-30-2 requires fair-value-based measurement at the grant date for equity-classified awards.$19$,
  difficulty = 'medium'
WHERE id = 446;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-25-6, the "more likely than not" threshold means a greater than 50% likelihood that the tax position will be sustained upon examination by the taxing authority based on its technical merits. This is the Step 1 recognition threshold in the two-step process for uncertain tax positions.
...
Wrong (D): A 25% probability is well below the more-likely-than-not threshold. At only 25% likelihood, the position would fail Step 1 and the tax benefit would not be recognized.$19$,
  difficulty = 'easy'
WHERE id = 447;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 740-10-35-4, deferred tax assets and liabilities are adjusted for the effect of enacted changes in tax rates in the period of enactment. The resulting adjustment is recognized in income from continuing operations, providing immediate transparency about the rate change''s effect on future tax consequences.
...
Wrong (D): The effect of a rate change is recognized in income from continuing operations, not in other comprehensive income. OCI recognition applies only to deferred tax effects related to items originally recognized in OCI.$19$,
  difficulty = 'medium'
WHERE id = 448;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-30-5, a valuation allowance is established to reduce the deferred tax asset to the amount that is more likely than not to be realized. The DTA remains at $500,000 as a gross asset, and a $200,000 valuation allowance (contra-asset) reduces the net DTA to $300,000 on the balance sheet.
...
Wrong (D): Disclosure alone is insufficient. ASC 740 requires a balance sheet adjustment through the valuation allowance when it is more likely than not that some portion of the DTA will not be realized.$19$,
  difficulty = 'easy'
WHERE id = 449;
...
Wrong (C): Government-mandated nonexchange transactions involve one level of government requiring another to perform a function, often with accompanying funding. Property taxes are imposed directly on citizens, not mandated between governments.$19$,
  difficulty = 'medium'
WHERE id = 460;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB Statement No. 34, paragraphs 23-25, the modified approach for infrastructure assets allows a government to forgo depreciation if it (1) maintains assets at or above a condition level it establishes and discloses, (2) performs condition assessments at least every three years, and (3) expenses maintenance and preservation costs in the period incurred. Additions and improvements are still capitalized.
...
Wrong (D): Reporting infrastructure assets at fair value each year is not required under any GASB approach. The modified approach requires condition assessments, not fair value remeasurement.$19$,
  difficulty = 'hard'
WHERE id = 463;
...
Wrong (C): Fund-based presentation (general fund, special revenue, etc.) is used in governmental fund financial statements, not in the government-wide statements. The government-wide statements consolidate all governmental activities regardless of fund structure.$19$,
  difficulty = 'medium'
WHERE id = 465;
...
Wrong (D): A reporting requirement is an administrative obligation, not a substantive barrier. The donor retains no right of return simply because a report is not filed, so this does not make the contribution conditional.$19$,
  difficulty = 'medium'
WHERE id = 467;
...
Wrong (D): Reclassifying the entire endowment to net assets without donor restrictions would violate the donor''s original restriction. The donor restriction persists regardless of whether the endowment is underwater.$19$,
  difficulty = 'hard'
WHERE id = 472;
...
Wrong (C): A contractual right to receive all profits, without the power to direct significant activities, does not satisfy the dual-condition test. Both power and economic exposure must be present simultaneously.$19$,
  difficulty = 'medium'
WHERE id = 476;
...
Wrong (C): Writing the previously held interest to zero and absorbing the difference into goodwill has no basis in ASC 805. The standard requires fair value remeasurement with gain or loss recognition, not elimination.$19$,
  difficulty = 'hard'
WHERE id = 477;
...
Wrong (D): While allocation to identifiable assets is part of the process, the excess is first analyzed for specific asset attributions before any remainder is assigned to goodwill. This choice omits the ongoing amortization of the identifiable portions.$19$,
  difficulty = 'hard'
WHERE id = 478;
...
Wrong (D): The excess is not credited to additional paid-in capital. It is recognized as a gain in net income because it represents an economic benefit to the acquirer from purchasing net assets below their fair value.$19$,
  difficulty = 'medium'
WHERE id = 481;
...
Wrong (D): Designing an entity so that non-equity interests absorb expected losses is a hallmark of a VIE structure under ASC 810-10-15-14(b). This disproportionate risk allocation is exactly what the VIE model is designed to capture.$19$,
  difficulty = 'hard'
WHERE id = 483;
...
Wrong (C): Negative goodwill amortization over a useful life is not permitted under ASC 805. The excess is recognized as an immediate gain in net income after the acquirer''s reassessment confirms the measurement.$19$,
  difficulty = 'medium'
WHERE id = 486;
...
-- Issues: no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 305-10-05-1, cash includes amounts on deposit with financial institutions. A bank reconciliation identifies and explains differences between the ending cash balance per the bank statement and the ending cash balance per the company''s books, adjusting both to the correct (true) cash balance. Common reconciling items include outstanding checks, deposits in transit, bank charges, and errors.
...
Wrong (D): Calculating total deposits is not the goal. The reconciliation focuses on explaining the difference between two independently maintained records of the same cash balance.$19$,
  difficulty = 'easy'
WHERE id = 1099;
...
Wrong (D): A compensating balance is an asset of the depositor, not a reduction of the related liability. The bank holds the funds in the company''s account, and the balance represents a restricted asset, not an offset to debt.$19$,
  difficulty = 'medium'
WHERE id = 1102;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Ridgemont Manufacturing sponsors a 401(k) defined contribution plan, while its subsidiary sponsors a defined benefit pension plan. During a year when the stock market declines 20%, the DC plan''s employer expense is unchanged while the DB plan records a significant actuarial loss. How does the risk allocation differ between the two plan types?$19$,
  choices = $19$["Both plan types expose the employer to identical investment risk with only presentational differences","The DC plan shifts investment risk to employees while the DB plan retains it with the employer, increasing the underfunded liability","The DC plan creates greater employer risk because matching contributions rise when employees increase deferrals","The DB plan is less risky because the pension trust absorbs all investment losses with no employer impact"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 715-70-25-1, a defined contribution plan limits the employer''s obligation to the specified contribution amount. Once the match is deposited, investment risk transfers to the employee. Under ASC 715-30-35-26, a defined benefit plan retains investment risk with the employer — when plan assets decline, the funded status deteriorates because the projected benefit obligation (PBO) is unchanged, and actuarial losses are recognized in OCI.
...
Wrong (D): Investment losses in a DB plan directly affect the employer''s funded status and balance sheet. The pension trust does not shield the employer — asset declines increase the net pension liability reported under ASC 715.$19$,
  difficulty = 'easy'
WHERE id = 1108;
...
Wrong (D): Deferring recognition until benefits are paid would understate the pension obligation and related expense during the amortization period. The plan amendment creates an immediate obligation that must be recognized.$19$,
  difficulty = 'medium'
WHERE id = 1111;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 715-30-20, the projected benefit obligation (PBO) is the only measure that incorporates projected future salary increases when estimating the present value of future pension benefits. The PBO is used for pension expense calculations and balance sheet reporting of the funded status.
...
Wrong (D): Only the PBO incorporates projected salary increases. The ABO explicitly excludes them, which is the defining distinction between the two measures under ASC 715.$19$,
  difficulty = 'medium'
WHERE id = 1112;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$A company settles its pension obligation by purchasing annuity contracts. The PBO is $4,000,000, plan assets are $3,700,000, and the annuity cost is $3,850,000. What is the settlement result?$19$,
  choices = $19$["A settlement gain of $150,000","A settlement loss of $150,000","A settlement loss of $300,000","No gain or loss on settlement"]$19$::jsonb,
  explanation = $19$Correct (A): Under ASC 715-30-35-80, a pension settlement gain or loss equals the difference between the PBO settled and the cost of settlement. The company eliminates a $4,000,000 obligation for $3,850,000, yielding a $150,000 settlement gain. The plan assets of $3,700,000 determine the additional cash outlay ($150,000) but do not define the settlement gain or loss.
...
Wrong (D): A gain exists because the settlement cost ($3,850,000) is less than the PBO eliminated ($4,000,000). Whenever the cost of settlement differs from the obligation settled, a gain or loss must be recognized.$19$,
  difficulty = 'hard'
WHERE id = 1115;
...
Wrong (D): Section 179 full expensing is elective and subject to annual limits. The question specifies MACRS at a 20% rate, which is the standard first-year percentage for 5-year property, not full Section 179 expensing.$19$,
  difficulty = 'medium'
WHERE id = 1117;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under IRC Section 197, goodwill acquired in a business acquisition is classified as a Section 197 intangible and amortized ratably over 15 years for tax purposes. This contrasts with GAAP treatment under ASC 350-20-35, where goodwill is not amortized but is tested for impairment annually.
...
Wrong (D): A 40-year amortization period was used under the predecessor standard (APB 17) for GAAP purposes and has no application under current tax law. Section 197 specifies 15 years.$19$,
  difficulty = 'medium'
WHERE id = 1120;
...
Wrong (D): A compilation engagement addresses the financial statements, not the tax return. The CPA does not examine or express any conclusion about the underlying tax return in a compilation report.$19$,
  difficulty = 'medium'
WHERE id = 1121;
