...
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 260-10-45-16, diluted EPS is computed using the treasury stock method for stock options. Proceeds = 20,000 × $30 = $600,000. Shares repurchased at market = $600,000 / $40 = 15,000. Incremental dilutive shares = 20,000 − 15,000 = 5,000. Diluted EPS = $500,000 / (100,000 + 5,000) = $4.76.
...
Wrong (D): $4.35 overstates the incremental share count, likely by failing to calculate the repurchase correctly under the treasury stock method.$EXPL$,
  difficulty = 'medium'
WHERE id = 1918;
...
Wrong (C): 195,000 adds the full 15,000 shares without time-weighting the mid-year issuance.$EXPL$,
  difficulty = 'medium'
WHERE id = 1919;
...
Wrong (D): The $4.00 threshold is fabricated; the correct comparison is the per-share effect ($5.00) against basic EPS ($6.00).$EXPL$,
  difficulty = 'medium'
WHERE id = 1922;
...
UPDATE questions SET
  stem = $EXPL$Under ASC 606, how is a performance obligation defined?$EXPL$,
  choices = $EXPL$["A promise to transfer any item listed in the contract","A promise to transfer only tangible goods to the customer","A promise to transfer a distinct good or service, or a similar series","A promise to transfer the entire contract bundle as a single unit"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (C): Under ASC 606-10-25-14, a performance obligation is a promise to transfer a distinct good or service—or a series of distinct goods or services that are substantially the same and share the same pattern of transfer—to the customer. Distinctness, not mere contractual listing, determines the unit of account.
...
Wrong (D): The entire bundle is treated as a single obligation only when the goods or services are not distinct from each other.$EXPL$,
  difficulty = 'easy'
WHERE id = 1924;
...
Wrong (C): $2,000,000 would recognize the full contract price, which is only appropriate when the obligation is fully satisfied.$EXPL$,
  difficulty = 'medium'
WHERE id = 1928;
...
Wrong (C): The residual approach under ASC 606-10-32-34 is used to estimate standalone selling prices when they are highly variable, not to estimate variable consideration.$EXPL$,
  difficulty = 'medium'
WHERE id = 1931;
...
Wrong (D): $85,000 does not correspond to any valid allocation method under ASC 606.$EXPL$,
  difficulty = 'medium'
WHERE id = 1932;
...
Wrong (C): $900 represents the unearned portion (contract liability), not the revenue recognized for the period.$EXPL$,
  difficulty = 'easy'
WHERE id = 1936;
...
Wrong (C): Deducting estimated returns from gross revenue is a separate concept from the principal-versus-agent determination.$EXPL$,
  difficulty = 'easy'
WHERE id = 1937;
...
Wrong (D): $100,000 does not result from any valid calculation of the contract asset or liability under the cost-to-cost method.$EXPL$,
  difficulty = 'hard'
WHERE id = 1942;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Under ASC 606, how should an entity account for incremental costs of obtaining a contract, such as sales commissions?$EXPL$,
  choices = $EXPL$["Expense them immediately regardless of recoverability","Capitalize and amortize them if the period exceeds one year","Include them in the contract transaction price","Net them against recognized revenue as a contra amount"]$EXPL$::jsonb,
...
Wrong (D): These costs are not netted against revenue; they are recognized as a separate asset and amortized as an expense.$EXPL$,
  difficulty = 'medium'
WHERE id = 1943;
...
Wrong (D): Advance payments made for reasons other than financing (such as customer convenience or protection from breach) do not indicate a significant financing component.$EXPL$,
  difficulty = 'medium'
WHERE id = 1945;
...
Wrong (C): $188,000 may result from discounting for only one year or using an incorrect rate; the full 3-year compound discount must be applied.$EXPL$,
  difficulty = 'hard'
WHERE id = 1946;
...
Wrong (D): Contract signing does not satisfy the performance obligation; the entity must transfer control of the license to trigger revenue recognition.$EXPL$,
  difficulty = 'medium'
WHERE id = 1947;
...
Wrong (C): Granting access to a constantly updated library is a license arrangement, not an outright sale of intellectual property.$EXPL$,
  difficulty = 'easy'
WHERE id = 1948;
...
Wrong (D): $450.00 overstates the amount allocated to points and does not result from the correct proportional calculation.$EXPL$,
  difficulty = 'hard'
WHERE id = 1951;
...
Wrong (C): The $15,000 is a contract liability, not an accounts receivable; the customer has already been billed and owes the $50,000, but the entity has an obligation to perform.$EXPL$,
  difficulty = 'easy'
WHERE id = 1952;
...
Wrong (D): $7,000 does not result from the relative standalone selling price allocation method.$EXPL$,
  difficulty = 'medium'
WHERE id = 1953;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Under ASC 606, when are costs to fulfill a contract that fall outside the scope of other standards capitalized as an asset?$EXPL$,
  choices = $EXPL$["When the total costs exceed a materiality threshold","When they relate directly to a contract, enhance resources, and are recoverable","When they are incurred before the contract is signed","When they relate to general and administrative activities"]$EXPL$::jsonb,
...
Wrong (D): General and administrative costs are always expensed as incurred under ASC 340-40-25-8 because they do not relate directly to a specific contract.$EXPL$,
  difficulty = 'medium'
WHERE id = 1954;
...
Wrong (D): Reporting $0 revenue and $60,000 liability ignores the 6 months of service already provided by December 31.$EXPL$,
  difficulty = 'easy'
WHERE id = 1956;
...
Wrong (D): $250,000 may result from incorrectly subtracting costs incurred instead of prior revenue recognized.$EXPL$,
  difficulty = 'hard'
WHERE id = 1957;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 330-10-30-9 and the FIFO cost flow assumption, the earliest purchased units are assigned to cost of goods sold first. COGS = (100 × $10) + (20 × $12) = $1,000 + $240 = $1,240. The first 100 units at $10 are consumed, then 20 of the 150 units at $12.
...
Wrong (C): $1,440 represents a LIFO result (120 × $12), not FIFO, because LIFO assigns the most recent costs first.$EXPL$,
  difficulty = 'easy'
WHERE id = 1958;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 330-10-30-9 and the LIFO cost flow assumption, the most recently purchased units are assigned to cost of goods sold first. All 120 units sold come from the most recent layer of 150 units at $12. COGS = 120 × $12 = $1,440. Ending inventory = (100 × $10) + (30 × $12) = $1,360.
...
Wrong (C): $1,380 does not correspond to a valid LIFO layer calculation from the given purchase data.$EXPL$,
  difficulty = 'easy'
WHERE id = 1959;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 330-10-30-9 and the weighted-average periodic method, a single average cost per unit is computed. Total cost = (200 × $8) + (300 × $10) = $1,600 + $3,000 = $4,600. Total units = 500. Weighted-average cost = $4,600 / 500 = $9.20. This unit cost is applied to both COGS and ending inventory.
...
Wrong (C): $8.80 does not result from a correct weighted-average calculation of the given data.$EXPL$,
  difficulty = 'easy'
WHERE id = 1960;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 330-10-35-1B, inventory is measured at the lower of cost or net realizable value (LCNRV). Since NRV of $42,000 is below cost of $50,000, inventory is written down to $42,000. The $8,000 write-down is recognized as a loss in the current period.
...
Wrong (C): $46,000 is not supported by any LCNRV calculation; inventory is carried at the lower of cost ($50,000) or NRV ($42,000).$EXPL$,
  difficulty = 'easy'
WHERE id = 1962;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 330-10-30-1, in a periodic inventory system, cost of goods sold is determined as beginning inventory plus net purchases minus ending inventory. This formula derives COGS from the goods available for sale less the inventory remaining, which is determined by a physical count at period end.
...
Wrong (D): Beginning inventory plus ending inventory minus purchases inverts the formula and produces a meaningless result.$EXPL$,
  difficulty = 'easy'
WHERE id = 1963;
...
Wrong (D): There is no requirement to adjust perpetual LIFO to match periodic LIFO; they are recognized as distinct acceptable methods.$EXPL$,
  difficulty = 'medium'
WHERE id = 1964;
...
Wrong (D): FIFO always produces identical results under both systems, making "never" incorrect.$EXPL$,
  difficulty = 'medium'
WHERE id = 1965;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 330-10-S99-4 (SEC Staff Accounting Bulletin Topic 11-F), companies using LIFO must disclose the LIFO reserve, defined as FIFO inventory minus LIFO inventory. FIFO inventory = LIFO inventory + LIFO reserve = $200,000 + $45,000 = $245,000.
...
Wrong (D): $225,000 does not result from the correct LIFO reserve formula.$EXPL$,
  difficulty = 'medium'
WHERE id = 1966;
...
Wrong (D): $68,000 adds the beginning and ending reserves, which has no analytical meaning in the LIFO reserve framework.$EXPL$,
  difficulty = 'medium'
WHERE id = 1967;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 330-10-30-18, the gross profit method estimates inventory by applying a historical gross profit rate. Estimated COGS = $350,000 × (1 − 40%) = $210,000. Goods available for sale = $60,000 + $240,000 = $300,000. Estimated ending inventory = $300,000 − $210,000 = $90,000.
...
Wrong (D): $60,000 equals beginning inventory and does not reflect any estimation calculation.$EXPL$,
  difficulty = 'medium'
WHERE id = 1968;
...
Wrong (C): Federal income tax filings require actual inventory methods and records, not gross profit estimates.$EXPL$,
  difficulty = 'easy'
WHERE id = 1969;
...
Wrong (D): $48,000 does not result from the correct cost-to-retail ratio applied to ending inventory at retail.$EXPL$,
  difficulty = 'hard'
WHERE id = 1970;
...
Wrong (C): The inventory has not been received yet, so it cannot be recorded; the appropriate treatment is to recognize a loss and disclose the commitment.$EXPL$,
  difficulty = 'medium'
WHERE id = 1972;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 330-10-30-13, dollar-value LIFO measures inventory changes in terms of total dollar value rather than individual units. The base-year cost increment = $110,000 − $100,000 = $10,000. This new layer is restated to current-year dollars: $10,000 × 1.08 = $10,800. Dollar-value LIFO ending inventory = base layer ($100,000) + new layer ($10,800) = $110,800.
...
Wrong (D): $118,800 appears to apply the price index to the entire ending inventory, which would overstate the LIFO value by indexing the base layer.$EXPL$,
  difficulty = 'hard'
WHERE id = 1973;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 330-10-50-2, a LIFO liquidation occurs when quantities sold exceed quantities purchased during the period, causing older, lower-cost LIFO layers to be matched against current-period revenues. This dip into old layers artificially inflates gross profit and net income because historical costs are much lower than current replacement costs.
...
Wrong (D): LIFO conformity is the IRS requirement that a company using LIFO for tax must also use it for financial reporting; it is unrelated to layer liquidation.$EXPL$,
  difficulty = 'medium'
WHERE id = 1976;
...
Wrong (D): Selling and distribution costs are period expenses that occur after production is complete and are not capitalized to inventory.$EXPL$,
  difficulty = 'medium'
WHERE id = 1977;
...
Wrong (D): $110,000 is the estimated selling price before deducting completion and disposal costs; NRV must net those costs.$EXPL$,
  difficulty = 'medium'
WHERE id = 1978;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 330-10-35-1B, once inventory is written down under the LCNRV rule, the reduced amount establishes a new cost basis. U.S. GAAP prohibits subsequent reversal of inventory write-downs. Even if NRV later recovers, the lower carrying amount is permanent.
...
Wrong (D): No OCI treatment exists for inventory write-down recoveries; inventory adjustments flow through the income statement, and reversals are simply not permitted under U.S. GAAP.$EXPL$,
  difficulty = 'medium'
WHERE id = 1979;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 330-10-30-21, the conventional retail method (lower of average cost or market) excludes net markdowns from the denominator of the cost-to-retail ratio but includes them when computing ending inventory at retail. By excluding markdowns from the ratio, the resulting percentage is lower, which approximates the lower of cost or market valuation. Net markups are included in the ratio calculation.
...
Wrong (D): Markdowns affect retail amounts, not cost amounts; freight-in is a cost-side addition and markdowns have no cost-side equivalent.$EXPL$,
  difficulty = 'hard'
WHERE id = 1980;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 330-10-30-9 and the FIFO assumption, ending inventory consists of the most recently purchased units. Ending inventory = (200 × $15) + (100 × $13) = $3,000 + $1,300 = $4,300. The 200 most recent units at $15 are included first, then 100 of the 400 units at $13 fill the remaining 100 units.
...
Wrong (C): $3,000 accounts for only the 200 units at $15 and omits the additional 100 units needed to reach 300 total.$EXPL$,
  difficulty = 'medium'
WHERE id = 1981;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 330-10-30-1 and FOB shipping point terms, title and risk of loss transfer to the buyer when the goods are delivered to the carrier at the shipping point. The buyer includes these goods in its ending inventory even though they have not physically arrived, because ownership transferred at shipment.
...
Wrong (D): Title cannot be split between parties; FOB terms assign ownership entirely to the buyer or seller based on the designated transfer point.$EXPL$,
  difficulty = 'easy'
WHERE id = 1982;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 330-10-30-1, consigned goods remain the inventory of the consignor until sold by the consignee to a third party. Title does not transfer when goods are placed at the consignee's location. The consignor reports the $30,000 as inventory on its balance sheet until an actual sale occurs.
...
Wrong (D): Because no sale has occurred, there is no receivable to record; the goods remain as inventory of the consignor.$EXPL$,
  difficulty = 'medium'
WHERE id = 1983;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 330-10-30-1, inventoriable (product) costs for a manufacturer include raw materials, direct labor, and manufacturing overhead. Total = $80,000 + $60,000 + $40,000 = $180,000. These costs are capitalized to inventory and expensed as COGS when the goods are sold.
...
Wrong (D): $200,000 does not correspond to any valid combination of the given cost categories.$EXPL$,
  difficulty = 'medium'
WHERE id = 1984;
...
Wrong (C): Net markups increase the retail value of goods available for sale; they are additions, not reductions.$EXPL$,
  difficulty = 'hard'
WHERE id = 1985;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 360-10-35-4, straight-line depreciation allocates the depreciable base evenly over the useful life. Annual depreciation = (Cost − Salvage) / Useful life = ($200,000 − $20,000) / 5 = $36,000 per year. This method produces equal periodic charges over the asset's service life.
...
Wrong (D): $32,000 may result from an arithmetic error or incorrect salvage value assumption.$EXPL$,
  difficulty = 'easy'
WHERE id = 1989;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 360-10-35-4, the double-declining-balance (DDB) method applies twice the straight-line rate to the declining book value. DDB rate = (1/4) × 2 = 50%. Year 1: $100,000 × 50% = $50,000 depreciation, leaving book value of $50,000. Year 2: $50,000 × 50% = $25,000. Under DDB, salvage value is not deducted from the base, but the asset is not depreciated below salvage.
...
Wrong (D): $50,000 is the Year 1 depreciation, not Year 2; the declining book value produces lower depreciation in subsequent years.$EXPL$,
  difficulty = 'medium'
WHERE id = 1990;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 360-10-35-4, the sum-of-the-years'-digits (SYD) method is an accelerated depreciation method. SYD = 5 + 4 + 3 + 2 + 1 = 15. Year 1 fraction = 5/15 = 1/3. Depreciation = ($90,000 − $0) × 5/15 = $30,000. The fraction decreases each year, producing front-loaded depreciation.
...
Wrong (D): $27,000 would equal $90,000 × 4.5/15, which is not a valid SYD fraction for any year.$EXPL$,
  difficulty = 'easy'
WHERE id = 1991;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 360-10-35-47, when a significant component of a long-lived asset is replaced, the old component's remaining book value ($40,000) is derecognized and written off as a loss on disposal. The new replacement component ($250,000) is capitalized and depreciated over its own estimated useful life.
...
Wrong (D): Only the incremental cost of $210,000 ignores that the old roof's book value must be removed; the full $250,000 is capitalized and the $40,000 old value is written off.$EXPL$,
  difficulty = 'medium'
WHERE id = 1993;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Equipment has a carrying amount of $500,000. Estimated undiscounted future cash flows are $480,000 and fair value is $420,000. Under ASC 360, what impairment loss, if any, should be recognized?$EXPL$,
  choices = $EXPL$["No impairment loss because fair value exceeds half of carrying amount","An impairment loss of $20,000 based on the cash flow shortfall","An impairment loss of $80,000 based on the fair value deficiency","An impairment loss of $60,000 based on the average of both measures"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (C): Under ASC 360-10-35-17, long-lived asset impairment uses a two-step process. Step 1 (recoverability test): compare carrying amount ($500,000) to undiscounted future cash flows ($480,000). Because $480,000 < $500,000, the asset fails the test. Step 2 (measurement): the impairment loss equals carrying amount minus fair value = $500,000 − $420,000 = $80,000.
...
Wrong (D): Averaging measures is not prescribed by ASC 360; the impairment loss is strictly carrying amount minus fair value.$EXPL$,
  difficulty = 'medium'
WHERE id = 1994;
