...
UPDATE questions SET
  stem = $19$Which of the following best describes a key difference between tax-basis financial statements and GAAP financial statements regarding inventory capitalization?$19$,
  choices = $19$["Tax basis follows IRC Section 263A (UNICAP) rules, which may differ from GAAP capitalization under ASC 330","Tax basis always requires the FIFO cost flow assumption","Tax basis prohibits all inventory valuation methods","Tax basis and GAAP treat inventory identically"]$19$::jsonb,
  explanation = $19$Correct (A): Under the income tax basis, inventory capitalization follows IRC Section 263A (UNICAP), which requires capitalization of certain direct and indirect costs that may differ from GAAP requirements under ASC 330-10-30. UNICAP has specific cost allocation methods and exceptions (e.g., the small business exception under IRC 263A(i)) that have no GAAP equivalent.
...
Wrong (D): Significant differences exist between tax-basis and GAAP inventory treatment, particularly in cost capitalization rules and the UNICAP requirements.$19$,
  difficulty = 'medium'
WHERE id = 2355;
...
Wrong (D): A contractual basis framework uses accounting principles specified in a contract such as a loan agreement, not principles prescribed by a regulatory body.$19$,
  difficulty = 'easy'
WHERE id = 2357;
...
Wrong (C): A regulatory basis framework follows principles prescribed by a regulatory agency for filing requirements, not the terms of a private loan agreement.$19$,
  difficulty = 'easy'
WHERE id = 2358;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Which of the following accurately describes the AICPA''s Financial Reporting Framework for Small- and Medium-Sized Entities (FRF for SMEs)?$19$,
  choices = $19$["It is mandatory for all entities with less than $50 million in revenue","It is identical to the IFRS for SMEs framework issued by the IASB","It is a self-contained non-GAAP framework designed as a cost-effective alternative for private companies","It is considered GAAP for purposes of SEC reporting requirements"]$19$::jsonb,
  explanation = $19$Correct (C): The FRF for SMEs is a self-contained, non-GAAP framework developed by the AICPA as a simplified alternative for owner-managed and small-to-medium-sized private companies. Per the AICPA FRF for SMEs framework, it draws from traditional accounting methods such as historical cost and avoids complex GAAP topics like fair value measurements.
...
Wrong (D): The FRF for SMEs is explicitly a non-GAAP framework and is not accepted for SEC reporting, which requires U.S. GAAP or IFRS.$19$,
  difficulty = 'medium'
WHERE id = 2359;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under the pure cash basis as described in AU-C Section 800.A2, the $240,000 cash payment for equipment is recorded as a disbursement (expense) in the period of purchase. There is no capitalization or depreciation under the pure cash basis.
...
Wrong (C): The cash basis does recognize the transaction as a cash disbursement; it records cash outflows as expenses in the period paid rather than ignoring them entirely.$19$,
  difficulty = 'easy'
WHERE id = 2360;
...
Wrong (D): Recording only the accrued interest without the underlying debt would be illogical; the modification must be applied consistently to related items.$19$,
  difficulty = 'medium'
WHERE id = 2362;
...
Wrong (D): $555,000 incorrectly deducts both the guaranteed payments and some other amount, failing to account for the proper treatment of guaranteed payments already embedded in taxable income.$19$,
  difficulty = 'hard'
WHERE id = 2363;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under AU-C Section 800.A14, when financial statements are prepared on the cash basis, the titles should clearly indicate the basis of accounting. The appropriate title is "Statement of Cash Receipts and Disbursements" or similar wording that avoids implying GAAP compliance.
...
Wrong (D): "Statement of Operations" is a GAAP-oriented title that does not communicate the cash basis of accounting to financial statement users.$19$,
  difficulty = 'easy'
WHERE id = 2364;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under the pure cash basis as described in AU-C Section 800.A2, revenue is recognized when cash is received regardless of when the service is performed. The $60,000 advance payment is recorded as revenue in December when the cash is received.
...
Wrong (C): Deferred revenue is an accrual-basis liability concept that has no place in pure cash-basis financial statements, which do not recognize unearned obligations.$19$,
  difficulty = 'easy'
WHERE id = 2366;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$A company uses the income tax basis and elects to expense all equipment purchases under IRC Section 179, taking an immediate $500,000 deduction for new equipment. Under GAAP, the equipment would be depreciated over 7 years using straight-line. What is the equipment-related expense on the tax-basis financial statements for year one?$19$,
  choices = $19$["$71,429 using straight-line depreciation over 7 years","$0 because the asset must be capitalized first","$250,000 using the half-year convention","$500,000 as the full Section 179 deduction"]$19$::jsonb,
  explanation = $19$Correct (D): Under the income tax basis, the IRC Section 179 election allows the company to deduct the full $500,000 cost in the year of purchase. Tax-basis financial statements follow the tax return treatment per AU-C Section 800.A2, so the entire $500,000 is expensed in year one.
...
Wrong (C): The half-year convention applies to MACRS depreciation under IRC Section 168, not to Section 179 immediate expensing which allows the full deduction in year one.$19$,
  difficulty = 'medium'
WHERE id = 2374;
...
Wrong (D): Comparability enables users to identify similarities and differences between items, but it does not address consensus among independent observers about faithful representation.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4707;
...
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 105-10-05-1, the FASB Accounting Standards Codification is the single authoritative source of U.S. GAAP for nongovernmental entities (other than SEC guidance for public companies). All other sources are nonauthoritative.
...
Wrong (D): Industry practice widely recognized as generally accepted is nonauthoritative and ranks below the ASC in the hierarchy; it may only be considered when the ASC is silent.$19$,
  cognitive_level = 1,
  difficulty = 'medium'
WHERE id = 4710;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (D): Under ASC 105-10-05-2, when the ASC does not address a specific transaction, an entity should first consider guidance within the ASC for similar transactions or events by analogy. This takes priority over all nonauthoritative sources.
...
Wrong (C): Internal management preferences are not a recognized source of accounting guidance under any level of the GAAP hierarchy and cannot justify an accounting policy choice.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4715;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB''s authoritative literature and the AICPA Code of Professional Conduct, GASB is responsible for establishing GAAP for state and local governmental entities in the United States.
...
Wrong (D): The SEC has authority over financial reporting for public companies but generally defers standard-setting to FASB and does not set standards for governmental entities.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4716;
...
Wrong (D): Investments by owners is defined in CON 6, paragraph 66, as increases in equity resulting from transfers of something of value to the entity by owners.$19$,
  cognitive_level = 1,
  difficulty = 'hard'
WHERE id = 4718;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (C): Under FASB Concepts Statement No. 8 (CON 8), Chapter 3, QC12, faithful representation requires that financial information represent the substance of an economic phenomenon rather than merely its legal form. When economic substance differs from legal form, accounting should reflect the economic reality.
...
Wrong (D): Form and substance frequently differ in financial reporting, as demonstrated by finance leases, certain transfers of receivables, and variable interest entities where legal and economic characteristics diverge.$19$,
  cognitive_level = 2,
  difficulty = 'hard'
WHERE id = 4719;
...
Wrong (D): Both U.S. GAAP (CON 6) and IFRS (Conceptual Framework) define assets and liabilities as fundamental elements of financial statements.$19$,
  cognitive_level = 1,
  difficulty = 'hard'
WHERE id = 4721;
...
Wrong (C): Net realizable value is the estimated selling price less costs to complete and sell, commonly used for inventory under ASC 330, not for equity investments measured at fair value.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4723;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 410-20-25-4, an entity must recognize an asset retirement obligation at fair value in the period in which the obligation is incurred. Fair value is approximated by the present value of estimated future cash flows discounted at the credit-adjusted risk-free rate. The corresponding amount is capitalized as an increase to the related long-lived asset.
...
Wrong (D): The fair value of the platform itself is irrelevant to the ARO measurement; the obligation is measured based on the present value of the estimated removal costs, not the asset''s market value.$19$,
  cognitive_level = 3,
  difficulty = 'hard'
WHERE id = 4731;
...
Wrong (D): Vacation days can and must be accrued when the criteria in ASC 710-10-25 are satisfied, including accumulation, probability of payment, and reasonable estimability.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4732;
...
Wrong (D): Unredeemed gift cards create a legal and accounting obligation that must be reported; ignoring them would understate liabilities and potentially overstate income.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4739;
...
Wrong (C): $48,000 represents the full annual assessment and would only be appropriate as an accrual at December 31, not March 31.$19$,
  cognitive_level = 3,
  difficulty = 'easy'
WHERE id = 4741;
...
Wrong (D): Restating only the immediately preceding period is insufficient; ASC 250-10-45-5 requires adjustment of all prior periods presented in the comparative financial statements.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4746;
...
Wrong (D): A cumulative effect adjustment to retained earnings is not required for estimate changes; the revised estimate is simply applied to current and future depreciation calculations.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4747;
...
Wrong (D): Changing the estimated percentage of uncollectible accounts is a change in accounting estimate under ASC 250-10-20, involving a revised prediction of future events rather than a different accounting method.$19$,
  cognitive_level = 2,
  difficulty = 'easy'
WHERE id = 4748;
...
Wrong (D): Disclosure only without adjustment is insufficient for material errors; ASC 250-10-45-23 requires restatement of prior periods, not merely footnote disclosure.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4749;
...
Wrong (D): A change in reporting entity involves presenting financial statements for a different entity or combination of entities and requires retrospective application; changing a depreciation method does not alter the reporting entity.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4751;
...
Wrong (C): A change in estimate is accounted for prospectively but involves revising an assumption, not switching between two different accounting methods for the same type of transaction.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4755;
...
Wrong (D): A press release correction is not governed by ASC 250 financial statement restatement requirements; press releases are not part of the audited financial statements.$19$,
  cognitive_level = 2,
  difficulty = 'medium'
WHERE id = 4756;
...
Wrong (D): A change in reporting entity involves presenting financial statements for a different entity or combination under ASC 250-10-45-21; it has no relation to omitting an accrual.$19$,
  cognitive_level = 2,
  difficulty = 'easy'
WHERE id = 4757;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 250-10-45-17, all changes in accounting estimate are accounted for prospectively, regardless of the source of the new information. It does not matter whether the revised estimate arises from new information, additional experience, or subsequent developments.
...
Wrong (D): Error corrections require restatement under ASC 250-10-45-23 and apply when GAAP was misapplied; revising an estimate based on new information or better insight is explicitly a change in estimate, not an error.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4759;
...
Wrong (D): A change in reporting entity involves presenting financial statements for a different entity or combination of entities under ASC 250-10-45-21 and has no relation to correcting non-GAAP accounting methods.$19$,
  cognitive_level = 4,
  difficulty = 'hard'
WHERE id = 4760;
...
Wrong (D): The direction is wrong; retained earnings was understated by the error. While $60,000 is the correct magnitude, the overstated characterization is incorrect because excessive expense reduced net income.$19$,
  cognitive_level = 3,
  difficulty = 'hard'
WHERE id = 4761;
...
Wrong (C): A new accounting standard that permits an alternative method better reflecting the entity''s economics provides a valid basis for a voluntary change when the entity can demonstrate preferability.$19$,
  cognitive_level = 4,
  difficulty = 'hard'
WHERE id = 4762;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 250-10-20, a change in accounting principle involves adopting a different acceptable accounting method (e.g., FIFO to LIFO), while a change in accounting estimate involves revising an assumption or prediction used in applying an existing method (e.g., useful life, salvage value). The two receive different accounting treatments.
...
Wrong (D): A change in estimate never requires prior-period restatement; ASC 250-10-45-17 explicitly requires prospective treatment for all estimate changes.$19$,
  cognitive_level = 2,
  difficulty = 'easy'
WHERE id = 4764;
...
Wrong (D): Committed is one of the five GASB 54 classifications, representing amounts constrained by formal action of the government''s highest level of decision-making authority.$19$,
  cognitive_level = 1,
  difficulty = 'medium'
WHERE id = 4769;
...
-- Issues: unstructured, no_contrast, no_blooms
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB Statement No. 84, paragraph 4, fiduciary fund types include pension trust funds, investment trust funds, private-purpose trust funds, and custodial funds. The custodial fund replaced the former agency fund classification.
...
Wrong (D): Permanent funds are governmental fund types under GASB 34, used to report resources legally restricted so that only earnings may be used for a specified purpose.$19$,
  cognitive_level = 1,
  difficulty = 'easy'
WHERE id = 4775;
...
Wrong (C): Unassigned fund balance under GASB 54, paragraph 17, is the residual classification for the general fund not constrained by any purpose; the federal grant has an explicit external restriction.$19$,
  cognitive_level = 2,
  difficulty = 'hard'
WHERE id = 4780;
...
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 205-40-50-1, management must evaluate whether conditions or events raise substantial doubt about the entity''s ability to continue as a going concern within one year after the date the financial statements are issued (or available to be issued). This forward-looking assessment uses the issuance date as the starting point.
...
Wrong (D): The evaluation period is not limited to the period covered by the financial statements; ASC 205-40 requires a forward-looking assessment extending one year from the issuance date, which extends beyond the reporting period.$19$,
  difficulty = 'medium'
WHERE id = 32;
...
UPDATE questions SET
  stem = $19$Clearwater Construction has a $10 million bridge contract with original estimated costs of $8 million. At year-end, $3 million in costs have been incurred. The engineer reports unexpected soil conditions increasing total estimated costs to $9.5 million. Under ASC 606, how does this cost revision affect revenue recognized to date using the cost-to-cost input method?$19$,
  choices = $19$["Revenue increases because higher total costs accelerate the completion percentage","Revenue remains at $3,750,000 because ASC 606 locks in the original estimate","Revenue decreases from $3,750,000 to approximately $3,157,895 due to the lower completion percentage","Revenue drops to $3,000,000 because revenue must equal costs incurred"]$19$::jsonb,
  explanation = $19$Correct (C): Under ASC 606-10-55-20, the cost-to-cost method measures progress as costs incurred divided by total estimated costs. Originally: $3M / $8M = 37.5%, yielding $3,750,000. After revision: $3M / $9.5M = 31.6%, yielding approximately $3,157,895. The cumulative catch-up adjustment under ASC 606-10-32-14 reduces recognized revenue.
...
Wrong (D): Revenue is not limited to costs incurred; the cost-to-cost method applies the completion percentage to total transaction price, which can produce revenue above or below costs incurred depending on the profit margin.$19$,
  difficulty = 'medium'
WHERE id = 36;
...
Wrong (C): While triggering events prompt the test for finite-lived assets, the question states the necessary data is already available; the reason the customer list is not impaired is that it passes the recoverability screen, not that no test was performed.$19$,
  difficulty = 'hard'
WHERE id = 42;
...
Wrong (D): The lessor retaining all risks and rewards is an operating lease characteristic from the lessor''s perspective; under ASC 842, lessee classification focuses on specific criteria such as transfer of ownership, purchase option, lease term, present value, and asset specialization.$19$,
  difficulty = 'medium'
WHERE id = 43;
...
-- Issues: unstructured, choice_cuing
UPDATE questions SET
  stem = $19$Waverly Corp. has 100,000 shares of $5 par common stock outstanding at a $40 market price. The board considers a 10% stock dividend versus a 30% stock dividend. How does the size affect the amount transferred from retained earnings?$19$,
  choices = $19$["Both dividends transfer the same total amount from retained earnings","The 10% dividend transfers $400,000 at market value; the 30% dividend transfers $150,000 at par value","The 30% dividend transfers $1,200,000 at market value for all shares issued","Both dividends use par value, transferring $50,000 and $150,000 respectively"]$19$::jsonb,
...
Wrong (D): Par value applies only to large stock dividends; small dividends below the 20-25% threshold must use market value under ASC 505-20-30-3, so $50,000 understates the transfer for the 10% dividend.$19$,
  difficulty = 'medium'
WHERE id = 47;
...
UPDATE questions SET
  stem = $19$The Thornfield Community Foundation adopted ASU 2016-14, reporting net assets without donor restrictions of $2.8 million and net assets with donor restrictions of $4.5 million. The restricted amount includes time-restricted grants, purpose-restricted capital campaign funds, and perpetual endowments. What is a key analytical trade-off of the two-category system compared to the old three-category model?$19$,
  choices = $19$["The two-category system provides identical information because the three old categories map directly to the two new ones","The system improves transparency by eliminating the temporary/permanent distinction but requires enhanced note disclosures to distinguish near-term restrictions from perpetual endowments","The system reduces transparency in all respects by providing less information than the prior model","The system eliminates the need for note disclosures because all restrictions are aggregated into one line item"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASU 2016-14 (ASC 958-210-45), the three-category model (unrestricted, temporarily restricted, permanently restricted) was replaced with two categories: with and without donor restrictions. This simplification eliminates preparer confusion but aggregates near-term and perpetual restrictions into one line. The standard compensates by requiring enhanced note disclosures about the nature, amount, and timing of restrictions.
...
Wrong (D): ASU 2016-14 increased note disclosure requirements under ASC 958-310-50 rather than eliminating them; notes are essential for users to assess the composition and timing of donor restrictions.$19$,
  difficulty = 'medium'
WHERE id = 53;
...
Wrong (D): Only the $500,000 principal carries a perpetual restriction; the $25,000 in earnings is unrestricted by the donor and must be reclassified to net assets without donor restrictions when earned.$19$,
  difficulty = 'hard'
WHERE id = 54;
...
Wrong (D): A neighboring government with shared boundaries is an independent primary government with its own financial accountability and reporting obligations, not a component unit of another government.$19$,
  difficulty = 'hard'
WHERE id = 60;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 606-10-55-36, the primary indicator of whether an entity is a principal is whether it controls the specified good or service before transfer to the customer. Control means the ability to direct the use of and obtain substantially all the remaining benefits from the asset.
...
Wrong (D): Not bearing inventory risk is an indicator that the entity is an agent rather than a principal under ASC 606-10-55-38; principals typically obtain control of goods (including bearing inventory risk) before transferring them to customers.$19$,
  difficulty = 'medium'
WHERE id = 154;
...
Wrong (D): The contractor''s employment status (employee vs. vendor) does not affect capitalization; the nature of the expenditure and whether it brings the asset to intended use or merely maintains it determines the accounting treatment.$19$,
  difficulty = 'medium'
WHERE id = 158;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Clearwater Logistics leases a fleet of trucks for 5 years at $200,000 per year with a present value of lease payments of $850,000. How does finance lease versus operating lease classification affect the income statement expense pattern over the lease term?$19$,
  choices = $19$["Both classifications produce identical expense patterns and balance sheet effects","A finance lease front-loads expense while an operating lease recognizes level expense each year","A finance lease produces lower total expense over the lease term due to interest deductibility","An operating lease produces higher total expense because of an implicit accounting premium"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 842-20-25, a finance lease records amortization of the ROU asset (straight-line) and interest on the lease liability (front-loaded based on declining balance), producing higher combined expense in early years. An operating lease under ASC 842-20-25-6 recognizes a single straight-line lease cost each year. Total expense over 5 years is identical ($1,000,000) but the timing differs.
...
Wrong (D): No implicit premium exists under ASC 842; both lease types produce the same total cost over the lease term, and the operating lease simply allocates expense evenly rather than front-loading it.$19$,
  difficulty = 'medium'
WHERE id = 163;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Greystone Corp. issued $2 million of 8% bonds at 105 with a current carrying amount of $2,048,000. It repurchases the bonds at 98 ($1,960,000). Ashford Industries retires its own $2 million bonds (originally issued at 95, carrying amount $1,970,000) at 101 ($2,020,000). What gain or loss does each company recognize?$19$,
  choices = $19$["Both companies recognize a loss because early extinguishment always incurs a penalty","Greystone recognizes an $88,000 gain and Ashford recognizes a $50,000 loss","Both companies recognize a gain from eliminating future interest obligations","Greystone recognizes a $40,000 gain and Ashford a $20,000 loss, measured against face value"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 470-50-40-2, the gain or loss on early extinguishment equals the difference between the carrying amount and the reacquisition price. Greystone: $2,048,000 carrying - $1,960,000 reacquisition = $88,000 gain. Ashford: $2,020,000 reacquisition - $1,970,000 carrying = $50,000 loss. The gain or loss depends on whether the entity paid more or less than its book obligation.
...
Wrong (D): Face value is irrelevant to the gain/loss calculation; ASC 470-50-40-2 measures the difference between carrying amount (after premium or discount amortization) and reacquisition price, not the difference from par value.$19$,
  difficulty = 'medium'
WHERE id = 169;
