...
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 740-10-25-20, permanent differences affect current tax expense but do not create deferred taxes. Taxable income = $800,000 − $50,000 (municipal bond interest, permanently excluded per IRC §103) + $30,000 (nondeductible fines) = $780,000. Current income tax expense = $780,000 × 21% = $163,800.
...
Wrong (D): $173,460 incorrectly adds both the municipal bond interest and fines to pretax income before applying the tax rate.$19$,
  difficulty = 'medium'
WHERE id = 2162;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 740-10-25-1, temporary differences between book and tax bases of assets create deferred tax liabilities. The Year 1 temporary difference is $100,000 (MACRS) − $50,000 (straight-line) = $50,000. The deferred tax liability = $50,000 × 21% = $10,500, reflecting future taxable amounts when the excess depreciation reverses.
...
Wrong (D): $100,000 is the total MACRS depreciation, not the deferred tax effect.$19$,
  difficulty = 'medium'
WHERE id = 2163;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-30-5, a valuation allowance reduces the DTA to the amount more likely than not to be realized. Net DTA = $210,000 gross DTA − $80,000 valuation allowance = $130,000. The valuation allowance is a contra asset reflecting the portion management does not expect to realize.
...
Wrong (D): $290,000 incorrectly adds the valuation allowance to the gross DTA rather than subtracting it.$19$,
  difficulty = 'medium'
WHERE id = 2165;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): ASU 2015-17 (codified in ASC 740-10-45-4) simplified balance sheet presentation by requiring all deferred tax assets and liabilities to be classified as noncurrent. The prior requirement to separate current and noncurrent components was eliminated.
...
Wrong (C): Classifying based on the related asset or liability was the old method under pre-ASU 2015-17 guidance, no longer applicable.$19$,
  difficulty = 'easy'
WHERE id = 2167;
...
Wrong (D): $300,000 is the pre-tax accrual amount, not the tax-effected deferred tax asset.$19$,
  difficulty = 'medium'
WHERE id = 2168;
...
Wrong (C): $210,000 applies the tax rate to the full $1,000,000 pretax book income without adjusting for either permanent or temporary differences.$19$,
  difficulty = 'hard'
WHERE id = 2169;
...
UPDATE questions SET
  stem = $19$Under ASC 740, intraperiod tax allocation requires income tax expense to be allocated among which components?$19$,
  choices = $19$["Continuing operations only","Continuing operations, discontinued operations, OCI, and equity adjustments","Continuing operations and discontinued operations only","Each individual line item on the income statement"]$19$::jsonb,
  explanation = $19$Correct (B): ASC 740-20-45-2 requires intraperiod tax allocation across continuing operations, discontinued operations, other comprehensive income, and items charged or credited directly to equity (including prior period adjustments). Each component reflects its own tax effect to give users meaningful after-tax information.
...
Wrong (D): Allocation is not applied to each individual income statement line item but rather to the major components specified in the standard.$19$,
  difficulty = 'medium'
WHERE id = 2171;
...
Wrong (D): $150,000 does not correspond to any correct computation under the 21% tax rate applied to either component.$19$,
  difficulty = 'medium'
WHERE id = 2172;
...
Wrong (C): $300,000 has a 70% cumulative probability but is not the largest amount exceeding 50%—$400,000 also exceeds that threshold at 55%.$19$,
  difficulty = 'hard'
WHERE id = 2174;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 740-10-25-20, the allowance method bad debt accrual creates a deductible temporary difference because book expense is recognized before the tax deduction (actual write-offs). Taxable income currently exceeds book income, and the future deduction will reduce taxable income, creating a DTA.
...
Wrong (D): Installment method gain deferral for tax creates a taxable temporary difference (DTL) because book income exceeds taxable income currently, with future taxable amounts on collection.$19$,
  difficulty = 'medium'
WHERE id = 2175;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-30-5, the DTA for an NOL carryforward is measured at the full NOL amount times the enacted rate: $2,000,000 × 21% = $420,000. The 80% annual utilization limitation (IRC §172(a)) affects only the timing of realization, not the total benefit. Since management expects full realization, no valuation allowance is needed per ASC 740-10-30-18.
...
Wrong (D): $400,000 does not correspond to any correct application of the 21% enacted rate to the NOL carryforward.$19$,
  difficulty = 'hard'
WHERE id = 2176;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 740-10-30-21, brief carryforward periods are negative evidence because they limit the time available to generate sufficient taxable income to realize the DTA. Shorter windows increase the risk that the DTA will expire unused.
...
Wrong (D): Appreciated asset values exceeding tax basis are positive evidence because the unrealized gains could be realized through asset sales to generate taxable income.$19$,
  difficulty = 'medium'
WHERE id = 2177;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-25-20, only the $80,000 excess tax depreciation is a temporary difference because it will reverse in future periods. The nondeductible meals expense (50% of $50,000 = $25,000) and the $30,000 municipal bond interest are permanent differences per ASC 740-10-25-30 that never reverse and do not create deferred taxes.
...
Wrong (D): $110,000 incorrectly includes the $30,000 municipal bond interest as a temporary difference alongside the depreciation.$19$,
  difficulty = 'medium'
WHERE id = 2178;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-25-47, deferred taxes are measured using the enacted rate expected to apply when the temporary differences reverse. Since the differences reverse when the 28% rate is in effect, the DTL = $600,000 × 28% = $168,000. The adjustment from the old rate is recognized as tax expense in the enactment period per ASC 740-10-35-4.
...
Wrong (D): $600,000 is the gross temporary difference, not the tax-effected deferred tax liability.$19$,
  difficulty = 'medium'
WHERE id = 2180;
...
Wrong (C): Excess tax depreciation is a temporary difference that affects the timing of tax payments but does not create a permanent difference between the effective and statutory rates.$19$,
  difficulty = 'medium'
WHERE id = 2181;
...
Wrong (C): $222,600 incorrectly deducts both the nondeductible premiums and excess depreciation from pretax income.$19$,
  difficulty = 'hard'
WHERE id = 2182;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Yates Corp. acquired an asset in a nontaxable business combination. The fair value assigned is $900,000 and the tax basis is $600,000. The tax rate is 21%. What is the appropriate deferred tax treatment for this $300,000 difference under ASC 740?$19$,
  choices = $19$["Record a deferred tax liability of $63,000","Apply the initial recognition exception and record no deferred tax","Record a deferred tax liability with an offsetting goodwill adjustment","Record a deferred tax asset of $63,000"]$19$::jsonb,
  explanation = $19$Correct (A): Under ASC 740-10-25-20, the initial recognition exception does not apply to differences arising in a business combination. The $300,000 difference ($900,000 fair value − $600,000 tax basis) creates a DTL of $300,000 × 21% = $63,000, which is recognized at the acquisition date and affects goodwill measurement per ASC 805-740-25-3.
...
Wrong (D): A DTA would arise from a deductible temporary difference where the tax basis exceeds fair value, which is the opposite of this scenario.$19$,
  difficulty = 'hard'
WHERE id = 2184;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 740-10-25-30, municipal bond interest is a permanent difference—it is included in book income but permanently excluded from taxable income under IRC §103. Permanent differences never reverse and do not create deferred taxes.
...
Wrong (D): Revenue recognized at a point in time for book but on installment for tax creates a temporary difference that reverses as cash is collected.$19$,
  difficulty = 'easy'
WHERE id = 2185;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 740-10-25-20, the $180,000 advance creates a deductible temporary difference because it is taxed in Year 1 but not recognized as book revenue until Year 2. The DTA = $180,000 × 21% = $37,800, representing prepaid taxes on income not yet earned for book purposes. The DTA reverses in Year 2 when book revenue is recognized.
...
Wrong (D): $180,000 is the gross temporary difference, not the tax-effected DTA.$19$,
  difficulty = 'medium'
WHERE id = 2186;
...
Wrong (D): A book-to-tax depreciation reconciliation is not a standalone disclosure requirement, though depreciation differences may appear as line items in the rate reconciliation.$19$,
  difficulty = 'easy'
WHERE id = 2188;
...
Wrong (D): $600,000 may result from subtracting the NCI value from total consideration, which is not the correct goodwill formula.$19$,
  difficulty = 'hard'
WHERE id = 2195;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 810-10-45-1, all intercompany transactions must be eliminated in consolidation. Management fees between parent and subsidiary represent revenue to one entity and expense to the other within the consolidated group, requiring elimination to avoid double-counting.
...
Wrong (D): A subsidiary''s purchase from an unrelated supplier is an external transaction and does not require elimination.$19$,
  difficulty = 'easy'
WHERE id = 2196;
...
Wrong (D): $120,000 is the total intercompany profit, not just the unrealized portion remaining in ending inventory.$19$,
  difficulty = 'medium'
WHERE id = 2197;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under ASC 810-10-45-1, in a downstream sale the parent is the seller and earns the intercompany profit. The entire unrealized profit is eliminated against the parent''s share of consolidated income. The NCI is unaffected because the subsidiary did not originate the profit.
...
Wrong (C): Proportional allocation between parent and NCI applies to upstream sales (subsidiary sells to parent), not downstream sales.$19$,
  difficulty = 'medium'
WHERE id = 2198;
...
Wrong (D): Eliminating entirely to consolidated retained earnings ignores the required allocation between controlling and noncontrolling interests.$19$,
  difficulty = 'medium'
WHERE id = 2199;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under ASC 810-10-45-1, intercompany receivables and payables must be eliminated because the consolidated entity cannot owe money to itself. The entry debits Note Payable and credits Note Receivable for $500,000, removing both balances from the consolidated balance sheet.
...
Wrong (C): Debiting Note Receivable and crediting Note Payable reverses the correct entry, which would increase rather than eliminate the intercompany balances.$19$,
  difficulty = 'easy'
WHERE id = 2200;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 323-10-35-4 (equity method), Horizon recognizes its share of the investee''s net income: 40% × $800,000 = $320,000. Dividends received ($200,000 × 40% = $80,000) reduce the investment account balance but are not recognized as income. The equity method records income based on earnings, not cash distributions.
...
Wrong (D): $400,000 does not correspond to any correct percentage applied to Vertex''s net income or dividends.$19$,
  difficulty = 'easy'
WHERE id = 2201;
...
Wrong (D): The subsidiary''s equity retains its value after acquisition; it is eliminated only on the consolidation workpaper to avoid double-counting, not because it has no value.$19$,
  difficulty = 'medium'
WHERE id = 2202;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 810-10-45-19, NCI''s share of the subsidiary''s net income is reported as a separate line item on the consolidated income statement. NCI owns 30% of Small Corp., so NCI income = 30% × $600,000 = $180,000. Dividends declared reduce the NCI''s balance sheet equity, not income.
...
Wrong (D): $420,000 is the parent''s 70% share of income, not the NCI''s share.$19$,
  difficulty = 'medium'
WHERE id = 2203;
...
Wrong (D): Reducing equipment by $300,000 would understate the asset, which should remain at its original $300,000 cost basis from the consolidated perspective.$19$,
  difficulty = 'hard'
WHERE id = 2204;
...
Wrong (D): $360,000 allocated 100% to the parent both overstates the unrealized amount and misapplies the upstream sale allocation rules.$19$,
  difficulty = 'hard'
WHERE id = 2207;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Which of the following best describes the primary criterion for determining whether an entity must consolidate a variable interest entity (VIE)?$19$,
  choices = $19$["The entity owns more than 50% of the VIE''s voting stock","The entity holds a majority of seats on the VIE''s board of directors","The entity provides more than half of the VIE''s total financing","The entity is the primary beneficiary with power to direct significant activities"]$19$::jsonb,
...
Wrong (C): Providing financing creates a variable interest but does not by itself make an entity the primary beneficiary without the power-to-direct criterion.$19$,
  difficulty = 'medium'
WHERE id = 2208;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 805-10-25-6, only the acquiree''s revenues and expenses from the acquisition date forward are included in consolidated income. From June 1 through December 31 = 7 months. Sub''s consolidated revenue = $3,600,000 × 7/12 = $2,100,000. Pre-acquisition results belong to the prior owners and are not consolidated.
...
Wrong (D): $1,500,000 represents 5 months, understating the post-acquisition period.$19$,
  difficulty = 'medium'
WHERE id = 2209;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 323-10-35-4 (equity method), the investment balance is adjusted for the parent''s share of income and dividends. Beginning balance $3,200,000 + share of income (80% × $500,000 = $400,000) − share of dividends (80% × $120,000 = $96,000) = $3,504,000.
...
Wrong (D): $3,080,000 subtracts the full $120,000 dividends rather than the parent''s 80% share and may also misstate the income adjustment.$19$,
  difficulty = 'medium'
WHERE id = 2212;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 810-10-45-1, dividends paid by the parent to its own external shareholders are transactions with parties outside the consolidated group and are not eliminated. Only intercompany transactions within the consolidated entity require elimination.
...
Wrong (D): Intercompany interest revenue and interest expense must be eliminated to avoid double-counting income and expense on intragroup lending.$19$,
  difficulty = 'easy'
WHERE id = 2213;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 323-10-15-6, the equity method is appropriate when an investor has significant influence, typically presumed at 20%–50% ownership. A 35% interest with significant influence clearly qualifies for equity method accounting.
...
Wrong (D): A 5% interest with no board representation lacks significant influence and would be accounted for at fair value or under the measurement alternative.$19$,
  difficulty = 'easy'
WHERE id = 2217;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 820-10-35-40, Level 1 inputs are quoted prices in active markets for identical assets or liabilities. Publicly traded equity securities on the NYSE have readily available quoted prices that qualify as Level 1, the most reliable measurement input. No adjustments are permitted to Level 1 prices.
...
Wrong (D): Trading volume does not determine the level classification—an active market with quoted prices for identical assets is always Level 1 regardless of volume.$19$,
  difficulty = 'easy'
WHERE id = 2220;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under ASC 820-10-35-47, Level 2 inputs are observable inputs other than quoted prices for identical assets in active markets. An interest rate swap valued using the LIBOR/SOFR yield curve uses observable market interest rates as inputs, placing it squarely in Level 2.
...
Wrong (C): A DCF model using management''s proprietary assumptions employs unobservable inputs, classifying it as Level 3.$19$,
  difficulty = 'medium'
WHERE id = 2221;
...
Wrong (C): Level 3 applies when significant unobservable inputs are used. Here, the adjustments are based on observable market differences.$19$,
  difficulty = 'medium'
WHERE id = 2224;
...
Wrong (D): Comparable transaction multiples derived from observable market transactions are generally classified as Level 2 inputs.$19$,
  difficulty = 'easy'
WHERE id = 2225;
...
Wrong (C): Maximizing the amount received describes the most advantageous market, which is used only when no principal market can be identified.$19$,
  difficulty = 'medium'
WHERE id = 2230;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Lyric Corp. holds a liability that has no active market for transfers. The identical liability is traded as an asset by other parties at a quoted price of $950,000. Under ASC 820, how should Lyric measure the fair value of this liability?$19$,
  choices = $19$["Use a Level 3 valuation technique with entity-specific inputs","Use the present value of contractual cash flows as fair value","Measure at $950,000 based on the quoted asset price","Apply the cost approach using original issuance proceeds"]$19$::jsonb,
  explanation = $19$Correct (C): Under ASC 820-10-35-16B, when a quoted price for transferring an identical liability is not available but the identical item is held as an asset by another party, the entity uses the quoted price of that asset from the holder''s perspective. The liability fair value is $950,000 assuming no adjustments for asset-specific features are necessary.
...
Wrong (D): The cost approach using original issuance proceeds does not reflect current fair value and is not a prescribed technique when a quoted asset price is available.$19$,
  difficulty = 'hard'
WHERE id = 2231;
...
UPDATE questions SET
  stem = $19$Ridge Corp. values a patent using a discounted cash flow model. The discount rate of 12% is derived from market data, but the projected cash flows of $500,000 per year are based entirely on management''s estimates. Under ASC 820, how is the overall measurement classified?$19$,
  choices = $19$["Level 1 because a valuation model was used","Level 2 because the discount rate is observable","Level 3 because significant unobservable inputs drive the measurement","A blend of Level 2 and Level 3 reported separately"]$19$::jsonb,
  explanation = $19$Correct (C): Under ASC 820-10-35-52A, the overall classification is determined by the lowest level input that is significant to the entire measurement. Although the discount rate is observable (Level 2), the projected cash flows are unobservable (Level 3) and are significant to the valuation. Therefore, the entire measurement is classified as Level 3.
...
Wrong (D): ASC 820 does not permit splitting a single measurement into separate levels—the entire measurement is classified at the lowest significant input level.$19$,
  difficulty = 'medium'
WHERE id = 2233;
...
Wrong (D): Par value is a nominal amount that does not reflect the economic fair value of the obligation under current market conditions.$19$,
  difficulty = 'hard'
WHERE id = 2236;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $19$Under ASC 820, what characterizes an orderly transaction for fair value measurement purposes?$19$,
  choices = $19$["It must be completed within a single business day","It involves a seller acting under financial distress","It allows adequate market exposure prior to the measurement date","It requires prior approval from a regulatory authority"]$19$::jsonb,
  explanation = $19$Correct (C): Under ASC 820-10-35-3, an orderly transaction assumes the asset or liability has been exposed to the market for a period prior to the measurement date sufficient for normal marketing activities. It is not a forced liquidation or distress sale, ensuring fair value reflects normal market conditions.
...
Wrong (D): Regulatory approval is not a defining characteristic of an orderly transaction under the fair value framework.$19$,
  difficulty = 'easy'
WHERE id = 2237;
...
Wrong (D): The hierarchy ranks inputs from most reliable (Level 1) to least reliable (Level 3), not the reverse.$19$,
  difficulty = 'easy'
WHERE id = 2240;
...
Wrong (D): $73,000 subtracts both items from the bank balance, when deposits in transit should be added.$19$,
  difficulty = 'easy'
WHERE id = 2244;
...
Wrong (D): While the NSF check does create a receivable from the customer, the bank service fee is an expense, and both items must first be recognized as adjustments to the book cash balance.$19$,
  difficulty = 'easy'
WHERE id = 2245;
...
Wrong (D): $45,250 likely omits the NSF check deduction or miscomputes the note collection amount.$19$,
  difficulty = 'medium'
WHERE id = 2246;
...
Wrong (C): Recording the receivable net of expected losses conflates the gross receivable presentation with the allowance—CECL requires a separate allowance account, not a net presentation on initial recognition.$19$,
  difficulty = 'medium'
WHERE id = 2248;
