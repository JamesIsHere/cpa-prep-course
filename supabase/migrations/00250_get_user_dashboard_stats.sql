...
-- Replaces multiple heavy unbounded queries with a single efficient RPC
...
BEGIN
  ...
  -- 2. Trend Data (last 50 attempts per section per type)
  ...
  -- 3. Topic Performance (for weak topics)
  SELECT jsonb_agg(jsonb_build_object(
    'section_code', s.code,
