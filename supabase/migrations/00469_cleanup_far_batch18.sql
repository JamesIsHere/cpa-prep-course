...
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 34, paragraph 48, charges for services include revenues from exchange or exchange-like transactions and are classified as program revenues on the statement of activities. Admission fees charged by a swimming pool directly relate to the recreation function and offset that function''s expenses when calculating net expense.
...
Wrong (D): Interfund transfers involve movements between funds within the same government. Admission fees collected from the public are external exchange transactions, not interfund transfers.$19$,
  difficulty = 'medium'
WHERE id = 5442;
...
Wrong (D): Contributions made before the reporting date are not excluded from the financial statements. GASB 68 specifically requires recognition as deferred outflows rather than note disclosure only.$19$,
  difficulty = 'medium'
WHERE id = 5443;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 54, paragraph 10, committed fund balance requires formal action by the government''s highest level of decision-making authority, typically the governing body such as a city council or county board. The commitment must be made before fiscal year-end and can only be removed by the same authority through the same type of formal action.
...
Wrong (D): Individual elected officials do not constitute the highest level of decision-making authority. The governing body as a whole must take formal action, such as passing a resolution or ordinance.$19$,
  difficulty = 'easy'
WHERE id = 5444;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB 34, paragraph 130, governments must present budgetary comparison schedules for the general fund and each major special revenue fund that has a legally adopted annual budget. The comparison shows original budget, final budget, and actual amounts on the budgetary basis.
...
Wrong (D): There is no $5 million threshold for debt service fund budgetary reporting. The budgetary comparison requirement applies to the general fund and major special revenue funds, not to debt service funds based on outstanding debt levels.$19$,
  difficulty = 'easy'
WHERE id = 5446;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 87, paragraph 16, a short-term lease has a maximum possible term of 12 months or less, including any options to extend that are reasonably certain to be exercised. Because the 3-year extension is reasonably certain, the total lease term is 5 years, far exceeding the 12-month threshold. The city must recognize a lease liability and intangible right-to-use asset.
...
Wrong (D): GASB 87 did not eliminate all short-term lease exemptions. The standard explicitly provides a short-term exemption for leases with a maximum possible term of 12 months or less.$19$,
  difficulty = 'hard'
WHERE id = 5447;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 34, paragraph 100, capital contributions from developers and other external sources are reported separately after nonoperating revenues and expenses on the proprietary fund statement of revenues, expenses, and changes in net position. The infrastructure is capitalized at fair value upon dedication.
...
Wrong (D): Contributed capital assets are not deferred inflows amortized over useful life. They are recognized as capital contributions at the point of dedication, reflecting the immediate transfer of resources to the government.$19$,
  difficulty = 'medium'
WHERE id = 5448;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB 34, paragraph 92, proprietary funds use the economic resources measurement focus combined with the accrual basis of accounting. All assets, deferred outflows, liabilities, deferred inflows, revenues, and expenses are recognized regardless of when cash is received or paid.
...
Wrong (C): The cash basis is not used for proprietary fund financial statements under GASB standards. Proprietary funds follow full accrual accounting, recognizing economic events when they occur rather than when cash changes hands.$19$,
  difficulty = 'easy'
WHERE id = 5449;
...
Wrong (D): Committed resources are not spent first when restricted resources are available. The default order is restricted first, then committed, assigned, and finally unassigned.$19$,
  difficulty = 'medium'
WHERE id = 5450;
...
Wrong (D): Creation through enabling legislation and sharing a fiscal year-end are not sufficient to establish financial accountability. Without board appointment authority and benefit/burden or imposition of will, these factors alone do not trigger the component unit relationship.$19$,
  difficulty = 'medium'
WHERE id = 5451;
...
Wrong (C): Derived tax revenues arise from assessments imposed on exchange transactions, such as sales or income taxes. A mandated intergovernmental grant does not derive from an underlying exchange transaction.$19$,
  difficulty = 'medium'
WHERE id = 5452;
...
Wrong (D): Loan-financed assets are included in total assets upon recognition. There is no revenue-generation prerequisite for asset recognition under U.S. GAAP.$19$,
  difficulty = 'medium'
WHERE id = 31;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 855-10-25-1, subsequent events are classified as recognized (Type I) or nonrecognized (Type II) based on whether the condition existed at the balance sheet date. The fire occurred in January 2026, so conditions causing the loss did not exist at December 31, 2025, making it a Type II event requiring disclosure only without adjustment to the financial statements.
...
Wrong (D): There is no basis for splitting a loss between fiscal years based on insurable periods. The fire is a single event that occurred entirely after the balance sheet date and is addressed through disclosure, not allocation.$19$,
  difficulty = 'hard'
WHERE id = 33;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 606-10-32-33, the $360,000 transaction price is allocated by relative standalone selling prices. The license receives $270,000 divided by $450,000 times $360,000, equaling $216,000, recognized at delivery. Support receives $180,000 divided by $450,000 times $360,000, equaling $144,000, of which $60,000 is recognized in 2025 (10 of 24 months). Total 2025 revenue is $276,000.
...
Wrong (D): Support revenue is recognized over time as the service is delivered, not deferred entirely until the end of the service term. Ten months of the 24-month support period fall in 2025.$19$,
  difficulty = 'medium'
WHERE id = 34;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 606-10-32-33, discounts are allocated proportionally by relative standalone selling prices unless specific criteria for allocating a discount to fewer obligations are met. Hardware receives $60,000 divided by $100,000 times $80,000, equaling $48,000, absorbing $12,000 of the discount. Services receive $40,000 divided by $100,000 times $80,000, equaling $32,000, absorbing $8,000.
...
Wrong (D): Delivery sequence does not determine discount allocation. The allocation is based on relative standalone selling prices, not the timing of when each obligation is satisfied.$19$,
  difficulty = 'medium'
WHERE id = 35;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 330-10-30-1, inventory must be valued at historical cost using an acceptable cost flow assumption such as FIFO, LIFO, or weighted-average. Replacement cost is not a permitted primary inventory costing method and departs from the historical cost principle.
...
Wrong (D): U.S. GAAP does not require replacement cost as an inventory valuation method. The historical cost principle, modified by the lower of cost or NRV framework, governs inventory measurement.$19$,
  difficulty = 'medium'
WHERE id = 37;
...
Wrong (D): A simplified LIFO-to-FIFO conversion adjusts only the inventory denominator. A full conversion would actually reduce COGS because higher-cost recent purchases would remain in inventory rather than flowing to cost of goods sold.$19$,
  difficulty = 'medium'
WHERE id = 38;
...
Wrong (C): DDB reduces book value faster, which decreases the denominator. A smaller denominator produces a higher turnover ratio, not a lower one.$19$,
  difficulty = 'medium'
WHERE id = 39;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 835-20-30, avoidable interest uses a two-tiered approach: specific borrowings first ($4 million times 8% equals $320,000), then excess expenditures at the weighted-average general borrowing rate ($6 million minus $4 million times 5% equals $100,000), totaling $420,000 in capitalizable interest. The CFO''s $320,000 understates the asset and overstates period interest expense by $100,000.
...
Wrong (D): General borrowings supplement, rather than replace, the specific borrowing rate. The 8% rate applies to the first $4 million of expenditures, and the 5% rate applies only to the remaining $2 million excess.$19$,
  difficulty = 'hard'
WHERE id = 40;
...
Wrong (D): The $85,000 represents systematic amortization of finite-lived intangibles for six months, not an impairment charge. Impairment and amortization are distinct concepts under ASC 350.$19$,
  difficulty = 'medium'
WHERE id = 41;
...
Wrong (D): Finance leases do not produce higher total expense. The interest component redistributes the same aggregate $250,000 across periods rather than adding cost beyond the lease payments.$19$,
  difficulty = 'medium'
WHERE id = 44;
...
Wrong (D): Annual expense differs under the effective interest method due to changing carrying amounts, and total expense also differs by the $80,000 spread between the discount and premium amounts.$19$,
  difficulty = 'medium'
WHERE id = 45;
...
Wrong (C): The carrying amount of a discount bond increases over time as discount amortization is added, causing interest expense to grow. The carrying amount does not decline; it converges upward toward the face value at maturity.$19$,
  difficulty = 'hard'
WHERE id = 46;
...
Wrong (D): The repurchase is not netted against additional paid-in capital under the cost method. Treasury stock is recorded as a separate contra-equity account at the full repurchase cost.$19$,
  difficulty = 'medium'
WHERE id = 48;
...
Wrong (C): This choice reverses the classifications. The depreciation difference produces a liability from future taxable amounts, and the warranty produces an asset from future deductible amounts, not the reverse.$19$,
  difficulty = 'medium'
WHERE id = 49;
...
Wrong (D): A deferred tax asset from NOL carryforwards cannot be reclassified as a deferred tax liability. DTAs and DTLs arise from different types of temporary differences and have distinct economic meanings.$19$,
  difficulty = 'medium'
WHERE id = 50;
...
Wrong (D): Fund type selection does not eliminate the measurement focus difference. The distinction between current financial resources and economic resources persists regardless of which governmental fund records the transaction.$19$,
  difficulty = 'medium'
WHERE id = 52;
...
Wrong (D): U.S. GAAP permits both the full fair value and proportionate share methods for measuring NCI under ASC 805-20-30, so the comparison is valid and relevant for financial analysis.$19$,
  difficulty = 'hard'
WHERE id = 55;
...
Wrong (D): Intercompany sales have corresponding costs that also inflate expenses. Net income is unaffected because the revenue and expense overstatements offset, but the gross amounts are misstated.$19$,
  difficulty = 'medium'
WHERE id = 56;
...
Wrong (C): Both the ROU asset and the lease liability affect financial ratios. The liability increases leverage ratios like debt-to-equity, while the asset affects asset turnover and return on assets.$19$,
  difficulty = 'medium'
WHERE id = 57;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 606-10-55-49 through 55-50, when an entity expects to be entitled to a breakage amount, the entity recognizes breakage revenue in proportion to the pattern of rights exercised by the customer. This means breakage is recognized gradually over time as redemptions occur, matching the pattern of actual gift card usage.
...
Wrong (D): Breakage recognition follows the customer''s actual redemption pattern, not an arbitrary fiscal-year cutoff. The timing is driven by when and how customers use their gift cards.$19$,
  difficulty = 'easy'
WHERE id = 58;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 740-10-20, a temporary difference arises when there is a difference between the tax basis and the reported amount of an asset or liability that will result in taxable or deductible amounts in future years. A warranty accrual is a classic example: the expense is recognized for books when estimated but is deductible for tax only when paid, creating a deductible temporary difference.
...
Wrong (D): A difference in accounting periods is not the definition of a temporary difference under ASC 740. Temporary differences arise from basis differences between book and tax treatment of specific assets and liabilities.$19$,
  difficulty = 'easy'
WHERE id = 59;
...
Wrong (D): Assets can be reclassified when circumstances change. If a noncurrent receivable''s maturity falls within 12 months, ASC 210 requires reclassification to current regardless of the original classification.$19$,
  difficulty = 'medium'
WHERE id = 145;
...
Wrong (D): The all-inclusive income concept is reflected through comprehensive income, which combines both net income and OCI. Reporting OCI separately from net income is required by the standard, not an error.$19$,
  difficulty = 'medium'
WHERE id = 146;
...
Wrong (C): Geographic location alone does not determine whether a segment is reportable. A segment may operate in the same region as the parent and still be reportable if it meets any quantitative threshold.$19$,
  difficulty = 'easy'
WHERE id = 149;
...
Wrong (D): The sales-value method is used for inventory estimation in certain retail contexts, not for measuring progress on long-term construction contracts under ASC 606.$19$,
  difficulty = 'easy'
WHERE id = 150;
...
Wrong (D): A refund liability is required under ASC 606, not merely a contra-revenue account. The standard specifically prescribes a refund liability for expected returns along with a corresponding right-of-return asset for the expected inventory recovery.$19$,
  difficulty = 'medium'
WHERE id = 151;
...
Wrong (C): The transaction price reduction is allocated to the points as a separate performance obligation, not applied entirely to the original sale. Revenue for the points is deferred and recognized upon redemption or expiration.$19$,
  difficulty = 'easy'
WHERE id = 152;
...
Wrong (D): The scope change required new mutual approval, which defines a contract modification under ASC 606, not an option exercise. The bonus is variable consideration estimated under the constraint, not a contingent asset recognized only when realized.$19$,
  difficulty = 'medium'
WHERE id = 153;
...
Wrong (D): FIFO assigns the newest (highest) costs to ending inventory during rising prices, not the cheapest. The first-in, first-out flow means older, lower-cost units are sold first, leaving newer, higher-cost units on the balance sheet.$19$,
  difficulty = 'easy'
WHERE id = 155;
...
-- Issues: choice_cuing
UPDATE questions SET
  stem = $19$Thornfield Electronics carries 5,000 units of a smartphone model in inventory at a cost of $400 per unit. A new competing product has driven the estimated selling price down to $380, with $30 in estimated completion and disposal costs. The controller argues against a write-down because the company can still sell above cost. Under ASC 330 as amended by ASU 2015-11, what is the correct inventory valuation and income statement impact?$19$,
  choices = $19$["No write-down is needed because the $380 selling price exceeds the $30 disposal cost","A $250,000 write-down is required because NRV of $350 per unit is below the $400 cost","A $100,000 write-down is required based on the difference between cost and selling price","The write-down should be deferred until the units are actually sold below cost"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 330-10-35-1B (as amended by ASU 2015-11), inventory is measured at the lower of cost or net realizable value. NRV equals selling price of $380 minus disposal costs of $30, equaling $350 per unit. Since $350 is below the $400 cost, a write-down of $50 per unit times 5,000 units equals $250,000, recognized in cost of goods sold. Once written down, $350 becomes the new cost basis with no reversal permitted.
...
Wrong (D): ASU 2015-11 simplified the lower of cost or market framework but did not eliminate the requirement for timely write-downs. Inventory must be adjusted when NRV falls below cost, not deferred until actual sale.$19$,
  difficulty = 'medium'
WHERE id = 156;
...
Wrong (D): A cumulative catch-up adjustment to retained earnings is not the prescribed treatment for depreciation method changes. The prospective approach applies the new method going forward without adjusting prior periods or beginning retained earnings.$19$,
  difficulty = 'easy'
WHERE id = 160;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 985-20-25, costs incurred before technological feasibility are expensed as research and development under ASC 730. Costs incurred after technological feasibility through general release are capitalized. Ridgemont capitalizes $2.5 million while Thornfield capitalizes $3.2 million, demonstrating that the timing of the feasibility milestone directly determines how much is expensed versus capitalized.
...
Wrong (D): Pre-feasibility costs are expensed, not capitalized. The standard requires expensing costs before the feasibility milestone because the future economic benefits are too uncertain at that stage to justify capitalization.$19$,
  difficulty = 'medium'
WHERE id = 162;
...
Wrong (D): The short-term lease expense is recognized straight-line without a prepaid asset on the balance sheet. The 13-month lease creates a lease liability, not merely a different type of balance sheet presentation.$19$,
  difficulty = 'medium'
WHERE id = 164;
...
Wrong (D): The $30,000 difference between fair value and carrying amount is a selling profit, not an impairment loss. An impairment loss would occur only if fair value were below carrying amount, which is the opposite of the facts presented.$19$,
  difficulty = 'hard'
WHERE id = 166;
...
Wrong (D): Eliminating intercompany transactions reduces both revenue and cost of goods sold. The unrealized profit elimination reduces net income by $30,000; it does not increase net income by reducing expenses alone.$19$,
  difficulty = 'medium'
WHERE id = 167;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 835-30-35-4, the straight-line method produces constant annual expense of $108,000, while the effective interest method starts at $113,200 in Year 1 and declines to $103,600 by Year 10 as the carrying amount decreases through premium amortization. Straight-line understates expense early and overstates it later, but is acceptable when results are not materially different from effective interest.
...
Wrong (D): While total interest expense is identical over 10 years under both methods, annual expense amounts differ. The effective interest method produces declining annual expense for a premium bond, while straight-line produces a constant amount.$19$,
  difficulty = 'medium'
WHERE id = 168;
...
Wrong (D): The below-cost reissuance still increases total equity by the $80,000 cash received. The $20,000 deficit is absorbed by the APIC from treasury stock balance, not netted against the cash proceeds to eliminate the equity increase.$19$,
  difficulty = 'medium'
WHERE id = 171;
...
Wrong (D): Only the municipal bond interest is a permanent difference. The depreciation timing difference is temporary and will reverse, creating a deferred tax liability rather than a permanent reduction in the effective tax rate.$19$,
  difficulty = 'medium'
WHERE id = 173;
...
Wrong (D): ASC 740 explicitly distinguishes permanent and temporary differences. Permanent differences have no deferred tax effect, while temporary differences require deferred tax recognition, making the classification essential to proper tax accounting.$19$,
  difficulty = 'easy'
WHERE id = 174;
...
Wrong (C): Bond proceeds are not required to be recorded in the debt service fund. Capital projects funds commonly record bond proceeds as other financing sources. The error is recording the bonds as a long-term liability in the general fund, which excludes long-term obligations.$19$,
  difficulty = 'medium'
WHERE id = 177;
