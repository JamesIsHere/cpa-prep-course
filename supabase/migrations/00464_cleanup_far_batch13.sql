...
Wrong (D): Tax-basis financial statements follow the IRC, not ASC 606. Revenue recognition under the IRC differs significantly from the five-step model in ASC 606.$EXPL$,
  difficulty = 'medium'
WHERE id = 1122;
...
Wrong (D): A qualified opinion for GAAP departure is not warranted when the statements comply with the applicable regulatory framework and are restricted to the regulatory agency.$EXPL$,
  difficulty = 'hard'
WHERE id = 1123;
...
Wrong (C): Modified cash basis is a variant of cash-basis reporting that records certain accruals. It is not defined by contractual reporting provisions in a loan agreement.$EXPL$,
  difficulty = 'hard'
WHERE id = 1125;
...
Wrong (D): When a loss is reasonably possible, ASC 450-20-50-3 requires disclosure. No accrual or disclosure would be appropriate only if the likelihood were remote.$EXPL$,
  difficulty = 'medium'
WHERE id = 1142;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 460-10-25-4, a guarantor must initially recognize a financial guarantee at its fair value, representing the stand-ready obligation to perform over the term of the guarantee. This fair value measurement reflects the premium that a market participant would require to issue the same guarantee at inception.
...
Wrong (D): The maximum potential amount of future payments represents the worst-case exposure and is a required disclosure under ASC 460-10-50-4, not the initial measurement basis. Fair value is typically much less than the maximum potential amount.$EXPL$,
  difficulty = 'hard'
WHERE id = 1143;
...
Wrong (D): A potential warranty claim on a low-value item with remote likelihood would fall under the general ASC 450 framework, where remote contingencies do not require disclosure. Unlike guarantees of indebtedness, warranty claims have no special remote-disclosure requirement.$EXPL$,
  difficulty = 'hard'
WHERE id = 1145;
...
UPDATE questions SET
  stem = $EXPL$Under ASC 820, when a fair value measurement uses significant inputs from different hierarchy levels, how is the entire measurement classified?$EXPL$,
  choices = $EXPL$["At the highest level of any significant input used","At the lowest level of any significant input used","At the weighted average of all input levels","At Level 2 by default for mixed-input measurements"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (B): Under ASC 820-10-35-37, when a fair value measurement uses inputs from multiple hierarchy levels, the entire measurement is classified at the lowest level of any significant input. If a significant unobservable input (Level 3) is used alongside observable inputs (Level 2), the entire measurement is Level 3. This ensures that the classification reflects the greatest degree of estimation uncertainty present.
...
Wrong (D): There is no default classification at Level 2 for mixed-input measurements. The hierarchy requires assessment of each significant input's level, with classification at the lowest.$EXPL$,
  difficulty = 'easy'
WHERE id = 1148;
...
Wrong (D): Financial guarantees within the scope of ASC 460 are eligible for the fair value option, allowing the guarantor to measure the obligation at fair value through earnings rather than under the ASC 460 measurement model.$EXPL$,
  difficulty = 'hard'
WHERE id = 1153;
...
Wrong (C): The market with the lowest transaction costs is not the correct criterion. While transaction costs are considered in identifying the most advantageous market, they are not used to measure fair value itself under ASC 820-10-35-9B.$EXPL$,
  difficulty = 'hard'
WHERE id = 1155;
...
Wrong (D): Present value of expected future cash flows discounted at the risk-free rate describes a specific income approach calculation. The income approach under ASC 820-10-35-24A uses risk-adjusted discount rates or certainty-equivalent cash flows, not necessarily the risk-free rate.$EXPL$,
  difficulty = 'hard'
WHERE id = 1282;
...
Wrong (D): NRV is not identical to fair value less costs to sell. Fair value under ASC 820 reflects a market-participant exit price, while NRV reflects an entity-specific selling price less entity-specific costs, producing potentially different amounts.$EXPL$,
  difficulty = 'medium'
WHERE id = 1283;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 715-20-35-26, net actuarial gains and losses arising during the period are recognized in other comprehensive income (OCI). These amounts are subsequently amortized from accumulated OCI into net periodic pension cost using the corridor approach or another systematic method.
...
Wrong (C): Amortization of prior service cost represents a reclassification from accumulated OCI into net periodic pension cost (net income). It reduces the OCI balance rather than being initially recognized there.$EXPL$,
  difficulty = 'medium'
WHERE id = 1857;
...
Wrong (D): A change requiring footnote disclosure only is insufficient. While disclosure is required, the change also affects the computation of depreciation expense going forward through prospective application.$EXPL$,
  difficulty = 'medium'
WHERE id = 1858;
...
Wrong (C): Disclosure in the footnotes with no adjustment is insufficient for a material error. ASC 250 requires both restatement and disclosure of the nature and effect of the error.$EXPL$,
  difficulty = 'medium'
WHERE id = 1859;
...
Wrong (C): A cumulative-effect adjustment to retained earnings is used when retrospective application is impracticable for all prior periods but the cumulative effect can be determined. For FIFO-to-LIFO changes, even the cumulative effect is typically indeterminable, so full prospective treatment applies.$EXPL$,
  difficulty = 'hard'
WHERE id = 1860;
...
Wrong (C): A cumulative catch-up adjustment in the current period only was the approach under the superseded APB Opinion 20. Under current ASC 250, the general requirement is full retrospective restatement of all prior periods presented.$EXPL$,
  difficulty = 'medium'
WHERE id = 1861;
...
Wrong (D): A cumulative catch-up adjustment is not the treatment for a change in estimate. Estimates are applied prospectively, affecting only the current and future periods.$EXPL$,
  difficulty = 'easy'
WHERE id = 1862;
...
Wrong (D): A ratio of 1.56 does not correspond to any correct calculation of the post-payment current assets and current liabilities.$EXPL$,
  difficulty = 'medium'
WHERE id = 1863;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 855-10-25-1, a Type I (recognized) subsequent event provides additional evidence about conditions that existed at the balance sheet date. Settlement of litigation that confirms a year-end loss estimate existed at the balance sheet date requires adjustment to the financial statements, as the underlying condition (the litigation) was present at year end.
...
Wrong (D): Issuance of new debt after the balance sheet date is a Type II event under ASC 855-10-25-3. It represents a new condition arising after year end and requires disclosure, not adjustment.$EXPL$,
  difficulty = 'medium'
WHERE id = 1866;
...
Wrong (D): A fixed contractual rate is not a valid exchange rate for translation under ASC 830. GAAP requires the use of actual exchange rates prevailing during the period.$EXPL$,
  difficulty = 'medium'
WHERE id = 1867;
...
Wrong (C): A change in the estimated residual value of a building is also a change in accounting estimate under ASC 250-10-45-17, applied prospectively. It reflects updated expectations about future salvage value, not a prior-period mistake.$EXPL$,
  difficulty = 'medium'
WHERE id = 1870;
...
Wrong (D): Splitting the obligation between current and noncurrent is not a recognized classification approach under ASC 470. The entire obligation is classified as either current or noncurrent based on whether the refinancing criteria are satisfied.$EXPL$,
  difficulty = 'hard'
WHERE id = 1873;
...
Wrong (D): The cumulative effect of the change on retained earnings is a required disclosure under ASC 250-10-50-1(c). This quantifies the total impact on prior-period equity from applying the new principle retrospectively.$EXPL$,
  difficulty = 'hard'
WHERE id = 1874;
...
Wrong (D): Changing the depreciation method from straight-line to units-of-production is a change in accounting estimate effected by a change in principle under ASC 250-10-45-18, applied prospectively from the date of change.$EXPL$,
  difficulty = 'medium'
WHERE id = 1876;
...
Wrong (C): No reporting at all would violate ASC 855-10-50-2, which requires disclosure of Type II subsequent events that are material enough to prevent the financial statements from being misleading.$EXPL$,
  difficulty = 'medium'
WHERE id = 1877;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Under ASC 230, how should a company report the acquisition of a building by issuing a long-term mortgage note directly to the seller on its statement of cash flows?$EXPL$,
  choices = $EXPL$["As a $500,000 operating outflow","As a noncash investing and financing activity disclosed in a supplemental schedule","As a $500,000 investing outflow and a $500,000 financing inflow","As a $500,000 financing outflow"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (B): Under ASC 230-10-50-3, acquiring an asset by directly issuing debt to the seller is a noncash transaction involving both investing (building acquisition) and financing (mortgage issuance). Because no cash changes hands, it is excluded from the statement of cash flows and instead disclosed in a separate supplemental schedule or in the notes.
...
Wrong (D): A financing outflow implies a cash payment to retire or reduce financing. No cash was disbursed in this transaction, and acquiring an asset is an investing activity, not a financing activity.$EXPL$,
  difficulty = 'easy'
WHERE id = 1878;
...
Wrong (D): Reporting only a $500,000 financing inflow implies cash was received from the note, which is incorrect. The note proceeds went directly to the seller as consideration for the building, not to the company as cash.$EXPL$,
  difficulty = 'medium'
WHERE id = 1883;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Greystone Distributors reports COGS of $2,400,000, beginning inventory of $310,000, ending inventory of $425,000, beginning accounts payable of $180,000, and ending accounts payable of $145,000. What is the cash paid to suppliers?$EXPL$,
  choices = $EXPL$["$2,285,000","$2,400,000","$2,515,000","$2,550,000"]$EXPL$::jsonb,
...
Wrong (C): $2,515,000 represents purchases (COGS adjusted for inventory change) but fails to add the $35,000 AP decrease, understating the actual cash paid to suppliers.$EXPL$,
  difficulty = 'medium'
WHERE id = 1886;
...
Wrong (C): A $300,000 net zero effect within financing activities mischaracterizes the transaction. The exchange involves both investing (land) and financing (stock) components, and no cash flow occurred in either category.$EXPL$,
  difficulty = 'easy'
WHERE id = 1891;
...
Wrong (D): A $200,000 net zero within financing activities incorrectly implies two offsetting cash flows occurred. No cash flows exist to offset — the entire transaction is noncash.$EXPL$,
  difficulty = 'medium'
WHERE id = 1893;
...
Wrong (D): ASC 260-10-45-29 requires convertible securities to be individually ranked by per-share impact from most dilutive to least dilutive, not tested simultaneously. This ranking prevents a less dilutive security from incorrectly appearing dilutive.$EXPL$,
  difficulty = 'medium'
WHERE id = 1911;
...
-- Issues: no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Cascade Industries has basic EPS of $4.00 (net income $600,000, 150,000 shares). It has two convertible bonds: Security 1 ($500,000 face, 10%, converts to 25 shares per $1,000 bond, 25% tax rate) and Security 2 ($400,000 face, 6%, converts to 30 shares per $1,000 bond, 25% tax rate). In what order should these be tested for diluted EPS?$EXPL$,
  choices = $EXPL$["Security 2 first ($1.50 per-share impact), then Security 1 ($3.00 per-share impact)","Security 1 first because it has higher interest expense","Both simultaneously because ranking is not required","Security 2 excluded because its 6% coupon is below cost of equity"]$EXPL$::jsonb,
...
Wrong (D): The dilution test compares per-share impact to basic EPS, not the coupon rate to cost of equity. Security 2's $1.50 per-share impact is well below $4.00 basic EPS, confirming it is dilutive.$EXPL$,
  difficulty = 'hard'
WHERE id = 1920;
...
Wrong (D): EPS presentation is not optional for public companies. ASC 260-10-45-2 makes it a mandatory requirement. Only nonpublic entities are exempt from the EPS presentation requirement.$EXPL$,
  difficulty = 'easy'
WHERE id = 1921;
...
Wrong (D): $80,000 does not result from the relative standalone selling price calculation. The correct proportional allocation yields $85,714 for the license.$EXPL$,
  difficulty = 'medium'
WHERE id = 1925;
...
Wrong (C): $40,000 may result from incorrectly applying a 20% discount or miscalculating the number of discounted units. The contract specifies a 5% volume discount on all units when the threshold is met.$EXPL$,
  difficulty = 'medium'
WHERE id = 1926;
...
Wrong (D): Noncash consideration measured at fair value under ASC 606-10-32-23 is a form of consideration but is not inherently variable. Its fair value is determined at contract inception and included in the transaction price unless the form of consideration itself varies.$EXPL$,
  difficulty = 'easy'
WHERE id = 1927;
...
Wrong (C): No alternative use with an enforceable right to payment is the third over-time criterion under ASC 606-10-25-27(c). This applies to customized goods that cannot be redirected to another customer.$EXPL$,
  difficulty = 'medium'
WHERE id = 1929;
...
Wrong (C): Recognizing $0 is overly conservative. ASC 606 does not defer all revenue when a return right exists; instead, revenue is recognized net of expected returns when it is probable a significant reversal will not occur.$EXPL$,
  difficulty = 'easy'
WHERE id = 1930;
...
Wrong (C): Prospective combination with the original contract applies under ASC 606-10-25-13(a) when the modification is not a separate contract and the remaining goods are distinct. It does not apply when the separate-contract criteria are met.$EXPL$,
  difficulty = 'medium'
WHERE id = 1933;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 606-10-25-19, a promised good or service is distinct if it meets two criteria: (1) the customer can benefit from it on its own or together with readily available resources (capable of being distinct), and (2) the promise to transfer the good or service is separately identifiable from other promises in the contract (distinct within the context of the contract).
...
Wrong (D): Requiring specialized installation or integration services from the entity actually suggests the good or service may not be distinct within the context of the contract under ASC 606-10-25-21(b), because the entity is providing a significant integration service that combines the deliverables.$EXPL$,
  difficulty = 'easy'
WHERE id = 1935;
...
Wrong (D): Providing a warranty on the goods is an indicator of being a principal because it suggests the entity has taken responsibility for the goods' quality and performance, which is inconsistent with an agency relationship.$EXPL$,
  difficulty = 'medium'
WHERE id = 1938;
...
Wrong (C): Recognizing only the loss incurred to date understates the total expected loss. The entire anticipated loss must be recognized immediately to prevent misleading financial statements about the contract's profitability.$EXPL$,
  difficulty = 'medium'
WHERE id = 1939;
...
Wrong (D): The equity method is used to account for investments in entities over which the investor has significant influence under ASC 323. It is an investment accounting method, not a standalone selling price estimation technique.$EXPL$,
  difficulty = 'easy'
WHERE id = 1940;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 606-10-32-5, early payment discounts (such as 2/10, net 30) are a form of variable consideration. When the entity estimates all customers will take the 2% discount, the transaction price is reduced accordingly: 500 units × $100 × (1 − 0.02) = $49,000. The discount is included in the transaction price estimate subject to the constraint in ASC 606-10-32-11.
...
Wrong (D): $51,000 exceeds the gross sales amount and does not correspond to any correct application of the 2/10, net 30 discount terms.$EXPL$,
  difficulty = 'medium'
WHERE id = 1941;
...
Wrong (C): Recognizing revenue when cash is collected follows the cash basis, which is not consistent with ASC 606. Revenue is recognized as performance obligations are satisfied, not when cash is received (unless the collection method is used under specific constraints).$EXPL$,
  difficulty = 'hard'
WHERE id = 1944;
...
Wrong (D): Deferring all revenue until all units are delivered is not a treatment under ASC 606 for modifications. Revenue continues to be recognized as units are delivered under the respective contracts.$EXPL$,
  difficulty = 'medium'
WHERE id = 1949;
...
Wrong (C): Having three years of historical data is not a requirement. While historical experience is relevant to estimating variable consideration and assessing the constraint, ASC 606 does not mandate any specific minimum period of historical data.$EXPL$,
  difficulty = 'medium'
WHERE id = 1950;
...
Wrong (D): Fair value less costs to sell is the measurement basis for certain biological assets under IAS 41, not for inventory under U.S. GAAP. ASC 330 uses the NRV concept, which is entity-specific rather than market-participant-based.$EXPL$,
  difficulty = 'easy'
WHERE id = 1961;
...
Wrong (D): A LIFO liquidation occurs when ending base-year inventory is less than beginning base-year inventory, meaning quantities decreased. Here, base-year inventory increased from $80,000 to $90,000, so a new layer was added, not liquidated.$EXPL$,
  difficulty = 'hard'
WHERE id = 1974;
...
Wrong (C): The revenue recognition principle (ASC 606) governs when revenue is recognized from customer contracts. It is unrelated to inventory valuation method conformity between tax and financial reporting.$EXPL$,
  difficulty = 'medium'
WHERE id = 1986;
