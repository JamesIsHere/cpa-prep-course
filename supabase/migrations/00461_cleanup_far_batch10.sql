...
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 326-20-30-1 (CECL model), the allowance for credit losses is maintained at the level of expected lifetime losses. The required allowance is $2,000,000 × 4% = $80,000. Since the existing allowance is $50,000, bad debt expense is the adjustment needed: $80,000 − $50,000 = $30,000.
...
Wrong (D): $130,000 incorrectly adds the existing allowance to the required allowance rather than computing the difference between them.$EXPL$,
  difficulty = 'medium'
WHERE id = 2249;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 860-20-25-1, a transfer of receivables without recourse that meets the sale criteria results in derecognition. Cash received = $500,000 − $15,000 (3% factor fee) − $25,000 (5% holdback) = $460,000. The holdback is recorded as a receivable from the factor.
...
Wrong (D): $485,000 incorrectly applies only the factor fee deduction and ignores the holdback.$EXPL$,
  difficulty = 'medium'
WHERE id = 2250;
...
Wrong (D): $20,000 considers only the recourse liability and ignores the factor fee component of the loss.$EXPL$,
  difficulty = 'hard'
WHERE id = 2252;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 860-10-40-5, an assignment of receivables is a secured borrowing, not a sale. Jasper records Cash (debit) $320,000 and Notes Payable (credit) $320,000. The receivables remain on Jasper's balance sheet and are disclosed as collateral for the loan.
...
Wrong (D): Recording a gain of $80,000 is incorrect because no sale has occurred and the $80,000 difference simply represents the excess collateral over the loan amount.$EXPL$,
  difficulty = 'medium'
WHERE id = 2254;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-25-2, a noninterest-bearing note received in a revenue transaction must be recorded at its present value using the prevailing market rate. PV = $50,000 ÷ (1.10)² = $50,000 ÷ 1.21 = $41,322 (rounded). The $8,678 discount represents imputed interest recognized over the note's term.
...
Wrong (D): $40,000 is not the result of any valid present value calculation at the given rate and term.$EXPL$,
  difficulty = 'medium'
WHERE id = 2256;
...
UPDATE questions SET
  stem = $EXPL$Under the CECL model, which method is NOT a valid approach for estimating expected credit losses on trade receivables?$EXPL$,
  choices = $EXPL$["Aging schedule method","Loss-rate method based on historical data","Discounted cash flow method","Specific identification of accounts already deemed uncollectible"]$EXPL$::jsonb,
...
Wrong (C): The discounted cash flow method estimates expected cash flows and is a valid measurement technique under ASC 326-20-30-4.$EXPL$,
  difficulty = 'easy'
WHERE id = 2257;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 326-20-30-2, the aging schedule method applies expected loss percentages to each aging category. Current: $500,000 × 1% = $5,000; 31–60 days: $200,000 × 3% = $6,000; 61–90 days: $80,000 × 8% = $6,400; Over 90 days: $40,000 × 25% = $10,000. Total required allowance = $27,400.
...
Wrong (D): $41,000 significantly overstates the allowance, likely by applying the highest loss rate too broadly across multiple categories.$EXPL$,
  difficulty = 'medium'
WHERE id = 2258;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 250-10-45-23, a bank error is corrected on the bank side of the reconciliation. Since the bank incorrectly deducted $2,000, the bank balance is understated and must be increased by $2,000. Company A notifies the bank but makes no journal entry.
...
Wrong (C): Adjusting Company B's book balance is irrelevant to Company A's reconciliation; Company B's records are separate.$EXPL$,
  difficulty = 'easy'
WHERE id = 2259;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 440-10-50-1, the undrawn portion of a line of credit is an off-balance-sheet commitment. Only the $400,000 drawn is recorded as a liability. The $600,000 available commitment is disclosed in the notes to the financial statements as a financial commitment.
...
Wrong (D): Accounts receivable of $600,000 is incorrect because the company has no right to receive cash from the bank without first drawing on the line.$EXPL$,
  difficulty = 'medium'
WHERE id = 2260;
...
Wrong (D): Debiting Bad Debt Expense and crediting the Allowance records additional expense without removing the uncollectible receivable from the books.$EXPL$,
  difficulty = 'easy'
WHERE id = 2261;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 835-30-35-2, interest revenue is accrued based on the passage of time. From March 1 to December 31 is 10 months. Accrued interest = $200,000 × 5% × 10/12 = $8,333. The adjusting entry debits Interest Receivable and credits Interest Revenue.
...
Wrong (D): Debiting Cash is incorrect because the interest has been earned but not yet received; the debit should be to Interest Receivable until cash is collected.$EXPL$,
  difficulty = 'medium'
WHERE id = 2262;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 326-20-30-1, the required ending allowance equals expected credit losses: $3,000,000 × 5% = $150,000. The allowance before adjustment = beginning balance $130,000 − write-offs $120,000 + recoveries $15,000 = $25,000. Bad debt expense = $150,000 − $25,000 = $125,000.
...
Wrong (C): $105,000 may result from ignoring the recovery of $15,000 in the allowance rollforward calculation.$EXPL$,
  difficulty = 'hard'
WHERE id = 2263;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 810-10-45-16, the noncontrolling interest is adjusted each period for the NCI's share of the subsidiary's income and dividends. NCI share of income = 25% × $400,000 = $100,000. NCI share of dividends = 25% × $80,000 = $20,000. Ending NCI = $600,000 + $100,000 − $20,000 = $680,000.
...
Wrong (D): $520,000 incorrectly reduces NCI for the full dividend or income amount rather than the 25% NCI share.$EXPL$,
  difficulty = 'medium'
WHERE id = 2267;
...
Wrong (D): Restricted cash is a real asset that must be reported on the balance sheet; omitting it would understate total assets.$EXPL$,
  difficulty = 'medium'
WHERE id = 2268;
...
Wrong (C): Recognizing only $140,000 in revenue understates total revenue; the full $200,000 is recognized upon receipt, with a separate reclassification entry for the portion spent.$EXPL$,
  difficulty = 'medium'
WHERE id = 2271;
...
Wrong (C): Disclosing only whether assets were used or sold omits the required information about valuation techniques, donor restrictions, and categorical disaggregation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2277;
...
Wrong (D): Debiting Cash is incorrect because no cash transaction occurs upon expiration of a time restriction; the entry involves only net asset reclassification.$EXPL$,
  difficulty = 'easy'
WHERE id = 2278;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$A not-for-profit has an endowment with an original gift value of $2,000,000. Due to investment losses, the endowment's fair value has declined to $1,850,000. Under UPMIFA, how should the NFP report this endowment?$EXPL$,
  choices = $EXPL$["Restore the endowment to $2,000,000 using unrestricted funds","Report the $150,000 decline as a loss in net assets without donor restrictions","Write off the endowment as permanently impaired","Report at $1,850,000 within net assets with donor restrictions and disclose the underwater amount"]$EXPL$::jsonb,
...
Wrong (C): Endowments are not written off as impaired; the donor restriction remains even when the fair value drops below the original gift amount.$EXPL$,
  difficulty = 'hard'
WHERE id = 2280;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 958-210-45-1, the statement of financial position equation for NFPs is Total Assets − Total Liabilities = Total Net Assets. Total net assets = $8,500,000 − $2,200,000 = $6,300,000. Net assets without donor restrictions = $6,300,000 − $3,100,000 = $3,200,000.
...
Wrong (D): $8,500,000 is total assets before deducting liabilities and does not represent any net asset category.$EXPL$,
  difficulty = 'easy'
WHERE id = 2282;
...
Wrong (D): 25% is the management and general ratio ($1,500,000 ÷ $6,000,000), not the program efficiency ratio.$EXPL$,
  difficulty = 'easy'
WHERE id = 2284;
...
Wrong (C): Waiting until fiscal year-end ignores the actual date the condition was met, which is two months after the grant agreement.$EXPL$,
  difficulty = 'medium'
WHERE id = 2286;
...
Wrong (C): Immediate release upon purchase would only be appropriate if the NFP's accounting policy does not imply a time restriction over the asset's useful life.$EXPL$,
  difficulty = 'hard'
WHERE id = 2289;
...
Wrong (C): $21,667 applies a straight-line method to the total discount, which is incorrect because the effective interest method must be used under ASC 835-30.$EXPL$,
  difficulty = 'hard'
WHERE id = 2290;
...
Wrong (D): The Debt Service Fund handles principal and interest payments on long-term debt, not the construction expenditures financed by the bonds.$EXPL$,
  difficulty = 'easy'
WHERE id = 2300;
...
Wrong (D): Governmental funds are required to record the adopted budget in the accounting system, not merely disclose it in the notes.$EXPL$,
  difficulty = 'medium'
WHERE id = 2301;
...
Wrong (D): The budget-to-actual comparison is required supplementary information (RSI), not a government-wide financial statement.$EXPL$,
  difficulty = 'easy'
WHERE id = 2304;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under GASB 34, paragraph 32, net position = (Total Assets + Deferred Outflows) − (Total Liabilities + Deferred Inflows) = ($250,000,000 + $8,000,000) − ($160,000,000 + $12,000,000) = $86,000,000. Net position is reported in three categories. Unrestricted = $86,000,000 − $45,000,000 (net investment in capital assets) − $15,000,000 (restricted) = $26,000,000.
...
Wrong (D): $98,000,000 likely ignores deferred inflows of resources in the net position calculation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2305;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Under modified accrual accounting, which revenue source is recognized when the underlying exchange occurs, provided the revenue is available?$EXPL$,
  choices = $EXPL$["Property taxes levied for the current year","Fines assessed but not yet collected","Federal grants reimbursing qualifying expenditures","Sales taxes collected by merchants"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (D): Under GASB 33, paragraph 16, sales taxes are derived tax revenues recognized when the underlying exchange (the sale) occurs, provided the revenue is available (collected within the availability period). They follow the exchange-transaction timing of the taxable event.
...
Wrong (C): Federal reimbursement grants are voluntary nonexchange transactions recognized when qualifying expenditures are incurred under GASB 33, paragraph 21, following eligibility requirements rather than an exchange event.$EXPL$,
  difficulty = 'medium'
WHERE id = 2306;
...
Wrong (D): Internal Service Funds provide goods or services to other government departments, not to the external public. A water utility serves external customers.$EXPL$,
  difficulty = 'easy'
WHERE id = 2307;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$A government's internal service fund provides printing services to other departments. During the year, the fund billed $2,400,000 and incurred costs of $2,100,000. How are internal service fund activities typically reported in the government-wide financial statements?$EXPL$,
  choices = $EXPL$["In a dedicated internal service activities column","Eliminated entirely from government-wide reporting","Reported within business-type activities","Reported within governmental activities when governmental funds are the predominant participants"]$EXPL$::jsonb,
...
Wrong (C): Reporting as business-type activities would be appropriate only if external parties are the predominant customers, which is uncommon for internal service funds.$EXPL$,
  difficulty = 'hard'
WHERE id = 2308;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under GASB 34, paragraph 38, the statement of activities uses a net cost format. Program revenues ($22,000,000) are deducted from program expenses ($80,000,000) to show the net expense of $58,000,000 that must be financed by general revenues such as taxes and unrestricted grants.
...
Wrong (C): $22,000,000 is the total program revenue, not the net expense borne by general taxpayers.$EXPL$,
  difficulty = 'easy'
WHERE id = 2312;
...
Wrong (C): Both statements do not report a capital asset; the General Fund reports expenditures, not capital assets, under modified accrual.$EXPL$,
  difficulty = 'medium'
WHERE id = 2313;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under GASB 54 fund balance reporting, the ending fund balance equals beginning balance plus revenues plus other financing sources minus expenditures. Ending = $800,000 + $5,000,000 + $120,000 + $600,000 − $3,500,000 − $1,800,000 = $1,220,000. The $600,000 transfer in is an other financing source that increases fund balance.
...
Wrong (D): $220,000 likely omits both the interest income and the transfer in from the calculation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2317;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under GASB 34, paragraphs 77–79, the reconciliation between governmental fund statements and government-wide governmental activities requires adding capital assets that were recorded as expenditures in the funds. Government-wide statements capitalize long-lived assets under the economic resources focus and accrual basis.
...
Wrong (D): Governmental funds use modified accrual, not cash basis. The reconciliation converts from modified accrual to full accrual, not from cash basis.$EXPL$,
  difficulty = 'medium'
WHERE id = 2319;
...
Wrong (C): $5,000,000 is the unavailable portion reported as a deferred inflow, not the revenue to be recognized.$EXPL$,
  difficulty = 'hard'
WHERE id = 2320;
...
Wrong (C): $2,400,000 may subtract nonoperating items from operating income but omit the capital contributions from developers.$EXPL$,
  difficulty = 'medium'
WHERE id = 2322;
...
Wrong (D): Recording no entry ignores both the collection fee revenue earned by the county and its custodial obligation to remit the $2,450,000.$EXPL$,
  difficulty = 'medium'
WHERE id = 2323;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$A government's General Fund transfers $3,000,000 to a Capital Projects Fund and $1,000,000 to an Enterprise Fund. How are these transfers reported in the General Fund?$EXPL$,
  choices = $EXPL$["Expenditures of $3,000,000 and transfers out of $1,000,000","Expenditures totaling $4,000,000","Revenue reductions totaling $4,000,000","Other financing uses totaling $4,000,000"]$EXPL$::jsonb,
...
Wrong (C): Revenue reductions do not apply to interfund transfers; transfers affect other financing sources/uses, a separate section of the fund financial statements.$EXPL$,
  difficulty = 'easy'
WHERE id = 2324;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$A city issues $20,000,000 of general obligation bonds at 102 (a 2% premium). In the Capital Projects Fund, how should the total proceeds be reported?$EXPL$,
  choices = $EXPL$["Revenue of $20,400,000","A single other financing source of $20,400,000","Bond proceeds of $20,000,000 with the premium transferred to the Debt Service Fund","Bond proceeds of $20,000,000 and premium on bonds of $400,000 as separate other financing sources"]$EXPL$::jsonb,
...
Wrong (C): While the premium may be transferred to the Debt Service Fund per the bond resolution, the initial reporting in the Capital Projects Fund must show both the face value and premium as separate other financing sources.$EXPL$,
  difficulty = 'hard'
WHERE id = 2325;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 715-30-35-4, net periodic pension cost = service cost + interest cost − expected return on plan assets + amortization of prior service cost + amortization of net loss. = $400,000 + $320,000 − $280,000 + $50,000 + $30,000 = $520,000. Under ASU 2017-07, only service cost is in operating income; other components are below the line.
...
Wrong (D): $400,000 is only the service cost component, not total net periodic pension cost, which includes all five components.$EXPL$,
  difficulty = 'medium'
WHERE id = 2327;
...
Wrong (D): Amortization of prior service cost is a non-service cost component that must be reported below operating income.$EXPL$,
  difficulty = 'easy'
WHERE id = 2328;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 715-30-35-12, ending PBO = beginning PBO + service cost + interest cost − benefits paid ± actuarial gains/losses. Interest cost = $5,000,000 × 6% = $300,000. Ending PBO = $5,000,000 + $350,000 + $300,000 − $420,000 + $180,000 = $5,410,000.
...
Wrong (D): $5,590,000 may double-count the actuarial loss or add benefits paid instead of subtracting them.$EXPL$,
  difficulty = 'medium'
WHERE id = 2329;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 715-30-35-21, ending plan assets at fair value = beginning fair value + actual return + employer contributions − benefits paid. = $4,000,000 + $360,000 + $500,000 − $350,000 = $4,510,000. The actual return (not expected return) is used when reconciling plan asset balances.
...
Wrong (D): $4,010,000 may omit both the actual return and employer contribution, significantly understating ending plan assets.$EXPL$,
  difficulty = 'medium'
WHERE id = 2330;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 715-30-35-22, when the actual return ($220,000) is less than the expected return ($300,000), an asset loss of $80,000 results. This loss is recognized in other comprehensive income and accumulated in AOCI. It is amortized into pension expense in future periods only if the cumulative unrecognized net gain or loss exceeds the corridor threshold (10% of the greater of PBO or plan assets).
...
Wrong (D): Claiming no effect is incorrect because the difference between actual and expected return must be recognized in OCI as an asset gain or loss.$EXPL$,
  difficulty = 'medium'
WHERE id = 2331;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (D): Under ASC 715-70-25-1, in a defined contribution plan, the employer's expense equals the contribution made each period. Employee contribution = 6% × $120,000 = $7,200. Company match = 50% × $7,200 = $3,600. Unlike defined benefit plans, there is no PBO or complex actuarial calculation.
...
Wrong (C): $1,800 may incorrectly apply the 50% match to only half the employee contribution or use an incorrect salary percentage.$EXPL$,
  difficulty = 'easy'
WHERE id = 2338;
...
Wrong (D): $630,000 is the total AOCI balance ($450,000 + $180,000), not the amount reclassified during the period. Only the amortized portions are reclassified.$EXPL$,
  difficulty = 'medium'
WHERE id = 2340;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 715-30-35-11, prior service cost is amortized over the average remaining service period of active employees expected to receive benefits. Amortization = $500,000 ÷ 8 years = $62,500 per year. This amount is reclassified from AOCI to net periodic pension cost each year.
...
Wrong (D): $50,000 divides the prior service cost by 10 years (the years of past service credit), which is the basis for the cost calculation, not the amortization period.$EXPL$,
  difficulty = 'medium'
WHERE id = 2344;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 715-60-35-8, increasing the healthcare cost trend rate raises expected future benefit payments, which increases the accumulated postretirement benefit obligation (APBO). This in turn increases both service cost (present value of current-year benefit accrual) and interest cost (discount rate applied to the larger APBO).
...
Wrong (D): An increase in the trend rate increases rather than decreases the APBO and OPEB expense, because higher projected costs raise the obligation and its components.$EXPL$,
  difficulty = 'medium'
WHERE id = 2349;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$A company has a defined benefit pension plan with a PBO of $15,000,000, plan assets of $11,000,000, AOCI losses of $2,800,000, and prior service cost in AOCI of $600,000. The company terminates the plan and settles all obligations by purchasing annuity contracts. What must be recognized upon settlement?$EXPL$,
  choices = $EXPL$["Only the $600,000 prior service cost in income","No immediate recognition; AOCI amounts continue to amortize","Only the $4,000,000 underfunded status in income","All $3,400,000 of AOCI items in income plus any settlement gain or loss"]$EXPL$::jsonb,
...
Wrong (C): The $4,000,000 underfunded status is the funded status difference ($15,000,000 − $11,000,000), which is already reflected on the balance sheet as a net pension liability. Settlement recognition relates to AOCI items, not the funded status.$EXPL$,
  difficulty = 'hard'
WHERE id = 2350;
...
Wrong (D): Recording accounts receivable requires accrual-basis recognition of revenue before cash is received, which contradicts the fundamental cash-basis principle.$EXPL$,
  difficulty = 'easy'
WHERE id = 2351;
