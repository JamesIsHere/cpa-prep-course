...
Wrong (C): $90,000 incorrectly uses a 3% discount rate on par, overstating the actual 2% discount.$EXPL$,
  difficulty = 'easy'
WHERE id = 2085;
...
Wrong (D): Increasing interest expense each period describes the pattern for discount bonds under the effective interest method, not premium bonds.$EXPL$,
  difficulty = 'easy'
WHERE id = 2086;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 470-20-25-2, an induced conversion occurs when the issuer offers additional consideration beyond the original conversion terms—such as extra cash, shares, or other sweeteners—to incentivize bondholders to convert earlier. The fair value of the additional consideration is recognized as debt conversion expense.
...
Wrong (D): Repurchasing bonds on the open market is a debt extinguishment, not a conversion event.$EXPL$,
  difficulty = 'medium'
WHERE id = 2088;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-35-2, interest expense under the straight-line method equals cash interest minus annual premium amortization. Cash interest = $4,000,000 × 7% = $280,000. Premium = $4,000,000 × 0.05 = $200,000. Annual amortization = $200,000 ÷ 10 = $20,000. Interest expense = $280,000 − $20,000 = $260,000.
...
Wrong (D): $320,000 overstates interest expense by adding an incorrect amortization amount to cash interest.$EXPL$,
  difficulty = 'medium'
WHERE id = 2090;
...
Wrong (D): $80,000 incorrectly computes the gain using the full premium rather than comparing carrying amount to reacquisition price.$EXPL$,
  difficulty = 'medium'
WHERE id = 2091;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-35-4, the effective interest method computes interest expense as carrying amount × market rate. For discount bonds, the carrying amount increases each period as the discount is amortized, causing interest expense to increase over the bond's life.
...
Wrong (D): Interest expense does not alternate; it follows a monotonically increasing pattern for discount bonds under the effective interest method.$EXPL$,
  difficulty = 'medium'
WHERE id = 2092;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-25-1, interest expense accrues over time based on the outstanding principal. The bonds were issued October 1, so only 3 months of interest accrues through December 31. Interest expense = $600,000 × 9% × (3/12) = $13,500. An adjusting entry at year-end records this amount.
...
Wrong (D): $40,500 represents 9 months of interest, incorrectly dating from April 1 rather than the October 1 issue date.$EXPL$,
  difficulty = 'easy'
WHERE id = 2093;
...
UPDATE questions SET
  stem = $EXPL$Under the fair value option (ASC 825-10), a company elects to measure its bonds payable at fair value. At year-end, the bonds' fair value has decreased by $50,000 due to an increase in the company's own credit risk. How should this $50,000 change be reported?$EXPL$,
  choices = $EXPL$["In net income as a fair value gain","As a direct adjustment to retained earnings","In accumulated other comprehensive income (AOCI)","In other comprehensive income (OCI)"]$EXPL$::jsonb,
...
Wrong (C): AOCI is the cumulative balance sheet account; the period change is reported in OCI, which then accumulates into AOCI.$EXPL$,
  difficulty = 'hard'
WHERE id = 2094;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 470-20-25-2, when bonds are issued with detachable stock warrants, the proceeds are allocated between the bonds and warrants based on their relative fair values. Total fair value = $960,000 + $80,000 = $1,040,000. Bonds allocation = ($960,000 ÷ $1,040,000) × $1,000,000 = $923,077. Warrants allocation = ($80,000 ÷ $1,040,000) × $1,000,000 = $76,923.
...
Wrong (D): $920,000 to bonds incorrectly subtracts the warrant fair value directly from proceeds rather than using the relative fair value proportional allocation.$EXPL$,
  difficulty = 'hard'
WHERE id = 2096;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 835-30-25-1, a bond is issued at par when the stated (coupon) rate equals the market (effective) rate at issuance. Investors pay exactly face value because the coupon rate provides a return equal to the prevailing market rate.
...
Wrong (D): Bonds without coupon payments are zero-coupon bonds, which are always issued at a deep discount, not at par.$EXPL$,
  difficulty = 'easy'
WHERE id = 2097;
...
Wrong (C): $350,000 incorrectly applies the full annual 7% market rate to half a year or miscomputes the carrying amount.$EXPL$,
  difficulty = 'medium'
WHERE id = 2098;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 835-30-35-2, interest expense under the straight-line method equals cash interest plus annual discount amortization. Cash interest = $3,000,000 × 8% = $240,000. Discount = $3,000,000 × 0.03 = $90,000. Annual amortization = $90,000 ÷ 5 = $18,000. Interest expense = $240,000 + $18,000 = $258,000.
...
Wrong (D): $222,000 incorrectly subtracts the amortization from cash interest, but discount amortization increases interest expense, not decreases it.$EXPL$,
  difficulty = 'medium'
WHERE id = 2101;
...
Wrong (D): Covenant disclosure is required for all outstanding debt, not only debt reclassified as current due to a violation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2102;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Osborne Corp. has a $5,000,000 loan that violates a debt covenant at the balance sheet date. The lender has not waived the violation. Under ASC 470-10, how should the loan be classified on the balance sheet?$EXPL$,
  choices = $EXPL$["As a long-term liability based on the original maturity date","As a reclassification to equity pending resolution","As a contingent liability disclosed in the notes only","As a current liability due to the lender's right to demand repayment"]$EXPL$::jsonb,
...
Wrong (C): A contingent liability with note disclosure only applies when a loss is reasonably possible, not when the debt is callable on demand due to a covenant violation.$EXPL$,
  difficulty = 'hard'
WHERE id = 2103;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 835-30-25-1, interest accrues over time. Interest was last paid on September 1. From September 1 to December 31 is 4 months. Accrued interest = $1,000,000 × 6% × (4/12) = $20,000. This amount is recorded as interest payable on the balance sheet.
...
Wrong (D): $40,000 represents 8 months of interest, which exceeds the 4-month accrual period since the last payment.$EXPL$,
  difficulty = 'easy'
WHERE id = 2104;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Dunn Corp. refinances a $2,000,000 short-term note payable with a 5-year long-term note on February 15, Year 2. The financial statements for Year 1 are issued on March 1, Year 2. Under ASC 470-10, how should the original short-term note be classified on the December 31, Year 1, balance sheet?$EXPL$,
  choices = $EXPL$["As a current liability because refinancing had not yet occurred at year-end","As a long-term liability because refinancing was completed before issuance","As a current liability because post-year-end events never affect classification","As a noncurrent contingent obligation pending refinancing completion"]$EXPL$::jsonb,
...
Wrong (D): The obligation is not contingent; it is a definite liability whose classification depends on the refinancing analysis under ASC 470-10.$EXPL$,
  difficulty = 'hard'
WHERE id = 2105;
...
Wrong (C): Crediting common stock for only $8,000 treats stated value as a per-share amount applied to 1,000 shares rather than the full 5,000 shares issued.$EXPL$,
  difficulty = 'easy'
WHERE id = 2108;
...
Wrong (C): Preferred shareholders typically do not have general voting rights; voting is a feature of common stock.$EXPL$,
  difficulty = 'easy'
WHERE id = 2109;
...
Wrong (D): $240,000 represents only the arrears and omits the current year's $120,000 preferred dividend.$EXPL$,
  difficulty = 'medium'
WHERE id = 2110;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-30-30-3, treasury stock acquired under the cost method is debited at the total acquisition cost. Treasury stock = 3,000 × $20 = $60,000. The entry debits treasury stock (a contra-equity account) and credits cash for $60,000.
...
Wrong (D): Debiting APIC is used in the par value method, not the cost method, for recording treasury stock acquisitions.$EXPL$,
  difficulty = 'easy'
WHERE id = 2111;
...
Wrong (D): Crediting retained earnings for the excess is incorrect; excesses on treasury stock reissuances above cost are credited to APIC, not retained earnings.$EXPL$,
  difficulty = 'medium'
WHERE id = 2112;
...
Wrong (D): Recording a loss on treasury stock is prohibited; treasury stock transactions are capital transactions that do not flow through the income statement.$EXPL$,
  difficulty = 'medium'
WHERE id = 2113;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-20-30-3, a small stock dividend (less than 20–25% of outstanding shares) is recorded at fair market value. Shares issued = 100,000 × 10% = 10,000. Retained earnings debit = 10,000 × $30 = $300,000. Common stock credit = 10,000 × $5 = $50,000. APIC credit = $300,000 − $50,000 = $250,000.
...
Wrong (D): Debiting APIC instead of retained earnings is incorrect; stock dividends reduce retained earnings, not APIC.$EXPL$,
  difficulty = 'medium'
WHERE id = 2114;
...
Wrong (D): Average cost of outstanding shares is not a recognized measurement basis for recording stock dividends under U.S. GAAP.$EXPL$,
  difficulty = 'medium'
WHERE id = 2115;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 505-20-25-3, a 2-for-1 stock split doubles the number of shares and halves the par value per share. New shares = 200,000 × 2 = 400,000. New par = $10 ÷ 2 = $5. Total par value remains $2,000,000. No journal entry is required—only a memo entry.
...
Wrong (D): 100,000 shares at $20 par describes a 1-for-2 reverse stock split, not a 2-for-1 forward split.$EXPL$,
  difficulty = 'easy'
WHERE id = 2116;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 505-10-25-2, issuing common stock above par increases total shareholders' equity. Cash is debited, and common stock plus APIC are credited, adding net assets to the company.
...
Wrong (D): Declaring a stock dividend reclassifies amounts within equity (retained earnings to common stock and APIC) but does not change total equity.$EXPL$,
  difficulty = 'easy'
WHERE id = 2117;
...
Wrong (D): $200,000 understates the preferred dividend, possibly confusing the common shareholder's portion with the preferred allocation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2119;
...
Wrong (C): $50,000 may result from dividing the remainder equally rather than proportionally by relative par values.$EXPL$,
  difficulty = 'hard'
WHERE id = 2120;
...
Wrong (C): Appropriated retained earnings are part of equity, not a liability; no obligation to external parties is created by the appropriation.$EXPL$,
  difficulty = 'medium'
WHERE id = 2122;
...
Wrong (D): $28,000 uses only the per-share stock price without multiplying by the number of shares, which is a computational error.$EXPL$,
  difficulty = 'medium'
WHERE id = 2123;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-10-25-4, the book value method transfers the carrying amount of preferred stock to common stock and APIC with no gain or loss. Shares of common issued = 500 × 4 = 2,000. Book value of preferred = 500 × $100 = $50,000. Common stock at par = 2,000 × $10 = $20,000. APIC = $50,000 − $20,000 = $30,000.
...
Wrong (D): $2,000 to common stock appears to use the wrong par value per share, and the $48,000 to APIC does not reconcile to the $50,000 book value.$EXPL$,
  difficulty = 'medium'
WHERE id = 2124;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 505-10-25-2, stock issuance costs reduce APIC rather than being expensed. Total proceeds = 15,000 × $35 = $525,000. Common stock at par = 15,000 × $20 = $300,000. Gross APIC = $525,000 − $300,000 = $225,000. Net APIC = $225,000 − $18,000 issuance costs = $207,000.
...
Wrong (D): $210,000 uses an incorrect deduction amount, not matching the stated $18,000 issuance costs.$EXPL$,
  difficulty = 'medium'
WHERE id = 2125;
...
Wrong (C): Automatic conversion at a predetermined date describes mandatory convertible preferred stock, not callable preferred stock.$EXPL$,
  difficulty = 'easy'
WHERE id = 2126;
...
Wrong (D): A new APIC account does not replace retained earnings; rather, APIC may be adjusted as part of the quasi-reorganization, but retained earnings remains a separate account.$EXPL$,
  difficulty = 'hard'
WHERE id = 2128;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-10-45-2, total shareholders' equity includes all equity components: common stock + APIC + retained earnings, minus contra-equity accounts such as treasury stock. Total = $500,000 + $300,000 + $400,000 − $80,000 = $1,120,000.
...
Wrong (D): $1,180,000 applies an incorrect deduction amount for treasury stock.$EXPL$,
  difficulty = 'easy'
WHERE id = 2129;
...
Wrong (C): Debiting common stock for $36,000 exceeds the par value component and does not properly allocate the cost among common stock, APIC, and retained earnings.$EXPL$,
  difficulty = 'hard'
WHERE id = 2130;
...
Wrong (D): A decrease of $25,000 has no basis in the stock dividend accounting; the par value component does not reduce total equity.$EXPL$,
  difficulty = 'easy'
WHERE id = 2131;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-10-25-2, when no-par stock has no stated value, the entire proceeds are credited to the common stock account. No APIC is created because there is no par or stated value to create a dividing line. Common stock is credited for the full $440,000 (20,000 × $22).
...
Wrong (D): Crediting APIC for the entire $440,000 with no common stock credit is incorrect; the common stock account must be credited.$EXPL$,
  difficulty = 'medium'
WHERE id = 2132;
...
Wrong (C): Reducing retained earnings on the balance sheet for undeclared dividends is not permitted; the impact on retained earnings occurs only upon declaration.$EXPL$,
  difficulty = 'medium'
WHERE id = 2133;
...
Wrong (D): $80,000 represents 4 months of interest, overstating the 3-month period from April 1 to June 30.$EXPL$,
  difficulty = 'medium'
WHERE id = 2135;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (C): Under ASC 505-20-30-6, a 40% stock dividend is a large stock dividend (greater than 20–25%) and is recorded at par value. New shares = 60,000 × 40% = 24,000. Retained earnings debit = 24,000 × $15 par = $360,000. Common stock credit = $360,000. No APIC is recognized for large stock dividends.
...
Wrong (D): Debiting APIC instead of retained earnings is incorrect; stock dividends are always charged to retained earnings.$EXPL$,
  difficulty = 'medium'
WHERE id = 2136;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 505-10-45-2, book value per share equals total equity divided by shares outstanding. Total equity = $1,000,000 + $600,000 + $850,000 − $75,000 − $180,000 = $2,195,000. Shares outstanding = 200,000 − 10,000 treasury = 190,000. Book value per share = $2,195,000 ÷ 190,000 = $11.55.
...
Wrong (D): $12.75 may result from dividing total equity by issued shares (200,000) rather than outstanding shares (190,000) or from other computational errors.$EXPL$,
  difficulty = 'medium'
WHERE id = 2137;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$Drake Corp. is a defendant in a lawsuit. Legal counsel advises that the loss is probable and estimates the range of loss to be between $200,000 and $500,000, with no amount in that range more likely than any other. What amount should Drake accrue as a loss contingency?$EXPL$,
  choices = $EXPL$["No accrual is required until the case is settled","The minimum of the range, $200,000","The midpoint of the range, $350,000","The maximum of the range, $500,000"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (B): Under ASC 450-20-30-1, when a range of loss is probable and no amount within the range is a better estimate than any other, the entity must accrue the minimum amount in the range. Drake should accrue $200,000 and disclose the exposure up to $500,000.
...
Wrong (D): The maximum ($500,000) overstates the accrual; ASC 450-20-30-1 requires the minimum, not the maximum, when no single amount is more likely.$EXPL$,
  difficulty = 'medium'
WHERE id = 2139;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 450-20-30-1, when a specific amount within a range of probable loss is a better estimate than any other, that amount should be accrued. The $150,000 best estimate takes precedence over the minimum-of-the-range rule, which applies only when no amount in the range is more likely.
...
Wrong (D): $135,000 (an average or arbitrary midpoint) is not prescribed by ASC 450-20 as a measurement approach for loss contingencies.$EXPL$,
  difficulty = 'medium'
WHERE id = 2144;
...
-- Issues: unstructured, no_contrast, choice_cuing
UPDATE questions SET
  stem = $EXPL$On December 15, Year 1, a company identified environmental contamination at one of its sites. By December 31, Year 1, the company determined that remediation is probable and estimated the cost at $800,000. The financial statements are issued on March 15, Year 2. What amount should be accrued at December 31, Year 1?$EXPL$,
  choices = $EXPL$["No accrual because remediation work has not yet commenced","A partial accrual of $400,000 reflecting estimated Year 1 costs","The full $800,000 estimated remediation cost","Note disclosure only with no balance sheet accrual"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (C): Under ASC 450-20-25-2, a loss contingency is accrued when it is probable and the amount is reasonably estimable as of the balance sheet date. Both conditions are met by December 31, Year 1, so the full $800,000 must be accrued regardless of whether remediation work has begun.
...
Wrong (D): Note disclosure alone is appropriate only when a loss is reasonably possible, not when it is probable and reasonably estimable.$EXPL$,
  difficulty = 'medium'
WHERE id = 2146;
...
Wrong (D): $450,000 incorrectly adds the deductible to the self-insured claims, double-counting the company's exposure.$EXPL$,
  difficulty = 'hard'
WHERE id = 2150;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (B): Under ASC 460-10-25-1, assurance-type warranties are accounted for as loss contingencies. Warranty expense accrual = $5,000,000 × 3% = $150,000. Actual claims paid reduce the warranty liability by $40,000. Ending warranty liability = $150,000 − $40,000 = $110,000.
...
Wrong (D): $190,000 incorrectly adds the claims paid to the accrual instead of subtracting them.$EXPL$,
  difficulty = 'easy'
WHERE id = 2155;
...
UPDATE questions SET
  stem = $EXPL$Which of the following represents a key difference between a loss contingency under ASC 450 and a provision under IAS 37?$EXPL$,
  choices = $EXPL$["IAS 37 uses a lower recognition threshold of 'more likely than not' (>50%), while ASC 450 uses 'probable' (~75–80%)","IAS 37 requires discounting provisions to present value when the time value of money is material, while ASC 450 generally prohibits discounting","ASC 450 requires disclosure of remote contingencies, while IAS 37 does not","There are no meaningful differences between the two standards"]$EXPL$::jsonb,
  explanation = $EXPL$Correct (A): Under IAS 37.23, provisions are recognized when the outflow is "more likely than not" (greater than 50%), whereas ASC 450-20-25-1 uses "probable," generally interpreted as a 75–80% likelihood threshold. This lower IAS 37 threshold results in more frequent recognition of provisions compared to U.S. GAAP loss contingencies.
...
Wrong (D): Significant differences exist between the two standards, including recognition thresholds and measurement approaches.$EXPL$,
  correct_index = 0,
  difficulty = 'hard'
WHERE id = 2157;
...
Wrong (C): $425,000 (a midpoint or average) is not prescribed by ASC 450-20 as a measurement approach for loss contingencies.$EXPL$,
  difficulty = 'easy'
WHERE id = 2158;
...
-- Issues: unstructured, no_citation, no_contrast
UPDATE questions SET
  explanation = $EXPL$Correct (A): Under ASC 740-10-25-20, a deferred tax liability arises from temporary differences that will result in taxable amounts in future periods—meaning the entity will pay more tax in the future when the temporary difference reverses.
...
Wrong (D): A net operating loss carryforward creates a deferred tax asset, not a deferred tax liability, because it provides future tax benefit.$EXPL$,
  difficulty = 'easy'
WHERE id = 2160;
