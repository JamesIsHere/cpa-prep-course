...
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB Statement No. 33, paragraph 16, property tax revenue in governmental funds must be both measurable and available — collected within the period or soon enough thereafter (typically 60 days) to pay current liabilities. The general fund recognizes $11.2M collected plus $500,000 expected within 60 days = $11.7M. The $300,000 expected in March is reported as deferred inflows of resources. In the government-wide statements, GASB 34 requires full accrual, so the entire $12M levy is recognized when the enforceable legal claim arises.
...
Wrong (D): GASB explicitly requires different measurement focuses at the fund level (current financial resources/modified accrual) and government-wide level (economic resources/full accrual), so the amounts differ.$19$,
  difficulty = 'medium'
WHERE id = 178;
...
Wrong (D): While the general fund can report many activities, special revenue, debt service, and permanent funds exist precisely because certain restrictions require separate accountability.$19$,
  difficulty = 'medium'
WHERE id = 179;
...
Wrong (D): Bond proceeds go to the capital projects fund for construction purposes; the debt service fund handles subsequent principal and interest payments, not the initial receipt of construction financing.$19$,
  difficulty = 'medium'
WHERE id = 180;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 958-605-25-5A, unconditional promises to give are recognized as revenue when made, measured at present value of expected cash flows. Pledge A''s two-year payment term creates a time restriction, classifying it as net assets with donor restrictions. Under ASC 958-605-25-11, conditional promises with a barrier (such as a matching requirement) are not recognized until the barrier is substantially met. Pledge B''s 40% progress ($400,000 of $1 million) does not constitute substantial performance.
...
Wrong (D): A multi-year payment schedule creates a time restriction but does not preclude recognition — the pledge is recognized at present value and reported in net assets with donor restrictions.$19$,
  difficulty = 'medium'
WHERE id = 182;
...
Wrong (D): A single line item without the dual classification does not comply with ASU 2016-14''s requirement for transparent expense reporting.$19$,
  difficulty = 'easy'
WHERE id = 184;
...
Wrong (D): Under ASC 810, a controlled subsidiary''s results are fully consolidated regardless of ownership percentage; less-than-wholly-owned status affects only the NCI allocation.$19$,
  difficulty = 'medium'
WHERE id = 185;
...
Wrong (C): Recording at historical book value does not comply with ASC 805, which requires fair value measurement of all identifiable assets and liabilities on the acquisition date.$19$,
  difficulty = 'easy'
WHERE id = 186;
...
Wrong (D): The receivables decrease is a standard cash flow reconciling item, not a qualitative trend disclosure — it reflects cash collection exceeding revenue recognition.$19$,
  difficulty = 'medium'
WHERE id = 188;
...
Wrong (D): The gain must be subtracted, not added, because it is already included in net income and the full proceeds are reported in investing activities.$19$,
  difficulty = 'medium'
WHERE id = 189;
...
Wrong (D): ASC 740 requires assessment of the valuation allowance at each reporting date, not deferral until the NOL actually expires unused.$19$,
  difficulty = 'easy'
WHERE id = 190;
...
Wrong (D): Book value is not netted against cash paid — each component is reported separately, with cash flows on the statement and noncash exchanges in supplemental disclosures.$19$,
  difficulty = 'hard'
WHERE id = 191;
...
Wrong (C): The peer company''s accrual of the range minimum reflects the absence of a best estimate, not lower confidence in the range — the range itself is established as the probable loss.$19$,
  difficulty = 'medium'
WHERE id = 192;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 450-20-50-3 through 50-5, when a loss contingency is reasonably possible (but not probable), no accrual is required. However, disclosure of the nature of the contingency and an estimate of the possible loss or range of loss must be provided in the notes to the financial statements. The $200,000–$500,000 range should be disclosed.
...
Wrong (D): When a loss is reasonably possible, disclosure is required — omitting both disclosure and accrual would violate ASC 450-20-50.$19$,
  difficulty = 'medium'
WHERE id = 193;
...
Wrong (D): Under ASC 260, cumulative preferred dividends are deducted from net income regardless of whether they have been declared, because cumulative dividends represent a claim that accumulates whether or not declared.$19$,
  difficulty = 'medium'
WHERE id = 194;
...
Wrong (D): Both the exercise price and the market price are essential inputs to the treasury stock method — the market price determines how many shares can be repurchased with the option proceeds.$19$,
  difficulty = 'hard'
WHERE id = 195;
...
Wrong (D): Public market prices may be more volatile day-to-day, but Level 1 measurements are objectively verifiable, making them lower audit risk than Level 3 estimates that rely on management assumptions.$19$,
  difficulty = 'medium'
WHERE id = 196;
...
Wrong (C): While the income approach is one of three permissible valuation techniques, ASC 820 does not mandate any single approach — the selection depends on which technique best estimates exit price from a market participant''s viewpoint.$19$,
  difficulty = 'hard'
WHERE id = 197;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 105-10-05-1, the FASB Accounting Standards Codification (ASC) is the single source of authoritative U.S. GAAP for nongovernmental entities. It superseded all previously issued standards, interpretations, and technical bulletins by consolidating them into one framework.
...
Wrong (D): SEC Staff Accounting Bulletins are authoritative only for SEC registrants and sit alongside, not above, the Codification in the GAAP hierarchy.$19$,
  difficulty = 'easy'
WHERE id = 370;
...
Wrong (D): Lower-margin items do not have more predictable cost structures, and the product mix shift weakens (not strengthens) the historical rate assumption.$19$,
  difficulty = 'medium'
WHERE id = 390;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 330-10-30-10 (conventional retail method), the cost-to-retail ratio excludes net markdowns from the denominator. Without markdowns: ratio = $840,000 ÷ $1,260,000 = 66.7%. With markdowns: ratio = $840,000 ÷ ($1,260,000 − $60,000) = 70.0%. Ending inventory at retail = $1,200,000 − $980,000 = $220,000. At 66.7%: $146,740; at 70.0%: $154,000. The lower ratio produces a more conservative estimate approximating lower of cost or market, because markdowns signal NRV has declined below original retail.
...
Wrong (D): The conventional retail method specifically excludes markdowns by design to approximate LCM — including all markdowns would produce the average cost retail method instead.$19$,
  difficulty = 'hard'
WHERE id = 391;
...
Wrong (D): Only the loss portion ($120,000) is accrued, not the entire commitment amount — the full contract price is not recorded as a liability.$19$,
  difficulty = 'medium'
WHERE id = 392;
...
Wrong (D): GAAP and IFRS have not converged on development cost capitalization — ASC 730 prohibits it while IAS 38 permits it under specified conditions.$19$,
  difficulty = 'medium'
WHERE id = 409;
...
-- Issues: choice_cuing
UPDATE questions SET
  stem = $19$Cascade Software is developing a new enterprise application for external sale. Conceptual design cost $200,000, detailed design through working model completion cost $450,000, and coding and testing after the working model cost $350,000. Under ASC 985-20, how does the technological feasibility milestone affect the amounts capitalized versus expensed?$19$,
  choices = $19$["All $1,000,000 is expensed because software development costs are always treated as R&D","Only Phase 1 ($200,000) is expensed and Phases 2–3 ($800,000) are capitalized","The $650,000 spent before the working model is expensed and the $350,000 after feasibility is capitalized","All $1,000,000 is capitalized because the intent to sell triggers capitalization from project start"]$19$::jsonb,
  explanation = $19$Correct (C): Under ASC 985-20-25-1 through 25-2, costs incurred before technological feasibility is established are expensed as R&D. Technological feasibility is established upon completion of a detailed program design or a working model. Phases 1–2 ($650,000) predate the working model and are expensed. Phase 3 ($350,000) follows feasibility and is capitalized, then amortized using the greater of straight-line or revenue-proportion method. The feasibility milestone is a management judgment call, which can reduce cross-company comparability.
...
Wrong (D): Intent to sell does not trigger capitalization — the technological feasibility milestone, not the business purpose, determines when capitalization begins.$19$,
  difficulty = 'medium'
WHERE id = 410;
...
Wrong (D): Only the application development stage qualifies for capitalization — costs during the preliminary and post-implementation stages are expensed.$19$,
  difficulty = 'easy'
WHERE id = 411;
...
Wrong (C): The standards apply different capitalization thresholds — ASC 985-20 uses technological feasibility while ASC 350-40 uses the application development stage, producing different timing for capitalization.$19$,
  difficulty = 'medium'
WHERE id = 415;
...
Wrong (D): ASC 842 eliminated leveraged lease classification for new leases entered into after the effective date; existing leveraged leases were grandfathered.$19$,
  difficulty = 'easy'
WHERE id = 419;
...
Wrong (D): Related-party leases are not exempt from ASC 842 recognition requirements — they follow the same classification and measurement rules as third-party leases.$19$,
  difficulty = 'easy'
WHERE id = 423;
...
Wrong (D): Convertible instruments still affect EPS calculations under ASC 260 — ASU 2020-06 actually eliminated the treasury stock method for convertible instruments and requires the if-converted method.$19$,
  difficulty = 'easy'
WHERE id = 428;
...
Wrong (C): Amortized cost remains available as the default measurement for debt instruments where the fair value option is not elected — the option supplements, not replaces, amortized cost accounting.$19$,
  difficulty = 'easy'
WHERE id = 429;
...
Wrong (D): Ongoing mark-to-market adjustments between exercise price and market price apply to liability-classified awards, not to typical equity-classified employee stock options.$19$,
  difficulty = 'easy'
WHERE id = 437;
...
Wrong (D): Compensation cost is recognized ratably over the service period as the condition becomes probable, not solely on the single date the performance condition is ultimately achieved.$19$,
  difficulty = 'easy'
WHERE id = 439;
...
Wrong (C): Equity-classified awards with market conditions are not remeasured after the grant date — the market condition is priced into the initial fair value measurement and fixed at that point.$19$,
  difficulty = 'easy'
WHERE id = 440;
...
Wrong (D): There are meaningful accounting and legal differences — restricted stock creates an immediate shareholder, while RSUs do not, affecting dividend treatment, voting rights, and Section 83(b) election availability.$19$,
  difficulty = 'medium'
WHERE id = 441;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB Statement No. 34, paragraphs 15–16, government-wide financial statements use the economic resources measurement focus and full accrual basis of accounting. Revenues are recognized when earned and expenses when incurred, regardless of when cash is received or paid.
...
Wrong (C): Budgetary basis is used for budgetary comparison schedules (required supplementary information), not for the government-wide financial statements.$19$,
  difficulty = 'easy'
WHERE id = 457;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB Statement No. 68, paragraph 13, the net pension liability is defined as the total pension liability (the actuarial present value of projected benefit payments attributed to past service) minus the pension plan''s fiduciary net position (plan assets available to pay benefits). This net amount is reported on the employer''s statement of net position.
...
Wrong (D): GASB 68 replaced the unfunded actuarial accrued liability concept with the net pension liability framework, using a different calculation methodology including a blended discount rate.$19$,
  difficulty = 'easy'
WHERE id = 458;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB Statement No. 75, paragraph 22, the total OPEB liability must be measured using the entry age normal cost method as the sole permissible actuarial cost method. This method spreads the actuarial present value of projected benefits as a level percentage of pay over each employee''s career from entry age to assumed exit age, ensuring comparability across government employers.
...
Wrong (D): The aggregate cost method is not permitted under GASB 75 — the entry age normal method is the only allowable approach for measuring the total OPEB liability.$19$,
  difficulty = 'hard'
WHERE id = 459;
...
Wrong (D): The donor''s written statement of fair value is not the recognition criterion — the nature and type of services determine whether recognition is appropriate.$19$,
  difficulty = 'easy'
WHERE id = 468;
...
Wrong (C): Restricted contributions increase the with-restrictions net asset category, not the without-restrictions category — they are reclassified only when the restriction is satisfied.$19$,
  difficulty = 'easy'
WHERE id = 469;
...
Wrong (D): ASC 230 measures from the entity''s purchase date, not remaining maturity at the balance sheet date — a 120-day CD purchased on day one does not become a cash equivalent simply because fewer than 90 days remain at year-end.$19$,
  difficulty = 'medium'
WHERE id = 1096;
...
Wrong (D): The origin of the item (external party) does not make all items bank-side adjustments — the NSF check and note collection originated externally but require entries on the company''s books.$19$,
  difficulty = 'medium'
WHERE id = 1097;
...
-- Issues: choice_cuing
UPDATE questions SET
  stem = $19$Waverly Financial adopted the CECL model under ASC 326 for its $50 million commercial loan portfolio. Under the old incurred loss model, the allowance was $800,000. After adopting CECL, the day-one allowance increased to $2.1 million based on lifetime expected losses. How does CECL affect the timing of loss recognition and reported equity upon transition?$19$,
  choices = $19$["No effect on the allowance because no actual losses have occurred","The $1.3 million increase reduces retained earnings through a cumulative-effect adjustment at adoption","The $1.3 million increase is recognized as income statement expense in the adoption year","CECL reduces the allowance because forward-looking forecasts predict lower losses"]$19$::jsonb,
  explanation = $19$Correct (B): Under ASC 326-10-65-1, the transition from the incurred loss model to CECL is recorded as a cumulative-effect adjustment to retained earnings on the adoption date. The $1.3 million increase ($2.1M − $0.8M) reduces retained earnings directly, not through the income statement. CECL recognizes lifetime expected credit losses at origination using forward-looking information, eliminating the requirement for a triggering loss event.
...
Wrong (D): CECL''s inclusion of current conditions and forward-looking forecasts typically increases allowances relative to the incurred loss model, particularly for portfolios with credit risk.$19$,
  difficulty = 'easy'
WHERE id = 1098;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 326-20-30-1, the current expected credit losses (CECL) model requires the allowance for credit losses to be measured based on expected lifetime credit losses on financial assets. The estimate must incorporate historical loss experience, current conditions, and reasonable and supportable forecasts of future economic conditions.
...
Wrong (D): CECL measures expected losses on a pool or collective basis using forward-looking information, rather than waiting for specific individual accounts to be identified as uncollectible.$19$,
  difficulty = 'easy'
WHERE id = 1100;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (B): Under ASC 860-20-25-1 through 25-3, when a transfer of receivables with recourse qualifies as a sale, the transferor derecognizes the receivables and recognizes a loss equal to the factoring fee plus the fair value of the recourse obligation. Factoring fee: $250,000 × 3% = $7,500. Recourse obligation fair value: $6,000. Total loss: $7,500 + $6,000 = $13,500. The holdback of $25,000 ($250,000 × 10%) is recorded as a receivable from the factor and is not a loss component — it is returned after the receivables are collected.
...
Wrong (D): The $6,000 is only the recourse obligation component and ignores the $7,500 factoring fee — both must be included in the total loss.$19$,
  difficulty = 'hard'
WHERE id = 1104;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 326-20-30-4, when using the discounted cash flow method under CECL, the allowance for credit losses equals the difference between the amortized cost basis and the present value of expected cash flows discounted at the financial asset''s effective interest rate: $1,000,000 − $940,000 = $60,000. This difference represents the expected credit losses over the remaining life of the portfolio.
...
Wrong (D): A positive present value of expected cash flows does not eliminate the need for an allowance — the $60,000 gap between amortized cost and expected cash flows represents credit losses that must be reserved.$19$,
  difficulty = 'hard'
WHERE id = 1105;
...
Wrong (D): Non-service pension components are expensed below the operating line, not capitalized as an asset — capitalizing pension cost has no basis under ASC 715.$19$,
  difficulty = 'medium'
WHERE id = 1106;
...
Wrong (D): Employer contributions relate to plan funding decisions, not the obligation measurement — the PBO is an actuarial liability calculation independent of how much the employer has contributed.$19$,
  difficulty = 'easy'
WHERE id = 1109;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under ASC 715-30-35-24, the corridor approach requires amortization of net actuarial gains or losses only when the cumulative unrecognized amount exceeds a corridor equal to 10% of the greater of the PBO or the market-related value of plan assets. The excess beyond the corridor is amortized over the average remaining service period of active employees expected to receive benefits.
...
Wrong (D): The amortization period is based on the average remaining service period of active employees, not a fixed 20-year period — the service period varies by plan demographics.$19$,
  difficulty = 'easy'
WHERE id = 1110;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $19$Correct (A): Under ASC 715-30-35-4, net periodic pension cost is calculated as: service cost + interest cost − expected return on plan assets + amortization of prior service cost + amortization of net actuarial loss. Calculation: $200,000 + $150,000 − $180,000 + $15,000 + $8,000 = $193,000. The expected return is subtracted because it represents anticipated plan asset earnings that offset the cost of the pension obligation.
...
Wrong (D): The $373,000 likely results from an arithmetic error in combining the five components — the correct sum is $193,000.$19$,
  difficulty = 'hard'
WHERE id = 1113;
...
Wrong (C): The tax basis is a distinct SPF category under AU-C 800, separate from the regulatory basis — regulatory basis refers to frameworks prescribed by government regulatory bodies other than tax authorities.$19$,
  difficulty = 'medium'
WHERE id = 1116;
...
Wrong (C): SPF financial statements should include informative disclosures describing the basis of accounting and significant accounting policies — omitting all notes would deprive users of essential context.$19$,
  difficulty = 'easy'
WHERE id = 1118;
