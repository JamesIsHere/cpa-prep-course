...
UPDATE questions SET
  explanation = $$Correct (D): Under ASC 450-20-25-2, a loss contingency is accrued when two conditions are met: (1) it is probable that a liability has been incurred, and (2) the amount of the loss can be reasonably estimated. Both conditions must be satisfied before recognition is appropriate.
...
Wrong (C): The mere filing of a lawsuit does not establish probability; management must assess the likelihood of an unfavorable outcome independently of the legal action itself.$$,
  difficulty = 'easy'
WHERE id = 1136;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (A): Under ASC 450-20-30-1, when the estimated loss falls within a range and no single amount within the range is a better estimate than any other, the minimum amount of the range is accrued. If a specific amount is the best estimate, that amount is accrued instead.
...
Wrong (D): ASC 450 requires accrual even when only a range is available, provided both probability and estimability conditions are met.$$,
  difficulty = 'easy'
WHERE id = 1137;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (B): Under ASC 855-10-25-1, recognized (Type I) subsequent events provide additional evidence about conditions that existed at the balance sheet date and may require adjustment to the financial statements, including accrual of a loss contingency such as a pending lawsuit settled after year-end.
...
Wrong (D): Subsequent events are addressed in the financial statements or notes by the entity, not solely in the auditor''s report.$$,
  difficulty = 'easy'
WHERE id = 1139;
...
Wrong (D): Inventory is written down to NRV when carrying value exceeds recoverable amount under ASC 330-10-35-1, regardless of whether it has been sold.$$,
  difficulty = 'medium'
WHERE id = 1140;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (D): Under ASC 320-10-35-1, trading securities are measured at fair value at each reporting date, with unrealized holding gains and losses included in earnings (net income) for the period.
...
Wrong (C): Trading securities require ongoing fair value measurement at each reporting date; holding at original cost without adjustment would fail to reflect current market conditions.$$,
  difficulty = 'easy'
WHERE id = 1151;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (A): Under ASC 820-10-35-34, the cost approach reflects the amount that would be required currently to replace the service capacity of an asset (current replacement cost), adjusted for physical deterioration, functional obsolescence, and economic obsolescence.
...
Wrong (D): Net book value (historical cost less accumulated depreciation) is a historical cost concept, not the current replacement cost contemplated by the cost approach under ASC 820.$$,
  difficulty = 'easy'
WHERE id = 1152;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under ASC 820-10-15-1A, share-based payment transactions measured under ASC 718 are explicitly excluded from the scope of ASC 820. While ASC 718 uses fair value concepts, it has its own measurement framework for stock compensation.
...
Wrong (D): Nonfinancial assets acquired in a business combination are measured at fair value under ASC 805, which references ASC 820 for the measurement methodology.$$,
  difficulty = 'medium'
WHERE id = 1281;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (C): Under ASC 230-10-45-28, the indirect method begins with net income and adjusts for (1) non-cash items such as depreciation and amortization (added back), (2) gains on asset sales (subtracted) and losses (added back), and (3) changes in operating assets and liabilities.
...
Wrong (D): Non-cash charges like depreciation are essential adjustments under the indirect method; ignoring them would fail to reconcile net income to operating cash flow.$$,
  difficulty = 'easy'
WHERE id = 1879;
...
Wrong (D): The direction of each adjustment depends on whether the noncash item understated or overstated operating cash flow relative to net income.$$,
  difficulty = 'medium'
WHERE id = 1889;
...
Wrong (D): The duration options have been outstanding is irrelevant to dilution analysis; the treasury stock method under ASC 260 relies solely on the relationship between exercise price and average market price.$$,
  difficulty = 'easy'
WHERE id = 1909;
...
Wrong (D): $5.00 incorrectly omits the after-tax interest add-back, dividing unadjusted net income by the diluted share count ($300,000 / 60,000).$$,
  difficulty = 'hard'
WHERE id = 1912;
...
-- Issues: no_contrast
UPDATE questions SET
  explanation = $$Correct (C): Under ASC 606-10-25-27(c), revenue is recognized over time when the asset created has no alternative use to the entity and the entity has an enforceable right to payment for performance completed to date. Both criteria are met for this specialized equipment contract.
...
Wrong (D): Revenue cannot be recognized at contract signing because no performance has yet occurred; ASC 606-10-25-1 requires satisfaction of performance obligations before recognition.$$,
  difficulty = 'easy'
WHERE id = 1955;
...
Wrong (D): $3,500,000 is the fair value of the reporting unit, not a measure of impairment loss.$$,
  difficulty = 'hard'
WHERE id = 2022;
...
Wrong (D): Immediate expensing is not appropriate because the value is captured within goodwill as part of the business combination, not charged to expense.$$,
  difficulty = 'hard'
WHERE id = 2029;
...
Wrong (D): $210,618 would result from using an ordinary annuity factor rather than an annuity-due factor, failing to account for the beginning-of-period payment timing.$$,
  difficulty = 'medium'
WHERE id = 2047;
...
Wrong (D): Leases shorter than 12 months may qualify for the short-term lease exemption under ASC 842-20-25-2, which eliminates the need for present value measurement entirely.$$,
  difficulty = 'easy'
WHERE id = 2050;
...
-- Issues: choice_cuing
UPDATE questions SET
  stem = $$Westfield Corp. declares a property dividend, distributing investment securities with a carrying amount of $200,000 and a fair value of $280,000. What is the net effect on retained earnings?$$,
  choices = $$["Decrease of $200,000","Decrease of $280,000","Increase of $80,000","No effect on retained earnings"]$$::jsonb,
  explanation = $$Correct (A): Under ASC 845-10-30-1, a property dividend is recorded at fair value. The investment is first revalued: Dr Investment $80,000, Cr Gain $80,000 (recognized in net income, flowing to retained earnings). Then the dividend is declared at fair value: Dr Retained Earnings $280,000, Cr Dividends Payable $280,000. The net effect is a $200,000 decrease (−$280,000 + $80,000 gain).
...
Wrong (D): Property dividends reduce retained earnings by the fair value of assets distributed, net of any gain on revaluation; they cannot leave retained earnings unaffected.$$,
  difficulty = 'hard'
WHERE id = 2134;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (C): Under ASC 450-20-25-2, a loss contingency is accrued when two conditions are both met: the loss is probable (likely to occur) and the amount can be reasonably estimated. Both criteria must be satisfied for recognition as a liability.
...
Wrong (D): Even if a loss is probable, accrual is not appropriate unless the amount can also be reasonably estimated; without estimability, disclosure is required instead under ASC 450-20-50-1.$$,
  difficulty = 'easy'
WHERE id = 2138;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (D): Under ASC 450-20-50-3, when a loss contingency is reasonably possible (more than remote but less than probable), accrual is not required. However, the nature of the contingency and the estimated amount ($300,000) must be disclosed in the notes to inform financial statement users.
...
Wrong (C): Reasonably possible losses require note disclosure under ASC 450-20-50-3; only remote losses may be omitted from disclosure entirely.$$,
  difficulty = 'easy'
WHERE id = 2140;
...
Wrong (D): Sufficient information exists for a reasonable estimate, including the EPA allocation, total cost estimate, and identification of insolvent co-PRPs.$$,
  difficulty = 'medium'
WHERE id = 2152;
...
Wrong (D): ASC 958-605-25-16 permits recognition of certain volunteer services when they meet either the specialized skills criterion or the asset enhancement criterion.$$,
  difficulty = 'hard'
WHERE id = 2275;
...
Wrong (D): ASC 958-210 does not require departmental breakdowns of unrestricted net assets; the disclosure focuses on board-designated versus undesignated amounts within net assets without donor restrictions.$$,
  difficulty = 'easy'
WHERE id = 2294;
...
Wrong (D): $1,500,000 incorrectly nets the matching funds against the grant; the match is the university''s own expenditure, not a reduction of the grant amount.$$,
  difficulty = 'hard'
WHERE id = 2295;
...
Wrong (C): Capital projects funds are used for capital acquisition and construction activities, not for operating grants restricted for public safety programs.$$,
  difficulty = 'medium'
WHERE id = 2303;
...
Wrong (D): PBO and ABO are distinct measures with different computational inputs; ASC 715-30-20 defines them separately with the salary growth assumption as the key differentiator.$$,
  difficulty = 'easy'
WHERE id = 2335;
...
-- Issues: choice_cuing
UPDATE questions SET
  stem = $$A company settles a portion of its defined benefit pension obligation by purchasing annuity contracts from an insurance company for $3,200,000. The PBO settled is $3,000,000 and the fair value of plan assets allocated to the settlement is $2,800,000. Under ASC 715, what is the settlement gain or loss?$$,
  choices = $$["$200,000 settlement loss","No settlement gain or loss","$200,000 settlement gain","$400,000 settlement loss"]$$::jsonb,
  explanation = $$Correct (A): Under ASC 715-30-35-80, the settlement gain or loss measures the difference between the PBO eliminated and the cost to settle it. The company pays $3,200,000 to extinguish $3,000,000 of PBO, resulting in a $200,000 settlement loss because the insurer charges a premium above the actuarial obligation.
...
Wrong (D): $400,000 incorrectly uses the difference between the annuity purchase price ($3,200,000) and plan assets allocated ($2,800,000), which measures the cash outlay beyond plan assets, not the economic settlement gain or loss on the obligation.$$,
  difficulty = 'hard'
WHERE id = 2336;
...
Wrong (C): Disclosure is required regardless of which presentation approach is chosen; reporting $200,000 without any disclosure of the nondeductible portion would be insufficient under tax-basis reporting standards.$$,
  difficulty = 'hard'
WHERE id = 2365;
...
Wrong (D): Using undiscounted totals violates GASB 96''s requirement to measure the subscription liability at the present value of future payments.$$,
  difficulty = 'medium'
WHERE id = 5246;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (C): Under GASB Statement No. 34, paragraph 112, interfund loans are reported as receivables ("due from other funds") in the lending fund and payables ("due to other funds") in the borrowing fund when repayment is expected within a reasonable time. The general fund reports a $750,000 receivable because the loan is temporary with expected repayment within six months.
...
Wrong (D): Interfund loans are not investments; they are reported as due from/due to other funds under GASB 34.$$,
  difficulty = 'medium'
WHERE id = 5247;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (C): Under GASB Concepts Statement No. 4, a deferred outflow of resources is defined as a consumption of net assets by the government that is applicable to a future reporting period. Common examples include deferred amounts on debt refundings and certain pension-related items under GASB 68.
...
Wrong (D): A reduction in liabilities from current operations describes a component of revenue or gain recognition, not the definition of a deferred outflow of resources.$$,
  difficulty = 'easy'
WHERE id = 5250;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (A): Under GASB Statement No. 54, paragraph 30, a special revenue fund accounts for and reports specific revenue sources that are restricted or committed to expenditure for purposes other than debt service or capital projects. The fund must have a substantial committed or restricted revenue source as its foundation.
...
Wrong (D): Revenue designated by the governing body for general operations does not meet the restricted or committed standard required for special revenue funds; general operations belong in the General Fund.$$,
  difficulty = 'easy'
WHERE id = 5251;
...
Wrong (D): Estimate changes flow through current and future income, not bypassing retained earnings; they simply are not applied retroactively to prior periods.$$,
  difficulty = 'medium'
WHERE id = 5253;
...
Wrong (D): GASB does not defer interest costs as a deferred outflow; interest is expensed in the period incurred under GASB 89.$$,
  difficulty = 'medium'
WHERE id = 5255;
...
Wrong (D): The transfer affects both columns; reporting it solely in governmental activities would misstate the business-type activities'' change in net position.$$,
  difficulty = 'medium'
WHERE id = 5256;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (C): Under GASB Statement No. 34, the budgetary comparison schedule reports the variance between final budgeted and actual amounts. The revenue variance is $18,750,000 actual minus $18,500,000 budgeted = $250,000 favorable, because actual collections exceeded the estimate.
...
Wrong (D): $800,000 represents the difference between actual revenues and actual expenditures ($18,750,000 − $17,950,000), which is the actual surplus, not the budgeted-to-actual revenue variance.$$,
  difficulty = 'medium'
WHERE id = 5259;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (A): Under GASB Statement No. 54, fund balance is classified as restricted when constraints are imposed by external parties such as creditors, grantors, or laws. General obligation bond covenants and enabling legislation legally restrict the use of proceeds to library construction, making the $2.8 million restricted fund balance.
...
Wrong (D): Unassigned fund balance is the residual classification for amounts not constrained for any purpose; bond proceeds legally restricted to construction cannot be unassigned.$$,
  difficulty = 'medium'
WHERE id = 5262;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under GASB Statement No. 33, paragraph 13, fines and penalties are classified as imposed nonexchange revenues. These are assessments by governments on nongovernmental entities — including property taxes, fines, and forfeitures — that are not derived from underlying exchange transactions.
...
Wrong (D): Voluntary nonexchange transactions arise from willing agreements between parties (such as donations or voluntary grants), not from compulsory penalties imposed by governmental authority.$$,
  difficulty = 'easy'
WHERE id = 5267;
...
Wrong (D): Private-purpose trust funds under GASB 84 are for trust arrangements benefiting individuals or private organizations; TIF districts serve a public purpose (infrastructure improvement) even though private property owners benefit incidentally.$$,
  difficulty = 'hard'
WHERE id = 5269;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under GASB Statement No. 34, paragraphs 23-25, the modified approach requires governments to maintain eligible infrastructure at or above an established condition level with assessments at least every three years. When conditions deteriorate and preservation spending is inadequate, the government must evaluate whether it can continue meeting the modified approach requirements or must switch to depreciation-based reporting.
...
Wrong (D): GASB 34 does not permit splitting the reporting approach for a single infrastructure network; the modified approach applies to the entire eligible asset class or not at all.$$,
  difficulty = 'hard'
WHERE id = 5271;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (A): Under GASB Statement No. 84, paragraph 11, a private-purpose trust fund reports trust arrangements where both the principal and income benefit individuals, private organizations, or other governments. Examples include escheat property and scholarship trusts for private beneficiaries.
...
Wrong (D): Taxes and fees collected on behalf of another government pending distribution are reported in a custodial fund under GASB 84, which replaced the former agency fund classification.$$,
  difficulty = 'easy'
WHERE id = 5274;
...
Wrong (C): Management''s expressed intention without formal action describes assigned fund balance under GASB 54, which requires only management''s intent rather than the governing body''s formal action.$$,
  difficulty = 'easy'
WHERE id = 5275;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (C): Under GASB Statement No. 34, interfund advances are reported as receivables ("advance to other funds") in the lending fund and payables ("advance from other funds") in the borrowing fund because repayment is expected. This differs from transfers, which are permanent shifts of resources.
...
Wrong (D): A deferred outflow of resources under GASB Concepts Statement No. 4 relates to consumption of net assets applicable to future periods, not interfund lending arrangements.$$,
  difficulty = 'easy'
WHERE id = 5336;
...
Wrong (C): While the General Fund is always reported as major, GASB 34 requires any other fund meeting the quantitative criteria also to be reported as a major fund.$$,
  difficulty = 'medium'
WHERE id = 5338;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under GASB 87, leases are recognized as intangible right-to-use assets and lease liabilities in government-wide statements, with amortization and interest expense reported annually. However, governmental fund statements use the current financial resources measurement focus and modified accrual basis, so only the current-year lease payment ($36,000) is reported as an expenditure.
...
Wrong (D): Governmental fund statements do not report long-term lease payables because long-term liabilities are excluded from the current financial resources measurement focus.$$,
  difficulty = 'medium'
WHERE id = 5339;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (D): Under GASB Statement No. 34, paragraph 8, management''s discussion and analysis is required supplementary information (RSI) that precedes the basic financial statements. MD&A provides an analytical overview of the government''s financial activities in a narrative format.
...
Wrong (C): MD&A is required, not optional; GASB 34 mandates its inclusion as RSI in the comprehensive annual financial report.$$,
  difficulty = 'easy'
WHERE id = 5341;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under GASB 77, paragraphs 5-7, governments must disclose tax abatement agreements in the notes, including the gross dollar amount of taxes abated during the period. The standard focuses on disclosure because the reduced tax amount is typically already reflected in the levy. The revenue reduction is often built into the tax assessment rather than being a separate adjustment.
...
Wrong (D): A long-term liability for future abated taxes is not recognized under GASB 77; each year''s abatement is addressed through the annual levy and disclosure process.$$,
  difficulty = 'medium'
WHERE id = 5343;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (D): Under GASB Statement No. 33, paragraph 7, the four classes of nonexchange transactions are: (1) derived tax revenues, (2) imposed nonexchange revenues, (3) government-mandated nonexchange transactions, and (4) voluntary nonexchange transactions.
...
Wrong (C): Intergovernmental service transactions involve exchange-like arrangements between governments and are not among the four nonexchange categories defined in GASB 33.$$,
  difficulty = 'easy'
WHERE id = 5345;
...
Wrong (D): Investing activities include interest received on investments and loans, not interest paid on borrowings for capital purposes.$$,
  difficulty = 'medium'
WHERE id = 5346;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (B): Under GASB 87, both a lease liability and a right-to-use asset of $22,380,000 are recognized at commencement. Adding equal amounts to a ratio below 100% always increases it: the new ratio is ($38M + $22.38M) / ($95M + $22.38M) = $60.38M / $117.38M = 51.4%, compared to the original $38M / $95M = 40.0%.
...
Wrong (D): At initial recognition under GASB 87, the lease liability and right-to-use asset are equal; first-year amortization occurs in subsequent periods, not at inception.$$,
  difficulty = 'hard'
WHERE id = 5347;
...
-- Issues: unstructured
UPDATE questions SET
  explanation = $$Correct (A): Under GASB Statement No. 34, paragraph 62, internal service fund activities are typically consolidated into governmental activities in the government-wide statements. The $3,600,000 charged to departments is already in governmental activities expenses, but consolidation replaces those charges with the fund''s actual $3,400,000 in costs, eliminating the $200,000 interfund markup and reducing total expenses.
...
Wrong (D): The $3,400,000 in actual costs is already reflected through the consolidation process; adding it separately would misstate the elimination entry.$$,
  difficulty = 'medium'
WHERE id = 5349;
