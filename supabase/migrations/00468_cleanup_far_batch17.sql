...
Wrong (D): A budgetary comparison format shows actual results versus appropriations and is presented as required supplementary information for governmental funds, not as the government-wide statement of activities.$19$,
  difficulty = 'easy'
WHERE id = 5358;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB 87, paragraph 16, a short-term lease is defined as a lease with a maximum possible term of 12 months or fewer, including any options to extend. Since this 10-month lease has no renewal option, the maximum possible term is 10 months, qualifying it for the short-term exception. Payments are recognized as expenses in the periods to which they relate.
...
Wrong (D): Recognizing the full amount as an expenditure at signing does not match the period-by-period expense recognition required for short-term leases under GASB 87.$19$,
  difficulty = 'medium'
WHERE id = 5359;
...
Wrong (D): Enterprise funds are classified as proprietary funds under GASB 34, not governmental funds. They account for activities where fees are charged to external users for goods or services.$19$,
  difficulty = 'easy'
WHERE id = 5361;
...
Wrong (C): Comparing actual expenditures to actual revenues measures the surplus or deficit, not the expenditure variance. The budgetary comparison focuses on compliance with the adopted budget.$19$,
  difficulty = 'medium'
WHERE id = 5363;
...
Wrong (D): Waiting until project completion to recognize revenue is overly conservative and not required by GASB 33. Revenue is recognized as qualifying expenditures are incurred, not deferred until the project is fully complete.$19$,
  difficulty = 'medium'
WHERE id = 5364;
...
Wrong (D): Capitalizing $270,000 with no liability ignores the present value measurement requirement and the obligation to make future payments. GASB 96 requires both an asset and a corresponding liability.$19$,
  difficulty = 'medium'
WHERE id = 5366;
...
Wrong (D): Fiduciary fund presentation applies when a government holds resources in trust or as an agent for external parties. The Building Authority''s resources benefit the city, not external beneficiaries.$19$,
  difficulty = 'hard'
WHERE id = 5367;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB Concepts Statement No. 4, deferred inflows of resources represent acquisitions of net assets by the government that are applicable to a future reporting period. They are reported as a separate section on the statement of net position or balance sheet.
...
Wrong (D): Assets restricted by external creditors are classified as restricted net position or restricted fund balance, not as deferred inflows of resources. Restrictions affect classification within net position, not the deferred inflows category.$19$,
  difficulty = 'easy'
WHERE id = 5368;
...
Wrong (C): Reducing the liability by cumulative contributions has no basis in GASB 68. The net pension liability is the total pension liability minus the plan''s fiduciary net position, not the total pension liability minus the employer''s contributions.$19$,
  difficulty = 'hard'
WHERE id = 5369;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 34, paragraph 58, interfund receivables and payables between funds of the same activity type must be eliminated in the government-wide financial statements. Because both the general fund and the capital projects fund are governmental funds, the $1.5 million interfund balance is eliminated during the conversion to government-wide statements.
...
Wrong (D): The repayment timeline is irrelevant to the government-wide elimination requirement. GASB 34 requires elimination of all interfund balances between funds of the same activity type regardless of the expected repayment period.$19$,
  difficulty = 'medium'
WHERE id = 5371;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB 77, paragraphs 4-7, governments must disclose information about tax abatement agreements, including a brief description of the program, the gross dollar amount of taxes abated during the reporting period, and any commitments made as part of the agreement. GASB 77 requires note disclosure, not recognition as an expenditure or liability.
...
Wrong (D): Reporting the abatement as a reduction to the tax levy with no additional disclosure fails to meet GASB 77''s requirement for note disclosures that describe the program, its purpose, authority, and dollar amounts abated.$19$,
  difficulty = 'medium'
WHERE id = 5376;
...
Wrong (D): Classifying the amount as assigned is incorrect because grants from other governments with legislative mandates create externally imposed constraints, which are the highest level of restriction under GASB 54.$19$,
  difficulty = 'hard'
WHERE id = 5378;
...
Wrong (D): Fiduciary fund reporting applies when a government holds resources in trust or as an agent for external parties. The library''s resources fund its own operations and public services, not a fiduciary arrangement.$19$,
  difficulty = 'hard'
WHERE id = 5379;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB 34, paragraph 130, budgetary comparison schedules for the general fund and each major special revenue fund with a legally adopted annual budget are required supplementary information (RSI). RSI accompanies but is not part of the basic financial statements.
...
Wrong (D): Combining statements for nonmajor funds are supplementary information but are not required by GASB standards. They are optional presentations, unlike RSI which is mandated.$19$,
  difficulty = 'easy'
WHERE id = 5381;
...
Wrong (D): Neither asset is reported at fair value under GASB 34. Infrastructure under the modified approach is reported at historical cost less preservation expenditures, and the road grader is reported at historical cost less accumulated depreciation.$19$,
  difficulty = 'medium'
WHERE id = 5382;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB 72, paragraphs 46-59, the fair value hierarchy consists of three levels: Level 1 (quoted prices in active markets for identical assets), Level 2 (observable inputs other than quoted prices), and Level 3 (unobservable inputs based on the government''s own assumptions).
...
Wrong (C): Market approach, cost approach, and income approach are valuation techniques used to measure fair value, not levels within the hierarchy. The hierarchy classifies the inputs to those techniques by their observability.$19$,
  difficulty = 'easy'
WHERE id = 5383;
...
Wrong (D): The $1.8 million difference between budgetary and GAAP amounts is a basis difference, not a prior period adjustment. Basis differences are reconciled through a note or schedule, not corrected as prior period adjustments.$19$,
  difficulty = 'medium'
WHERE id = 5384;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 33, paragraph 7, government-mandated nonexchange transactions occur when a higher-level government provides resources to a lower-level government and requires it to use those resources for a specific purpose. Federal grants for Medicaid or education are common examples.
...
Wrong (D): A fee charged for services rendered is an exchange or exchange-like transaction, not a nonexchange transaction. Government-mandated transactions involve resource transfers without proportional exchange of value.$19$,
  difficulty = 'easy'
WHERE id = 5385;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 54, paragraph 10, committed fund balance can be established and modified only by the government''s highest level of decision-making authority, which here is the board of trustees. A township manager lacks the authority to modify committed fund balance, so the original $800,000 commitment remains intact at year-end.
...
Wrong (D): The $200,000 reallocated portion was not validly reassigned because the manager lacks authority, and the remaining $600,000 was never released. The full $800,000 remains committed.$19$,
  difficulty = 'medium'
WHERE id = 5388;
...
Wrong (D): A permanent fund requires that the principal be maintained intact with only earnings available for use. An ongoing sales tax is a revenue stream, not an endowment-like principal.$19$,
  difficulty = 'medium'
WHERE id = 5390;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 34, paragraph 70, pension trust funds are fiduciary funds used to report resources held in trust for pension plan members and beneficiaries. These funds account for plan assets, contributions received, investment income, and benefit payments.
...
Wrong (D): The employer''s annual pension contribution expense is recognized on the government-wide financial statements under GASB 68, not within the pension trust fund. The trust fund reports contributions received, not the employer''s expense.$19$,
  difficulty = 'easy'
WHERE id = 5391;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB standards and general bond covenants, when a bond indenture specifies that unused proceeds must be applied to debt retirement, the restriction governs the disposition of surplus funds. The $340,000 must be transferred to the debt service fund to comply with the indenture, as external creditor restrictions take precedence under GASB 54.
...
Wrong (D): Returning funds directly to bondholders as an early principal payment is not the standard procedure. Bond proceeds flow through the debt service fund, which manages scheduled and early debt retirement payments.$19$,
  difficulty = 'medium'
WHERE id = 5393;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB 87, paragraph 16, a short-term lease has a maximum possible term of 12 months or less, including any options to extend. Short-term leases are exempt from the capitalization requirements, and payments are recognized as expenses or expenditures in the period incurred.
...
Wrong (C): A 36-month threshold has no basis in GASB 87. The 12-month cutoff is the only short-term threshold established by the standard.$19$,
  difficulty = 'easy'
WHERE id = 5395;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB Statement No. 34, paragraph 8, MD&A is classified as required supplementary information (RSI) that precedes the basic financial statements. It provides an analytical overview of the government''s financial activities and is required but not part of the basic financial statements themselves.
...
Wrong (D): Notes to the financial statements are an integral part of the basic financial statements and provide essential disclosures. MD&A is separate from the notes and precedes the basic financial statements.$19$,
  difficulty = 'easy'
WHERE id = 5400;
...
Wrong (D): The largest special revenue fund is not automatically major. It must still meet both quantitative thresholds under GASB 34 or be specifically designated by management as a major fund.$19$,
  difficulty = 'easy'
WHERE id = 5402;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB Statement No. 54, paragraph 30, a special revenue fund must have one or more specific revenue sources that form a substantial portion of its inflows. The $2,800,000 state grant at 75% of inflows is a restricted revenue source that satisfies this requirement.
...
Wrong (C): Special revenue funds may account for any restricted or committed revenue source, not just tax revenues. Grants, fees, and other restricted revenues are all qualifying sources under GASB 54.$19$,
  difficulty = 'medium'
WHERE id = 5403;
...
Wrong (D): Recognizing only the unspent balance has no basis in GASB 33. Revenue recognition for voluntary nonexchange transactions is triggered by meeting eligibility requirements, not by the pattern of spending.$19$,
  difficulty = 'medium'
WHERE id = 5408;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB Statement No. 34, paragraph 112, interfund services provided and used are reported as revenues and expenditures in the respective funds because they mirror arm''s-length transactions. The general fund reports the $480,000 billed amount as an expenditure for fleet services.
...
Wrong (D): Recording a $480,000 reduction in fund balance with no expenditure ignores proper accounting treatment. Payments for interfund services must be reported as expenditures in the paying fund.$19$,
  difficulty = 'medium'
WHERE id = 5409;
...
Wrong (C): The $310,000 figure does not correspond to any valid calculation under modified accrual. The correct amount is $295,000 collected plus $30,000 available within 60 days, totaling $325,000.$19$,
  difficulty = 'easy'
WHERE id = 5411;
...
Wrong (D): Nonspendable fund balance applies to amounts not in spendable form (inventories, prepaid items) or legally required to remain intact (permanent fund corpus). Cash set aside by resolution is spendable and does not qualify as nonspendable.$19$,
  difficulty = 'medium'
WHERE id = 5413;
...
Wrong (D): Internal service funds, while classified as proprietary funds, are typically included in the governmental activities column of the government-wide statements because they predominantly serve governmental funds.$19$,
  difficulty = 'easy'
WHERE id = 5414;
...
Wrong (C): GASB 77 requires note disclosure in the financial statements, not merely in the MD&A. Notes are an integral part of the basic financial statements, while MD&A is required supplementary information.$19$,
  difficulty = 'hard'
WHERE id = 5415;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB Statement No. 34 and GASB Codification Section 2200, required supplementary information is data that GASB has determined is essential for placing the basic financial statements in context. RSI accompanies the basic financial statements but is not part of them; examples include MD&A and pension schedules.
...
Wrong (D): Auditors are required to apply certain limited procedures to RSI under auditing standards, including inquiries of management and comparing RSI to the basic financial statements. RSI is not outside the auditor''s scope.$19$,
  difficulty = 'easy'
WHERE id = 5418;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB Statement No. 87, paragraph 16, a short-term lease has a maximum possible term (including renewal options) of 12 months or less at lease commencement. The 15-month lease exceeds this threshold and must be recognized as a right-to-use asset and lease liability regardless of payment amounts.
...
Wrong (D): Month-to-month leases are one type of short-term lease, but they are not the only qualifying type. Any lease with a maximum possible term of 12 months or less qualifies, including fixed-term leases within that period.$19$,
  difficulty = 'medium'
WHERE id = 5420;
...
Wrong (D): GASB 54 establishes a clear default spending hierarchy when no formal policy exists. The absence of a policy does not give the government discretion to choose any spending order.$19$,
  difficulty = 'hard'
WHERE id = 5421;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB Statement No. 44, the statistical section presents trend data, revenue capacity, debt capacity, demographic information, and operating data typically covering ten fiscal years. This information helps users assess a government''s financial condition over time.
...
Wrong (D): The annual operating budget document is a separate publication from the comprehensive annual financial report. The statistical section provides historical trend data, not the current-year budget.$19$,
  difficulty = 'easy'
WHERE id = 5423;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB Statement No. 67, paragraph 4, and GASB Statement No. 34, defined benefit pension plans administered through trusts are reported in a pension (and other employee benefit) trust fund, a fiduciary fund type. The fiduciary net position represents plan assets minus plan liabilities.
...
Wrong (D): Internal service funds account for goods or services provided by one department to another on a cost-reimbursement basis. They are proprietary funds and are not used to report fiduciary pension plan assets.$19$,
  difficulty = 'medium'
WHERE id = 5425;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 33, derived tax revenues such as income taxes are recognized when the underlying exchange transaction occurs and the resources are available. Because the $380,000 relates to income earned during 2026 and is collected within the 60-day availability period, it qualifies for recognition in the general fund, bringing total revenue to $4,580,000.
...
Wrong (D): Revenue recognition for derived taxes is permitted in both governmental fund statements (modified accrual) and government-wide statements (full accrual). The availability criterion applies only at the fund level, not as a complete bar to recognition.$19$,
  difficulty = 'medium'
WHERE id = 5427;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 54, paragraph 30, a special revenue fund accounts for the proceeds of specific revenue sources that are restricted or committed to expenditures for specified purposes other than debt service or capital projects.
...
Wrong (D): Accounting for goods and services provided between departments on a cost-reimbursement basis describes an internal service fund, which is a proprietary fund type, not a governmental fund.$19$,
  difficulty = 'easy'
WHERE id = 5429;
...
Wrong (D): The cash must be recorded when received, along with a corresponding deferred inflow. Ignoring the transaction entirely would understate both assets and deferred inflows on the balance sheet.$19$,
  difficulty = 'easy'
WHERE id = 5430;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (C): Under GASB 34, paragraph 76, the general fund is always reported as a major fund regardless of whether it meets the quantitative major fund criteria. All other governmental and enterprise funds must meet both the 10% and 5% thresholds to qualify as major funds unless the government elects to report them as major.
...
Wrong (D): The capital projects fund with the highest expenditures receives no automatic major fund status. Fund size alone does not guarantee major fund classification without meeting the dual threshold test.$19$,
  difficulty = 'easy'
WHERE id = 5431;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 34, paragraph 58, interfund receivables and payables between funds within the same activity category (governmental activities) must be eliminated in the government-wide statement of net position. Both the general fund and capital projects fund are governmental funds, so the $750,000 balance is eliminated.
...
Wrong (D): Netting against fund balance is not the correct government-wide conversion procedure. GASB 34 requires full elimination of same-activity interfund balances, not a netting adjustment to equity.$19$,
  difficulty = 'medium'
WHERE id = 5432;
...
Wrong (C): Board appointment alone does not determine blending. The substantive-sameness or exclusive-service criteria must also be satisfied for blending. Appointment power helps establish the component unit relationship but not the presentation method.$19$,
  difficulty = 'medium'
WHERE id = 5433;
...
Wrong (D): Distributing proportionally between funds has no basis in GASB standards or bond law. Bond proceeds carry an implicit restriction tying them to their original debt-financed purpose.$19$,
  difficulty = 'hard'
WHERE id = 5434;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (A): Under GASB 34, paragraph 76, a governmental fund qualifies as major if any single financial element is at least 10% of the corresponding total for all governmental funds AND at least 5% of the combined total for all governmental and enterprise funds. The parks fund''s $22 million is 12.2% of $180 million governmental fund assets (exceeds 10%) and 7.3% of $300 million combined total (exceeds 5%), satisfying both thresholds.
...
Wrong (D): Special revenue funds are not excluded from the dual threshold test. All governmental fund types, including special revenue funds, are subject to the same major fund criteria under GASB 34.$19$,
  difficulty = 'hard'
WHERE id = 5436;
...
Wrong (C): There is no 20-year useful life requirement for capitalization. GASB 34 requires capitalization based on the government''s threshold, and depreciation is applied over whatever useful life the government estimates.$19$,
  difficulty = 'medium'
WHERE id = 5437;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (B): Under GASB 54, paragraph 6, nonspendable fund balance includes amounts not in spendable form (such as inventories and prepaid items) or amounts legally or contractually required to remain intact (such as the corpus of a permanent fund).
...
Wrong (D): Assigned fund balance represents amounts intended for a specific purpose by a body or official authorized to make such assignments. Like restricted and committed, the constraint relates to purpose, not to the form of the resource.$19$,
  difficulty = 'easy'
WHERE id = 5438;
...
Wrong (D): Note disclosure alone is insufficient under GASB 68. The standard requires balance sheet recognition of the net pension liability and income statement recognition of pension expense, not merely footnote disclosure of the unfunded amount.$19$,
  difficulty = 'hard'
WHERE id = 5439;
...
-- Issues: unstructured, no_contrast
UPDATE questions SET
  explanation = $19$Correct (D): Under GASB 34, paragraph 8, management''s discussion and analysis is required supplementary information (RSI) that precedes the basic financial statements. MD&A provides an analytical overview of the government''s financial activities based on currently known facts and conditions.
...
Wrong (C): MD&A is not a component of the basic financial statements. It is RSI that accompanies the basic statements, which consist of the government-wide statements, fund financial statements, and notes.$19$,
  difficulty = 'easy'
WHERE id = 5440;
...
Wrong (D): Special items are not classified as program revenues because they do not relate to ongoing program operations. They are reported as a distinct line item to distinguish them from normal recurring activities and general revenues.$19$,
  difficulty = 'medium'
WHERE id = 5441;
