// Generate LessonSpec stub files for unspecced topics in blueprint.ts so future
...
import { getLessonSpec } from "../../src/lib/lesson-specs";
...
function generateStub(r: ResolvedTopic): string {
	...
	return `import type { LessonSpec } from "./types";
